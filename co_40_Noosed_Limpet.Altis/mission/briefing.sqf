...
if (side group player != CIVILIAN) then {
	...
	<br/>Ensure that an airfield captured by AAF forces does not remain operational.
	<br/>
	<br/>Destroy key assets within the area before leaving via Krya Nera to the North.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
