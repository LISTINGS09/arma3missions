...
_grpBLU = [
	...
	,["GrpBLU_ST1","Recon","b_recon","R",_purple]
	,["GrpBLU_IFV1","IFV1","b_mech_inf","I1",_orange]
	,["GrpBLU_IFV2","IFV2","b_mech_inf","I2",_orange]
	,["GrpBLU_IFV3","IFV3","b_mech_inf","I3",_orange]
	,["GrpBLU_TNK1","Thunder","b_armor","T",_orange]
];