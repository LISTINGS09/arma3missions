...
if (side group player != CIVILIAN) then {
	...
	<br/>Our intelligence has uncovered that a FIA outpost located in the city of Telos has secured critical data recently obtained from a NATO research facility in the area. This information is being stored on a laptop within the outpost. The data may hold significant value to our ongoing operations, and we cannot allow it to remain in enemy hands. The city of Telos is heavily defended by FIA forces, and the outpost itself is well-guarded, with potential reinforcements nearby. Expect urban combat in dense, close-quarters environments.
	<br/>
	<br/>As an elite AAF special operations unit, your objective is to infiltrate the city of Telos, locate the FIA outpost, and secure the laptop containing the NATO research facility data. Extract the data and exfiltrate safely. Time is of the essence, and the FIA will likely be aware of your presence once the operation begins, so expect stiff resistance.
	<br/>
	<br/>%4
	<br/>
	<br/>%1 <!--- Casualties Cap --->
