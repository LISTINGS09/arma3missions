...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission as the commanding officer of the FIA is to successfully interrogate two captives held for exchange by CSAT (Canton-Protocol Strategic Alliance Treaty) and Russian forces. The captives are held at an old house located on Tafos Hill.
	<br/>
	<br/>
	<br/><font color='#FF7F00'>Location</font>
	<br/>The captives are being held at an old house situated on Tafos Hill. The area is likely to be heavily guarded by both CSAT and Russian forces. Be prepared for resistance.
	<br/>
	<br/><font color='#FF7F00'>Captives</font>
	<br/>The identities of the captives are currently unknown, but their information is of strategic importance to our cause. Interrogate them thoroughly to gather valuable intel on enemy movements, plans, or any potential weaknesses that could be exploited.
	<br/>
	<br/><font color='#FF7F00'>Enemy Presence</font>
	<br/>Expect a significant enemy presence in the area. CSAT and Russian forces are likely to have stationed guards both inside and outside the old house with patrols. Exercise caution and maintain stealth whenever possible to avoid detection.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>Once the interrogation is complete and the necessary intel has been obtained, plan a safe extraction route for your team - We're after the Information, not the captives themselves. Be prepared for potential enemy reinforcements and adapt your strategy accordingly.
	<br/>
	<br/>
