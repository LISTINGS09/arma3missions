...
if (side group player != CIVILIAN) then {
	...
	<br/>Altis is a politically unstable region, with various factions vying for control. The Altis Armed Forces (AAF) have been stockpiling weapons and supplies in a hidden cache to the north of the Almyra desert. These arms are believed to be destined for rebel groups hostile to our interests in the region. You have been tasked with locating and neutralizing this cache to disrupt the AAF's operations.
	<br/>
	<br/><font color='#FF7F00'>Infiltrate</font>
	<br/>Your team will infiltrate the AO from a location determined by the Commander. Ensure that you remain undetected during the initial phases.
	<br/>
	<br/><font color='#FF7F00'>Reconnaissance</font>
	<br/>Locate the hidden cache's precise coordinates. Reconnaissance assets have identified a potential area, but ground verification is crucial.
	<br/>
	<br/><font color='#FF7F00'>Neutralize the Enemy</font>
	<br/>If AAF forces are guarding the cache, engage only if necessary. Avoid direct confrontations and utilize stealth to achieve your objectives. There are no neutral targets in the area - All civilians should be treated as a threat.
	<br/>
	<br/><font color='#FF7F00'>Destroy the Cache</font>
	<br/>Once the cache is located, eliminate any guards, and then proceed to destroy the cache. An Engineer with explosives has been provided for this purpose.
	<br/>
	<br/><font color='#FF7F00'>Exfiltrate</font>
	<br/>After completing your mission, safely withdraw from the area. Avoid any unnecessary engagements with enemy forces.
	<br/>
