...
if (side group player != CIVILIAN) then {
	...
	<br/>In the ongoing conflict in the Altis region, it has come to our attention that the AAF (Altis Armed Forces) have obtained two vital cases of radio equipment. These cases contain classified communication technology that is crucial to our ongoing operations. Intelligence has identified the location of the AAF warehouse south of Xirolimni Dam as the storage site for these cases.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
    <br/>You will be inserted at a location of the Commanders choice about 1 kilometer from the target area. Move quietly and maintain a low profile. Do not engage enemy forces unless absolutely necessary to avoid raising alarms.
	<br/>
	<br/><font color='#FF7F00'>Securing the Equipment</font>
    <br/>Once at the warehouse, proceed with caution. Your top priority is to locate the two cases of radio equipment. They are likely to be well-guarded. Gather any intelligence on enemy positions and strength you find there.
	<br/>
	<br/><font color='#FF7F00'>Exfiltration</font>
    <br/>After securing both cases, move to the extraction point designated by the Commander. Expect enemy reinforcements, and be prepared to engage or evade as necessary.
	<br/>
