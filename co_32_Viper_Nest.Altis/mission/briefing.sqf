...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to conduct a coordinated operation to clear a village of CSAT special forces. 
	<br/
	<br/The village is suspected to be a stronghold for CSAT operatives who have been conducting illicit activities in the region. The successful completion of this operation is crucial to maintaining regional stability and securing valuable intelligence.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
