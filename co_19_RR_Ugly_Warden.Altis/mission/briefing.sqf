...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to retrieve vital data codes from a CSAT outpost on the island of Altis. The information contained within these codes is critical to our ongoing efforts against the CSAT forces.
	<br/>
    <br/><font color='#FF7F00'>Infiltration</font>
	<br/>Move quietly to the CSAT outpost. Avoid enemy patrols and utilize silenced weapons whenever possible.
	<br/>
    <br/><font color='#FF7F00'>Data Codes</font>
	<br/>Locate a laptop terminal within the outpost. Download the data codes onto a secure device.
	<br/>
    <br/><font color='#FF7F00'>Extraction</font>
	<br/>After securing the data codes, proceed to a safe extraction point determined by the Commander.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>The enemy in the area consists of well-armed and highly-trained CSAT troops. Expect infantry patrols around the outpost, as well as potential vehicular support. They are equipped with a variety of small arms and light vehicles. Be prepared for a well-organized and determined enemy force.
	<br/>
