...
if (side group player != CIVILIAN) then {
	...
	<br/>NATO intelligence suggests that CSAT forces have developed a new type of fighter jet fuel which provides excellent efficiency while being much cheaper to refine and produce. 
	<br/>
	<br/>Your unit is to obtain a sample of this fuel and deliver it to an undercover contact in Limnichori. Obtain a sample of the newly-developed CSAT fuel from a <font color='#0080FF'><marker name='F'>Fuel Pump</marker></font color> at the airbase.
	<br/>
	<br/>The fuel is volatile and only trained personnel must extract the fuel from the pump (the Commander).
	<br/>
	<br/>Once obtained, bring it to our contact in <font color='#0080FF'><marker name='EX'>Limnichori</marker></font color>.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>Your unit has been deployed by boat along the <font color='#0080FF'><marker name='respawn_west'>North-Eastern coastline</marker></font color>.
	<br/>
	<br/>You will need to make your way to the objective on foot.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>The <font color='#0080FF'><marker name='FL'>CSAT Airbase</marker></font color> is far from front lines and is relatively lightly guarded with about 14-20 infantry.
	<br/>
	<br/>However, there are a number of other patrols in the area including sea and mechanised IFV patrols, but no tracked vehicles. 
	<br/>
	<br/>Static emplacements are expected to be minimal and no air contacts have recently been reported in the area.
	<br/>
