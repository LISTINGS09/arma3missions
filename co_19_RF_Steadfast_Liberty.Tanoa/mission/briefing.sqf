...
if (side group player != CIVILIAN) then {
	...
	<br/>The Syndikat is under increasing pressure from the Gendarme forces, who recently captured a critical weapons cache to the south of the Lumberyard. This cache contains valuable arms and ammunition that are vital to our operations. If the Gendarme manage to utilize or destroy these weapons, it could significantly hamper our ability to continue our resistance. We must act swiftly to neutralize this threat.
	<br/>
	<br/>Your objective is to infiltrate the area south of the Lumberyard and destroy the captured weapons cache. This operation is crucial for maintaining the balance of power in our favour. Expect the area to be heavily guarded by Gendarme forces. Use any means necessary to ensure the destruction of the cache.
	<br/>
	<br/><font color='#FF7F00'>Primary Objective</font>
    <br/>Locate and destroy the weapons cache.
	<br/>
	<br/><font color='#FF7F00'>Secondary Objective</font>
    <br/>Minimize Syndikat casualties and avoid civilian harm.
	<br/>
