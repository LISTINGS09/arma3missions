...
if (side group player != CIVILIAN) then {
	...
	<br/>High Command has decided they want a set of NATO UGVs, despite no-one having the terminals to control such vehicles, your platoon has been assigned the task.
	<br/>
	<br/>%1 <!-- Casualties Cap -->
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>Up to five squads, each with one IFV for fire support.
	<br/>
