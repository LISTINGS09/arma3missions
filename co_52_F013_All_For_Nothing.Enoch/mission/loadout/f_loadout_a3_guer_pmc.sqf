	...
	_unit spawn {
		...
		if (random 1 > 0.4) then { 
			if (random 1 > 0.6) then { 
				...
				_this addEventHandler [ "Respawn", { sleep 1; player setObjectTextureGlobal [0, 'A3\Characters_F\Civil\Data\c_cloth1_bandit_co.paa']}];
			} else { 
				_this setObjectTextureGlobal [0,'\A3\Characters_F\Civil\Data\c_cloth1_kabeiroi_co.paa'];	 // Grey Camo Top
				_this addEventHandler [ "Respawn", { sleep 1; player setObjectTextureGlobal [0, '\A3\Characters_F\Civil\Data\c_cloth1_kabeiroi_co.paa']}];
			};
		};
		if (random 1 > 0.5) then { _this setObjectTextureGlobal [1,'\A3\Characters_F\Common\Data\basicbody_black_co.paa']; _this addEventHandler [ "Respawn", { sleep 1; player setObjectTextureGlobal [0, '\A3\Characters_F\Common\Data\basicbody_black_co.paa']}] }; // Black Trousers
