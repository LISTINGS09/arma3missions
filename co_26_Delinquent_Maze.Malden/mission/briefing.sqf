...
if (side group player != CIVILIAN) then {
	...
	<br/>Your objective is to locate and rescue injured civilians, while also neutralizing the insurgent threat from hostiles who have taken control of a populated area. An IDAP convoy was travelling through this area and ended up getting caught in the crossfire.
	<br/>	
	<br/>The insurgents are heavily armed and have positioned themselves throughout the AO, making it difficult for any civilian aid to reach the injured. 
	<br/>
	<br/>Locate and rescue five injured IDAP personnel and return them safely back.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
