...
if (side group player != CIVILIAN) then {
	...
	<br/>Refuel and capture an AAF MBT captured by CSAT forces. 
	<br/>
	<br/>Fuel Canisters can be found at two CSAT locations a <marker name='marker_16'>Fuel Depot</marker> and <marker name='marker_17'>Fuel Station</marker>.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
