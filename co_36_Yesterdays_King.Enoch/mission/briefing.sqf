...
if (side group player != CIVILIAN) then {
	...
	<br/>We have received intel that the town of Sitnik is currently under the control of the Livonian Defense Force (LDF). Your mission is to secure the town by capturing two checkpoints and eliminating a mortar site. We also have reason to believe that important intel is located within the town.
	<br/>
	<br/>The commander is to chose an insertion point outside of the town. From there, you will move towards the first checkpoint located at the outskirts of Sitnik. The checkpoint is heavily guarded by LDF forces, so use caution when approaching. Once the checkpoint is secured, proceed towards the second checkpoint, which is located closer to the town centre.
	<br/>
	<br/>The second checkpoint is also heavily guarded, so use tactics to overcome the enemy forces. Once the second checkpoint is secured, proceed towards the mortar site located on the eastern outskirts of the town. This mortar site is shelling our forces in the area, so it must be eliminated at all costs.
	<br/>
	<br/>Once the mortar site is completely destroyed, move into the town and search for the intel. Be aware that the LDF forces are likely to be entrenched within the town and may have defensive measures in place.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
