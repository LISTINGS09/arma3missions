...
if (side group player != CIVILIAN) then {
	...
	<br/>Our mission is to destroy the AAF Munitions Warehouse located outside Rodopoli to disrupt their logistics and weaken their control over the region. We must execute this operation swiftly and efficiently to minimize the risk of detection.
	<br/>
	<br/>* Infiltrate the area quietly and neutralize any sentries or guards.
    <br/>* Plant explosives on the munitions warehouse and any enemy vehicles or equipment that can be disabled.
    <br/>* Withdraw from the area quietly and be prepared to defend against any AAF counterattacks.
    <br/>* Complete the mission without compromising the safety of our forces.
	<br/>
