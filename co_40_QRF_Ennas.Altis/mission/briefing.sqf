...
if (side group player != CIVILIAN) then {
	...
	<br/>Joint Operations Center (JOC) reports there is a good opportunity to secure and eliminate the enemies located at <font color='#0080FF'><marker name='obj1'>Ennas</marker></font color>.
	<br/>
	<br/>Secure and clear <font color='#0080FF'><marker name='obj1'>Ennas</marker></font color> from enemy forces.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
