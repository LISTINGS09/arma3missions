...
if (side group player != CIVILIAN) then {
	...
	<br/>An allied helicopter (ID: AZ8) has been engaged and downed by Rebel forces in a nearby forest.
	<br/>
	<br/>Eliminate the SAM site and also locate and secure the two downed pilots believed to still be alive at the wreckage.
	<br/>
	<br/>%1 <!-- Casualties Cap -->
