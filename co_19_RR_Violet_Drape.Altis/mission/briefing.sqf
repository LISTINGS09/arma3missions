...
if (side group player != CIVILIAN) then {
	...
	<br/>Our intelligence has identified a high-value target in the form of a Russian Commander hiding just outside the town of Kalochori on the island of Altis. This Commander is believed to be coordinating operations against our interests in the region and has evaded previous attempts at capture or elimination.
	<br/>
	<br/>Your task, as a part of the CTRG (Covert Tactical Response Group), is to locate and eliminate the Russian Commander. It is of the utmost importance that you do not engage the local civilian population, as we are operating in a sensitive political environment, and any collateral damage could have severe repercussions.
	<br/>
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>You will insert into an area designated by the Commander. Stay low, move fast, and avoid enemy patrols.
	<br/>
	<br/><font color='#FF7F00'>Intelligence Gathering</font>
	<br/>Once on the ground, you will rely on up-to-the-minute intelligence to track the Russian Commander's movements. The Commander is believed to have a small security detail; eliminate them quietly if possible.
	<br/>
	<br/><font color='#FF7F00'>Tracking and Elimination</font>
	<br/>Once you have a solid lead on the Commander's location, proceed with the elimination. Your mission is to kill and verify the death of the Commander; ensure that he does not leave the area alive.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>After the mission is complete, the Commander is to proceed to a safe location.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
