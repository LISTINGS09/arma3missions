...
if (side group player != CIVILIAN) then {
	...
	<br/>Locate and capture two CSAT support vehicles in the AO:
	<br/>1. Tempest Fuel - Located at a Fuel Station outside of Paros.
	<br/>2. Zamak Repair - Located in a Warehouse somewhere north of Kalochori.
	<br/>
	<br/>Once the vehicles have been captured, escort them from the area.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
