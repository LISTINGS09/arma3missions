...
if (side group player != CIVILIAN) then {
	...
	<br/>Destroy Two MJTF Artillery Assets located to the <marker name='marker_47'>North</marker> and <marker name='marker_48'>West</marker> of La Riviere.
	<br/>
	<br/>%1
	<br/>
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>All squads have either unarmed transported or armed patrol boats to move around the AO. No other friendly forces are present in the area.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>Expect light patrols across the AO. Due to the presence of enemy air support, a nearby enemy <marker name='marker_50'>Supply Cache</marker> will provide AA launchers if required.
	<br/>
	<br/>One Marshall IFV is known to be located near each of the artillery assets.
	<br/>
