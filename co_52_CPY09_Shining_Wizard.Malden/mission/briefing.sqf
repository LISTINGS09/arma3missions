...
if (side group player != CIVILIAN) then {
	...
	<br/>Obtain FIA Documents located in Guran and eliminate a high-ranking Officer.
	<br/>
	<br/>%1
	<br/>
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>Each squad has one unarmed transport to move closer to the AO.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>FIA has established a number of bunkers in the hills, expect infantry and static supports at these locations. 
	<br/>
	<br/>A mortar position is active to the south and can be expected to engage your forces once detected.
	<br/>
	<br/>Mechanised and infantry patrols are also active in the area, however given the terrain armoured contacts are anticipated to be very low.
	<br/>
