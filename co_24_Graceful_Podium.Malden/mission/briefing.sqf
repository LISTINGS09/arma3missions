...
if (side group player != CIVILIAN) then {
	...
	<br/>Our mission is to recover four trophies currently held the island of Moray, they will be located somewhere within the towns houses. Once complete, return to the NATO Frigate. 
	<br/>
	<br/>These trophies are critical to our cause and hold significant value in terms of morale and propaganda.
	<br/>
	<br/>NATO has agreed to lend us one of their boats to launch a naval assault and may provide us light air support for the duration of the operation.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	...
	<br/>%2%3
	<br/>
	<br/>Additional airborne QRF forces can be expected from the main island.
	<br/>
