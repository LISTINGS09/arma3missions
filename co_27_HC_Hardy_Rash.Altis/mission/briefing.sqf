...
if (side group player != CIVILIAN) then {
	...
	<br/>CSAT forces have identified a NATO truck in the possession of FIA insurgents. The truck is of high strategic value, containing sensitive equipment and classified documents that cannot be allowed to fall into hostile hands. Intelligence reports indicate the vehicle is currently stationed in a small insurgent base to the north of the town of Sofia. The FIA insurgents have fortified their positions and are expected to defend the vehicle fiercely.
	<br/>
	<br/>Your objective is to recover the NATO truck from the FIA insurgents. You must neutralize all hostile forces in the area, secure the truck, and safely extract it to a designated CSAT outpost south of Sofia. Use caution, as the insurgents are heavily armed and may have set up ambushes along the route. Time is critical, as NATO forces may be attempting to recover the vehicle as well.
	<br/>
	<br/>%4
	<br/>
	<br/>%1 <!--- Casualties Cap --->
