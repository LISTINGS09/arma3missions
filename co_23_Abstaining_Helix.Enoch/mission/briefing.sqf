...
if (side group player != CIVILIAN) then {
	...
	<br/>Your objective is to secure a Russian laboratory located deep within a forest to the North of Grabin that is currently guarded by CSAT forces.
	<br/>
	<br/>The laboratory in question is believed to be conducting illegal research and development of advanced weaponry. It is imperative that we secure this facility and gather as much intel as possible about their activities.
	<br/>
	<br/>Your primary objective is to secure the laboratory and neutralize all enemy forces guarding it.
	<br/>
	<br/>The terrain in the forest is dense and challenging, so we will need to exercise caution and maintain situational awareness at all times.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
