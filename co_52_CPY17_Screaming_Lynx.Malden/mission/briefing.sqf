...
if (side group player != CIVILIAN) then {
	...
	<br/>Ensure a deal taking place between CSAT and FIA forces does not complete.
	<br/>
	<br/>Eliminate the CSAT Officer, retrieve a stolen truck full of supplies from the area then withdraw back to the Airbase.
	<br/>
	<br/>At least one Vector asset must remain alive to sling load the objective Truck from the AO.
	<br/>
	<br/>%1
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>Each squad has one assigned Vector support for transport to the AO.
	<br/>
	<br/>All Vector call-signs are armed and should be on standby for CAS after insertion. 
	<br/>
	<br/>Due to the rural nature of the location, a number of civilian farmers may be encountered in the AO - These are not to be harmed under any circumstances.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>This region is primarily FIA-controlled however CSAT presence is heavier to the East and South, where CSAT occupy two towns. 
	<br/>
	<br/>Due to the meeting a high military presence is expected across the area - At least one CSAT IFV is present at the meeting point and patrols are active across the location.
	<br/>
	<br/>AA threats in the area are currently very low, but expect AA defences deeper into the island within CSAT territory. 
	<br/>
	<br/>QRF forces are expected to enter the AO following your attack - These may include AA, armoured or air supports.
	<br/>
