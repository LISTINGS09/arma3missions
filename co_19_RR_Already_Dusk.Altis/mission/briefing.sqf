...
if (side group player != CIVILIAN) then {
	...
	<br/>Your primary objective is to locate and neutralize the AAF Commander known to be operating to the south of Neri. This commander poses a significant threat to our operations in the region and his elimination is critical.
	<br/>
    <br/>After eliminating the AAF Commander, you must ensure his identity is verified. Search the body to confirm the target's identity.
	<br/>
