...
if (side group player != CIVILIAN) then {
	...
	<br/>CSAT forces have been engaged in a long-standing conflict with insurgent rebels in the region of Therisa. The rebels, known for their guerilla warfare tactics and local support, have managed to establish a stronghold in the vicinity. Their presence poses a significant threat to the stability and security of the region.
	<br/>
	<br/>CSAT command has tasked our unit with conducting a focused offensive operation to push back the insurgent rebels and regain control over the territory. Our primary objective is to neutralize the rebel forces at two locations and eliminate their operational capabilities around Therisa.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
