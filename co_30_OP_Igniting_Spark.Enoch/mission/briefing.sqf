...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to capture a small Livonian Defence Force (LDF) Headquarters located in Gieraltow. Intelligence reports suggest that the LDF is operating in the area and the HQ is believed to be a key strategic point for their operations.
	<br/>
	<br/>The LDF has established a presence in Gieraltow, and their HQ is serving as a command and control centre for their forces in the region. Recent developments indicate that they are planning offensive operations against friendly forces. It is imperative that you neutralize their command structure and gain control of the HQ.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
