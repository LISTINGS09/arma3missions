...
if (side group player != CIVILIAN) then {
	...
	<br/>Syndikat forces have been tasked with a critical mission to destabilize enemy control in the region. The target is the Police HQ in Luganville, which serves as a strategic point for enemy operations and intelligence. This facility is fortified and protected by local law enforcement and allied paramilitary units. Intelligence suggests that disrupting this HQ will significantly weaken enemy capabilities and bolster our position in the area.
	<br/>
	<br/>Your mission is to infiltrate Luganville and destroy the Police HQ. This objective must be achieved with precision and minimal collateral damage to maintain support from the local population. You are authorized to use any necessary means to neutralize enemy forces and ensure the success of the operation. Be prepared for potential reinforcements and heightened security measures.
	<br/>
