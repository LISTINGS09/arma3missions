...
if (side group player != CIVILIAN) then {
	...
	<br/>Assault a <marker name='marker_3'>CSAT Supply Outpost</marker> and use the support vehicles stored there to refuel our APC.
	<br/>
	<br/>A <marker name='marker_1'>Mortar Site</marker> is known to be active in the area and will also need to be eliminated.
	<br/>
	<br/>%1 <!-- Casualties Cap -->
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>Up to four squads, supported by one APC with limited fuel and one forward Recon team.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>CSAT forces are known to have deployed AP mines in the AO, but this also means infantry contacts will be limited. 
	<br/>
