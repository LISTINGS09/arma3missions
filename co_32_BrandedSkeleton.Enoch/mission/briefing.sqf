...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to destroy two LDF AAA sites within the town of Sitnik and then secure the Industrial Site there. The LDF has established multiple anti-aircraft artillery sites in the area which are posing a serious threat to our air superiority.
	<br/>
	<br/>Your main objective is to neutralize these AA sites in order to secure the airspace and provide our air support with the ability to operate freely in the region.
	<br/>
	<br/>The town of Sitnik is heavily fortified and guarded by a significant LDF ground force, so proceed with caution and precision.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
