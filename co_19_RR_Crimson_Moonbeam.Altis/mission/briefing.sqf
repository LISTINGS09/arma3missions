...
if (side group player != CIVILIAN) then {
	...
	<br/>Our insurgency is gaining momentum, and today, we have an opportunity to strike a severe blow to the CSAT (Canton-Protocol Strategic Alliance Treaty) forces occupying Altis. Intelligence reports suggest that a valuable CSAT supply cache is hidden in the region. Destroying this cache will weaken their hold on the island and provide us with valuable resources.
	<br/>
	<br/>Your mission is to locate and destroy the CSAT supply cache in the target area.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>You should start outside of the AO. Move quietly and covertly to the target area to avoid detection.
	<br/>
	<br/><font color='#FF7F00'>Locate the Cache</font>
	<br/>The cache's exact location is uncertain, but intelligence indicates it's likely hidden in one of the villages nearby. Gather information from the local population or use the UAV to pinpoint its location. Be cautious; the CSAT has a strong presence in the area, and they may have guards protecting the cache.
	<br/>
	<br/><font color='#FF7F00'>Destroy the Cache</font>
	<br/>Once you locate the cache, place explosive charges to destroy it. Ensure that the explosives are properly set and sufficient to eliminate the entire cache.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>After the cache is destroyed, quickly exfiltrate the area. Avoid any unnecessary engagement with CSAT forces. Stealth and speed are your allies.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
