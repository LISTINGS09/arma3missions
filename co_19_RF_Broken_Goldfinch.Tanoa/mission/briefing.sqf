...
if (side group player != CIVILIAN) then {
	...
	<br/>Your forces are tasked with capturing a Syndikat checkpoint located to the north of Katkoula. The Syndikat presence in the region has been a source of instability and criminal activity, disrupting local governance and endangering civilian populations. It is imperative to neutralize this threat and re-establish government control over the area.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Your unit will advance towards the checkpoint using stealthy movement techniques. Reconnaissance assets will provide real-time intelligence on enemy positions and movements, secure a foothold near the checkpoint without alerting the enemy.
	<br/>
	<br/><font color='#FF7F00'>Assault</font>
	<br/>Once in position, initiate a coordinated assault on the checkpoint. Maintain momentum and exploit weaknesses in enemy positions.
	<br/>
	<br/><font color='#FF7F00'>Clearing and Securing</font>
	<br/>Conduct a systematic clearance of the checkpoint, neutralizing any remaining resistance. Establish defensive positions to repel any counterattacks.
	<br/>
	<br/>
