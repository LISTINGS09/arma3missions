...
if (side group player != CIVILIAN) then {
	...
	<br/>Altis is under threat from insurgents who have established a mortar site near a vital research facility. They are using this position to continuously bombard the research facility, endangering the security of our nation. In response, AAF forces are to launch this operation, aimed at capturing this mortar site, eliminating the insurgent threat, and securing the research facility.
	<br/>
	<br/><font color='#FF7F00'>Locate Site</font>
	<br/>Locate the insurgent mortar position somewhere to the East of the Research Facility. This is the highest priority target. Expect the enemy to defend this position vigorously.
	<br/>
	<br/><font color='#FF7F00'>Advance to Contact</font>
	<br/>Move cautiously towards the mortar site when found. Neutralize all insurgent forces in the area, including any reinforcements. The enemy is well-armed and highly motivated. Expect guerrilla tactics.
	<br/>
	<br/><font color='#FF7F00'>Secure the Mortar</font>
	<br/>Once the mortar site is located, prioritize its capture. Use a flanking manoeuvre if necessary and establish a perimeter around it. Ensure the safety of the research facility - No damage to the facility is acceptable.
	<br/>
	<br/><font color='#FF7F00'>Extract Intelligence</font>
	<br/>Search for any intelligence regarding the insurgent group's future plans, connections, and leadership.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
