...
if (side group player != CIVILIAN) then {
	...
	<br/>Your objective is to sabotage NATO communications and download sensitive data from their communications center. The target of this operation is the NATO communication outpost located to the South of Malden.
	<br/>
	<br/>The first step is to gather intelligence on the enemy's position. Once you have this information, you may use the UAV and Mortar to strike key targets.
	<br/>
	<br/>Once the mission is complete, your group will rendezvous at a predetermined location on the East of the island and return to base.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
