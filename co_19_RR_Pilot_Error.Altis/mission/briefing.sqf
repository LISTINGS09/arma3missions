...
if (side group player != CIVILIAN) then {
	...
	<br/>The situation on Altis has escalated, and the oppressive NATO forces have established a significant presence near Oreokastro. Their Anti-Aircraft Artillery (AAA) asset poses a significant threat to our operations in the region, limiting our ability to manoeuvre and strike back. 
	<br/>
	<br/>Our rebel group, known as 'Serpent's Wrath', has received intelligence regarding the location of the NATO compound and AAA assets in the area. Our mission is to capture the compound and destroy the AAA assets, severely weakening NATO's air defence capabilities in the region.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
    <br/>Move to the vicinity of the NATO compound, avoiding detection as much as possible.
	<br/>
	<br/><font color='#FF7F00'>Capture the NATO Compound</font>
    <br/>Secure the NATO compound by neutralizing any enemy forces in the area. Establish control over the compound, preventing enemy reinforcements.
	<br/>
	<br/><font color='#FF7F00'>Destroy AAA Asset</font>
    <br/>Locate and destroy the Anti-Aircraft Artillery (AAA) asset near the compound.
	<br/>
	<br/><font color='#FF7F00'>Exfiltration</font>
    <br/>Once the compound and AAA asset is destroyed, safely withdraw from the area.
	<br/>
