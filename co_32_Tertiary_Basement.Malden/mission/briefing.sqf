...
if (side group player != CIVILIAN) then {
	...
	<br/>We have received intelligence indicating that NATO forces have established three key compounds just outside the town of Larche. Your mission is to capture and secure these compounds to weaken NATO's hold on this area and expand our influence. The compounds include:
	<br/>
	<br/>Field Office: The field office serves as a command centre for NATO operations in the region. Capturing it will disrupt their communications and coordination, giving us a significant advantage.
	<br/>
    <br/>Munitions Warehouse: This facility stores vital supplies for the NATO forces. Capturing it will not only deprive them of ammunition but will also bolster our own resources.
	<br/>
    <br/>Fuel Station: The fuel station is a critical supply point for NATO vehicles and aircraft. By taking control of this station, we will limit their mobility and aerial capabilities.   
	<br/>
