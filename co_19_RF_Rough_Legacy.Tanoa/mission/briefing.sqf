...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to obtain critical intelligence from a secure Gendarme laptop. To achieve this, you must ambush a Gendarme Commander and acquire their pass-card. Subsequently, conduct a raid on the compound located in Nicolet and download the intelligence stored on the laptop.
	<br/>
	<br/>The Gendarme Commander will be leaving in a few minutes and traveling in an unarmed Hunter accompanied by two infantry transport trucks within a convoy. They will be en route from the Nicolet compound carrying the pass-card required to access the secure laptop.
	<br/>
	<br/><font color='#FF7F00'>Ambush the Convoy</font>
	<br/>Deploy your forces somewhere along the convoy route, preferably in a concealed position before or at the <marker name='marker_44'>Ambush Marker</marker>. Initiate the ambush when the convoy approaches your location. Focus your efforts on neutralizing the Gendarme Commander travelling in the Hunter while minimizing collateral damage to the transport trucks.
	<br/>
	<br/><font color='#FF7F00'>Secure the Pass-Card</font>
	<br/>Once the Commander has been eliminated, secure their person to retrieve the pass-card. Ensure swift and decisive action to prevent any potential counterattacks from remaining Gendarme forces.
	<br/>
	<br/><font color='#FF7F00'>Raid the Nicolet Compound</font>
	<br/>Utilize the acquired pass-card to gain entry to the laptop to download the data. Exercise caution and be prepared to engage any hostile forces guarding the premises.
	<br/>
