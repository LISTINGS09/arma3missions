...
if (side group player != CIVILIAN) then {
	...
	<br/>A covert CSAT camp has been identified approximately 1km southwest of Molos. The camp is used as a staging area for enemy operations and is powered by a single generator. Disabling this generator will significantly hamper CSAT communications and logistics, providing NATO forces the opportunity to strike at their weakened defences.
	<br/>
	<br/>Your objective is to locate the CSAT camp and sabotage it by disabling the generator. Expect light to medium enemy resistance, including patrols and guard towers around the perimeter. Once the generator is disabled, exfiltrate the area and regroup at a designated extraction point.
	<br/>
