...
if (side group player != CIVILIAN) then {
	...
	<br/>Intelligence reports confirm that CSAT infantry units have captured a warehouse located outside Athira. This warehouse serves as an important strategic position for CSAT, housing a significant amount of ammunition crucial to their operations in the region.
	<br/>
	<br/>Your mission is to infiltrate the warehouse compound and destroy the enemy's ammunition cache, expect a series of explosions from the cache upon detonation. This will significantly hamper CSAT's operational capabilities in the region and provide a strategic advantage to our forces.
	<br/>
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Move cautiously towards the warehouse under the cover of darkness if possible. Use the terrain to your advantage and avoid detection by enemy patrols.
	<br/>
	<br/><font color='#FF7F00'>Assault</font>
	<br/>Once in position, launch a coordinated assault on the warehouse compound. Neutralize any enemy resistance and secure the perimeter.
	<br/>
	<br/><font color='#FF7F00'>Demolition</font>
	<br/>Locate the ammunition caches within the warehouse and plant explosives to destroy them. Ensure that the explosives are properly set and have sufficient coverage to eliminate the target effectively.
	<br/>
	<br/><font color='#FF7F00'>Exfiltration</font>
	<br/>After the demolition is complete, withdraw from the area quickly and rendezvous at the designated extraction point as chosen by the Commander. Be prepared to fend off any counterattacks during your withdrawal.
	<br/>
	<br/>
