...
if (side group player != CIVILIAN) then {
	...
	<br/>Secure four key locations around the town of La Trinite.
	<br/>
	<br/>%1
	<br/>
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>All squads begin south of the objective, you will need to advance towards the town by foot.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>Expect a large infantry presence at each of the key locations, fire-teams will also be on patrol across the AO.
	<br/>
	<br/>Motorised and mechanised supports have been spotted moving around town, however no additional QRF forces are expected.
	<br/>
