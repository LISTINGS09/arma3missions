...
if (side group player != CIVILIAN) then {
	...
	<br/>Intelligence reports confirm that the Freedom and Independence Army (FIA) has established a crucial outpost in Amfissa on Altis. This outpost serves as a hub for their operations in the region, including recruitment, supply, and coordination of attacks against our forces. To disrupt their activities and weaken their hold on the area, your unit has been tasked with a covert operation.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Your primary objective is to infiltrate Amfissa undetected. The Commander will choose a zone located approximately 1 kilometer from the site. Your path into Amfissa should remain stealthy and avoid direct confrontation with enemy forces if possible.
	<br/>
	<br/><font color='#FF7F00'>Poison the Well</font>
	<br/>Once inside the Outpost, locate the well that the FIA relies on for their water source. A chemist from our team has prepared a fast-acting, non-lethal toxin that will incapacitate anyone who consumes the water. Inject the toxin into the well's water supply without being detected.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>After poisoning the well, exfiltrate the area as quietly as possible. If your presence is compromised, be prepared for hostile engagements.
	<br/>
