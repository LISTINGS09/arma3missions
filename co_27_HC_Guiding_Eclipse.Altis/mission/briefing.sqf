...
if (side group player != CIVILIAN) then {
	...
	<br/>CSAT forces have intercepted intelligence regarding two AAF scientists who possess critical research data of strategic importance. These scientists are being held by the AAF within the vicinity of Nidasos. Based on gathered intelligence, their exact location is unknown but is suspected to be in one of four marked areas around the town. The AAF is on high alert, and their forces are maintaining tight security in these locations to prevent any rescue or extraction operations.
	<br/>
	<br/>Your task is to locate and secure the two scientists from AAF custody. Sweep through the four marked locations in and around Nidasos, verify their presence, and extract them to the designated CSAT extraction point. The scientists must be secured alive, and their safety is the top priority. Eliminate any hostile forces that threaten the success of the mission, but minimize collateral damage to avoid drawing unwanted attention.
	<br/>
	<br/>Support/Vector Teams may choose any vehicle and/or role as designated by the Commander.
	<br/>%4
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	...
	(format["Instant Death: %1", ["<font color='#CF142B'>Disabled</font>","<font color='#80FF00'>Enabled</font>"] select FAR_var_InstantDeath]) + "<br/>" +
	...
	(format["Fast Travel: %1", ["<font color='#CF142B'>Disabled</font>","<font color='#80FF00'>Enabled</font>"] select f_param_fastTravel])
	]]];
};
