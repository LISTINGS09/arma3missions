// Zeus Civilian Spawning - By 2600K Based on Enigma(?) Civilian Script - V1.8
...
//ZCS_var_UnitClass = [ "vn_c_men_13","vn_c_men_14","vn_c_men_15","vn_c_men_16","vn_c_men_17","vn_c_men_18","vn_c_men_19","vn_c_men_20","vn_c_men_21","vn_c_men_22","vn_c_men_01","vn_c_men_02","vn_c_men_03","vn_c_men_04"]; // Basic Unit Classes - Gear is applied below
ZCS_var_UnitGear = [
	[
		// Headgear
