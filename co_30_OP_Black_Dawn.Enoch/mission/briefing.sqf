...
if (side group player != CIVILIAN) then {
	...
	<br/>Intel reports suggest that CSAT has established a strategic radar post at Hedrykow. This radar facility is of critical importance for CSAT's regional operations. Our mission is to infiltrate, neutralize resistance, and secure control of the radar post.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
