...
if (side group player != CIVILIAN) then {
	...
	<br/>CSAT forces have established a fortified encampment approximately 1 kilometer north of Paros. Intelligence reports indicate that this camp serves as a staging ground for further CSAT operations into AAF-controlled territory. Securing this position is vital to preventing further incursions and ensuring the safety of Paros and its surrounding areas.
	<br/>
	<br/>Your task is to lead AAF forces in a coordinated assault on the CSAT camp. You must secure the encampment and eliminate or capture any hostile forces present. Time is of the essence, as the longer we allow the camp to operate, the greater the threat it poses to Paros and our supply lines.
	<br/>
