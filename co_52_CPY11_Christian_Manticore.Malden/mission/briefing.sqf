...
if (side group player != CIVILIAN) then {
	...
	<br/>Destroy two radio towers at a nearby AAF Radio Station to the East, then return back West.
	<br/>
	<br/>%1
	<br/>
	...
	<br/>Enemy patrols will be active across the area, IFV and motorised supports may also be active along the roads.
	<br/>
	<br/>As you near the Radio Station expect AAF QRF forces from the airbase and surrounding area.
	<br/>
