...
if (side group player != CIVILIAN) then {
	...
	<br/>The region of Altis has become a stronghold for insurgent forces who pose a significant threat to regional stability. Your objective is to seize control of the village of Ifestiona and neutralize the insurgent presence. The success of this mission is crucial for establishing a secure environment and restoring peace in the region.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
