...
if (side group player != CIVILIAN) then {
	...
	<br/>Our intelligence sources have confirmed the presence of a CSAT Ammo truck utilized by Insurgent forces in the region. The truck is vital to their operations as it supplies ammunition and explosives to their combatants. Our objective is to locate and capture the Ammo truck, denying the enemy their critical logistical support.
	<br/>
	<br/>The Insurgents have been operating in a heavily forested area, making it challenging to pinpoint the exact location of the truck. However, recent intel suggests that the vehicle is being kept at a temporary hideout near a remote village. The FIA (Freedom and Independence Army) will spearhead this operation, employing their knowledge of the local terrain and their ability to blend in with the population.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
