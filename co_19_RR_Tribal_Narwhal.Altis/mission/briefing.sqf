...
if (side group player != CIVILIAN) then {
	...
	<br/>Your objective is to neutralize two CSAT SAM (Surface-to-Air Missile) sites located near the valley of Kavirida. These SAM sites pose a significant threat to our air operations and must be eliminated to ensure our continued aerial superiority in the region.
	<br/>
	<br/>The SAM sites have each been deployed near warehouses in the vicinity of Kavirida. Satellite imagery has confirmed the presence of one SAM launcher inbound to each site, two in total. The warehouses are likely being used to store additional equipment and supplies for the SAM sites.
	<br/>
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Begin by conducting a stealthy infiltration to the vicinity of the SAM sites. Avoid detection by enemy patrols and use natural terrain features for cover.
	<br/>
	<br/><font color='#FF7F00'>Reconnaissance</font>
	<br/>Once in position near the warehouses, conduct reconnaissance to gather information on enemy positions, patrols, and any potential obstacles.
	<br/>
	<br/><font color='#FF7F00'>Target Prioritization</font>
	<br/>Identify the most advantageous approach routes to each SAM site, taking into account enemy defences and terrain features. Prioritize targets such as enemy patrols, defensive emplacements, and the SAM launchers themselves.
	<br/>
	<br/><font color='#FF7F00'>Destruction</font>
	<br/>Employ appropriate tactics and weaponry to neutralize the SAM sites and any accompanying enemy forces.
	<br/>
	<br/><font color='#FF7F00'>Exfiltration</font>
	<br/>Once the SAM sites have been destroyed, withdraw from the area using pre-planned exfiltration route determined by the Commander. Be prepared to engage any pursuing enemy forces and maintain security during the withdrawal.
	<br/>
	<br/>
