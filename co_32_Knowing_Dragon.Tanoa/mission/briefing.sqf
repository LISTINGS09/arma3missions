...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to capture a CSAT Device Truck located somewhere near Oumere. The truck is believed to be carrying valuable technology that could significantly impact the balance of power in the region. The success of this operation hinges on your ability to infiltrate the area, neutralize any hostile forces, and secure the device intact.
	<br/>
	<br/>CSAT forces have established a presence in the region and are likely to have a significant presence guarding the device truck. Expect well-equipped infantry units supported by armoured vehicles. Additionally, be vigilant for potential guerrilla forces sympathetic to CSAT interests operating in the area.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
