...
if (side group player != CIVILIAN) then {
	...
	<br/>The FIA have established a strategic bunker near the turbines outside of Fotia. This bunker serves as a key operational centre for their activities in the region. Intelligence reports suggest that the bunker is heavily fortified and guarded, posing a significant obstacle to our operations in the area.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Begin by moving stealthily towards the vicinity of the bunker. Avoid detection by enemy patrols and establish a foothold in the area.
	<br/>
	<br/><font color='#FF7F00'>Assault</font>
	<br/>Coordinate your attack on the bunker with your team members. Utilize suppressive fire and flanking manoeuvres to overwhelm the enemy defences.
	<br/>
	<br/><font color='#FF7F00'>Capture</font>
	<br/>Once the bunker is secure, take control of any key installations or resources within. Gather any intelligence materials or equipment that may be of use to our cause.
	<br/>
	<br/><font color='#FF7F00'>Consolidation</font>
	<br/>Establish defensive positions around the bunker to repel any counterattacks by FIA reinforcements. Prepare for possible extraction or reinforcement depending on the situation on the ground.
	<br/>
