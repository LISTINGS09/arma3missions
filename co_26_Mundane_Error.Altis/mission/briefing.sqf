...
if (side group player != CIVILIAN) then {
	...
	<br/>Agios Petros is a strategic village located in a volatile region. It has recently fallen under the control of a well-organized insurgent group known as the Eastern Liberation Front (ELF). The ELF has been conducting attacks against local government forces and posing a significant threat to the stability of the region.
	<br/>	
	<br/>Your forces have been tasked with securing the village of Agios Petros, which is currently occupied by insurgents. The objective is to neutralize the insurgent threat, restore stability to the area, and establish a secure presence for future operations.
	<br/>
