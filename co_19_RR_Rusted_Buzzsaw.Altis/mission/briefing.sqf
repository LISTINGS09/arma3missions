...
if (side group player != CIVILIAN) then {
	...
	<br/>Our intelligence has revealed that CSAT (Canton-Protocol Strategic Alliance Treaty) forces have established a hidden weapons cache near Molos. These weapons, critical to their operation in the region, are believed to be concealed within cardboard boxes, making it imperative for us to locate and secure them. The cache's exact location is unknown, and it's crucial that we find it before CSAT can put these weapons to use.
	<br/>
	<br/>Your mission, as AAF (Altis Armed Forces) Special Operations Unit, is to locate and secure the CSAT weapons cache hidden within cardboard boxes. This operation must be conducted swiftly and discreetly, as CSAT forces are likely to be on high alert. The operation's success is of utmost importance to the national security of Altis.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Your commander will select a suitable insertion point outside of the AO. From there, proceed on foot to avoid drawing unnecessary attention.
	<br/>
	<br/><font color='#FF7F00'>Reconnaissance</font>
	<br/>Conduct thorough reconnaissance of the area, utilizing your UAVs and surveillance equipment. Look for any signs of CSAT presence or clues about the cache's location.
	<br/>
	<br/><font color='#FF7F00'>Search and Secure</font>
	<br/>Once you have gathered intelligence and identified a possible location, proceed to search the area thoroughly. The cache is believed to be hidden within cardboard boxes, so be vigilant and check any such containers you come across.
	<br/>
	<br/><font color='#FF7F00'>Containment</font>
	<br/>If you find the cache, establish a secure perimeter to prevent any CSAT forces from interfering with the operation.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>Once the cache is secured, hold the area and Commander may call the mission complete.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
