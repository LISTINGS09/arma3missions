...
if (side group player != CIVILIAN) then {
	...
	<br/>The recent political unrest has led to heightened tensions between various factions in the region. The Free Independent Army has obtained crucial intelligence documents, and they are scheduled to exchange them with CSAT forces at an outpost located outside of Kavala. The documents contain sensitive information that could compromise operations in the area.
	<br/>
	<br/>Your mission is to infiltrate an outpost outside of Kavala where the FIA is exchanging intelligence documents with CSAT forces. Your task is to steal the intelligence document before the exchange is completed and safely extract it.
	<br/>
	<br/><font color='#FF7F00'>1.</font>Infiltrate the outpost undetected.
    <br/><font color='#FF7F00'>2.</font>Neutralize any guards and secure the area around the intelligence exchange point.
    <br/><font color='#FF7F00'>3.</font>Retrieve the intelligence document from the designated location.
    <br/><font color='#FF7F00'>4.</font>Ensure the safety of the document and prepare for extraction.
    <br/><font color='#FF7F00'>5.</font>Exfiltrate the area using a predetermined escape route while evading enemy patrols and reinforcements.
	<br/>
	<br/>
