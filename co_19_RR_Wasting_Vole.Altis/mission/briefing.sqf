...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to secure a warehouse containing radioactive waste materials located to the north of Zaros. Intelligence reports indicate that Insurgent forces have occupied the area and may have intentions to either use or sell the barrels of radioactive materials, which poses a significant threat to both regional stability and public safety.
	<br/>
	<br/><font color='#FF7F00'>Secure the Warehouse</font>
    <br/>Eliminate all hostile forces at the warehouse and establish control of the area.
	<br/>
	<br/><font color='#FF7F00'>Locate and Secure</font>
    <br/>Once the warehouse is under control, locate and secure the barrels with radioactive waste.
	<br/>
	<br/><font color='#FF7F00'>Exfiltration</font>
    <br/>Once the materials are secured, the Commander should plan an exfiltration route to ensure the safe passage of the radioactive materials to a designated NATO facility.
	<br/>
