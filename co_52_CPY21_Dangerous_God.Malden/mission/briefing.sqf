...
if (side group player != CIVILIAN) then {
	...
	<br/>1. Neutralise the crew of a speedboat docked somewhere along the coast.
	<br/>2. Locate and disable a mortar position somewhere in the mountains.
	<br/>3. Destroy the AAA vehicle overlooking the Western sea.
	<br/>4. Clear the checkpoint outside the town of La Pessagne.
	<br/>
	<br/>%1
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>All squads have landed at the shore and must move inland on foot.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>CTRG forces are dispersed across the area with light infantry and vehicles patrolling the AO.
	<br/>
	<br/>While clearing La Pessagne is not required, the town contains a number of garrisoned enemy units and at least one IFV. If not dealt with, these may make completing nearby objectives difficult.
	<br/>
	<br/>Any additional CTRG QRF/Support units are not expected to enter the AO.
	<br/>
