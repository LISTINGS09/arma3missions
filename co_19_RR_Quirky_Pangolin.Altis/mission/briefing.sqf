...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to infiltrate the Russian forces' compounds outside Zaros and steal money from their two separate warehouses. Each warehouse contains a laptop which must be used to transfer funds to our accounts. The success of this operation heavily relies on stealth and precision.
	<br/>
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Approach the compound covertly, avoiding detection by enemy patrols and vehicles.
	<br/>Utilize the cover of darkness (if possible) and natural terrain to your advantage.
	<br/>
	<br/><font color='#FF7F00'>Warehouse Reconnaissance</font>
	<br/>Gather intelligence on the layout of the warehouses, guard patrols, and security measures in place.
	<br/>Identify the locations of the laptops within each warehouse.
	<br/>
	<br/><font color='#FF7F00'>Stealthy Acquisition</font>
	<br/>Move silently and eliminate guards without raising alarm whenever necessary.
	<br/>Utilize distraction techniques to divert attention away from your main objectives.
	<br/>
	<br/><font color='#FF7F00'>Fund Transfer</font>
	<br/>Use the acquired laptops to transfer funds to our designated offshore accounts.
	<br/>Ensure that the transfer is completed successfully before exfiltration.
	<br/>
	<br/>
