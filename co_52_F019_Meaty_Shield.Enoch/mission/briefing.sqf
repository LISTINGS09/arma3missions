...
if (side group player != CIVILIAN) then {
	...
	<br/>CSAT forces have established a Communication Tower in the hills at Branzow Castle.
	<br/>
	<br/>Move into enemy territory and ensure the tower is destroyed.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	<br/>
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>Up to five squads must move across the AO on foot.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>Enemy minefields are present in the area, tread carefully.
	<br/>
	<br/>The following units are also known to be operational in the AO:
	<br/>%2%3
	<br/>
