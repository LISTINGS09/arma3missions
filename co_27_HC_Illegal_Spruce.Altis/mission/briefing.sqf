...
if (side group player != CIVILIAN) then {
	...
	<br/>NATO forces have recently established an outpost in the town of Charkia, using it as a staging ground for sensitive operations and training. Intelligence reports indicate that critical training data, potentially outlining their troop movements, strategies, and operational plans, is being stored at this location. The data would provide CSAT with a significant advantage in future engagements across the region.
	<br/>
	<br/>Your task is to lead a CSAT strike team to secure this vital training data from the NATO outpost. The operation must be swift and decisive to prevent NATO reinforcements from responding. Your objective is to infiltrate the outpost, eliminate any hostile resistance, retrieve the data, and extract safely.
	<br/>
	<br/>%4
	<br/>
	<br/>%1 <!--- Casualties Cap --->
