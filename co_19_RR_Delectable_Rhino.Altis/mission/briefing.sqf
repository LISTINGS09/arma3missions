...
if (side group player != CIVILIAN) then {
	...
	<br/>Our intelligence sources have identified a critical CSAT (Canton-Protocol Strategic Alliance Treaty) Fuel Dump located near Ifestiona. This fuel dump is crucial for sustaining CSAT's military operations in the region. CSAT has established a formidable presence in the region and their fuel dump near Ifestiona is a linchpin in their logistics network.
	<br/>
	<br/>Our recent reconnaissance has revealed vulnerabilities in their defences, which we must exploit to achieve our objective. The area is heavily guarded, with patrols and static defences. Expect stiff resistance from CSAT forces.
	<br/>
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>The operation will commence with a covert insertion at a location outside of the AO as chosen by the Commander.
	<br/>
	<br/><font color='#FF7F00'>Sabotage</font>
	<br/>Once inside the AO, teams will move swiftly to the fuel dump. The primary objective is to sabotage the fuel storage pods at the dump. Explosive charges will be required for this purpose.
	<br/>
	<br/><font color='#FF7F00'>Neutralization of Defences</font>
	<br/>Concurrently, teams will engage and neutralize CSAT patrols and defensive positions to ensure the success of the sabotage mission. Use stealth and surprise to your advantage.
	<br/>
	<br/><font color='#FF7F00'>Exfiltration</font>
	<br/>After completing the mission objectives, all teams will rendezvous at an extraction point for exfiltration.
	<br/>	
	<br/>	
