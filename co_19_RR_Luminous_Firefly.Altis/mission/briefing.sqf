...
if (side group player != CIVILIAN) then {
	...
	<br/>Our intelligence has confirmed the presence of a Russian barracks near Lakka, Altis. The barracks are being used as a strategic stronghold by the Russian forces, posing a significant threat to our operations in the region. It is imperative that we neutralize this threat to maintain control and security over the area.
	<br/>
	<br/>Your mission is to lead a detachment of AAF forces in a coordinated assault on the Russian barracks near Lakka. The primary objective is the complete destruction of the barracks and any enemy forces present within the compound.
	<br/>
	<br/>
	<br/><font color='#FF7F00'>Reconnaissance</font>
	<br/>Begin by conducting thorough reconnaissance of the area surrounding the Russian barracks. Gather intel on enemy positions, fortifications, and any potential obstacles or hazards.
	<br/>
	<br/><font color='#FF7F00'>Planning</font>
	<br/>Develop a detailed plan of attack based on the reconnaissance findings. Identify key points of entry, potential avenues of approach, and any vulnerabilities in the enemy defences.
	<br/>
	<br/><font color='#FF7F00'>Assault</font>
	<br/>Initiate the assault on the Russian barracks to overwhelm the enemy defences. Coordinate with supporting elements and maintain communication throughout the operation.
	<br/>
	<br/><font color='#FF7F00'>Destruction</font>
	<br/>Once inside the compound, prioritize the destruction of critical infrastructure, namely the building itself. Neutralize any enemy resistance encountered and secure the area to prevent counterattacks.
	<br/>
	<br/><font color='#FF7F00'>Exfiltration</font>
	<br/>Upon completion of the mission objectives, withdraw your forces from the area and regroup at a chosen extraction point for debriefing.
	<br/>
	<br/>
