...
if (side group player != CIVILIAN) then {
	...
	<br/>Commander, you are about to embark on a critical operation codenamed '%4'. The success of this mission is of utmost importance to our mission objectives.
	<br/>
	<br/>Check the 'Task' tab for the mission brief and plan in-game.
	<br/>
	<br/><font color='#80FF00'>Rules of Engagement (ROE)</font>
    <br/>Use lethal force only when necessary.
    <br/>Avoid civilian casualties at all costs.
    <br/>Prioritize any targets of opportunity. 
	<br/>
	<br/>%1 <!--- Casualties Cap --->
