...
if (side group player != CIVILIAN) then {
	...
	<br/>Our group is planning to fund our next operation by hacking three ATMs in the NATO controlled town of La Trinite. While this operation is not without risk, it is a critical component of our larger strategic goals.
	<br/>
	<br/>Your mission is to carry out the hacking operation and acquire the necessary funds to support our next operation. You must act quickly, as any delay could jeopardize our plans and put our broader mission at risk.
	<br/>
	<br/>Your primary objectives are as follows:
	<br/>Identify the exact location of the ATMs.
	<br/>Protect the Engineer while they carry out the hacking operation and acquire the necessary funds to support our next operation.
	<br/>Ensure the safety of our team members and prevent any collateral damage.
	<br/>
	<br/>Maintain a low profile and avoid drawing attention to our group's involvement in the operation.
	<br/>
	<br/>Once complete you are to withdraw from the area.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	...
	<br/>%2%3
	<br/>
	<br/>The town itself is not heavily occupied but expect NATO garrisons to be guarding the ATMs.
	<br/>
	<br/>Additional QRF forces can be expected from outside the area upon your detection.
	<br/>
