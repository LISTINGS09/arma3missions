...
if (side group player != CIVILIAN) then {
	...
	<br/>The region of Agios Dionysios has been identified as a significant insurgent stronghold with FIA and Syndikat forces working together, housing key assets and facilities. Our primary objective in this operation is to locate and disable a Main Battle Tank (MBT) being repaired at an insurgent workshop. It is believed that this MBT is a significant threat to regional stability and sabotaging its engine is essential to disrupt insurgent operations.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Your forces will insert near the outskirts of Agios Dionysios at a location designated by the Commander.
	<br/>
	<br/><font color='#FF7F00'>Locate the Workshop</font>
    <br/>Move covertly through the area, avoiding civilian contact. Your primary objective is to locate the insurgent workshop believed to house the MBT and its parts.
	<br/>
	<br/><font color='#FF7F00'>Disable the MBT Engine</font>
    <br/>Once the workshop is located, approach with extreme caution. Your team's priority is to sabotage the engine there. It will have been removed from the MBT. An engineer will be able to interact with the Engine.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
    <br/>After disabling the engine, rendezvous at an extraction point marked by the Commander.
	<br/>
