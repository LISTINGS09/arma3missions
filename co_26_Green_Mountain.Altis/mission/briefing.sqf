...
if (side group player != CIVILIAN) then {
	...
	<br/>Our intelligence has confirmed the presence of three insurgent caches around the village of Edessa, a key stronghold for the hostile forces operating in the region. These caches contain weapons, ammunition, and other supplies, which are vital to their operations. Our primary objective is to locate and neutralize these caches, denying the insurgents their much-needed resources.
	<br/>
	<br/>Furthermore, the enemy has established a communications tower just outside Edessa, enabling them to coordinate their activities effectively. Disrupting their communications network is crucial to impair their operational capabilities and hamper their ability to coordinate attacks against our forces. The destruction of this tower will significantly weaken their command structure.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
