...
if (side group player != CIVILIAN) then {
	...
	<br/>Enemy Air forces are enroute to the island, locate and secure an AA launcher to eliminate them.
	<br/>
	<br/>Locate and destroy two CTRG Artillery Assets.
	<br/>
	<br/>%1
	<br/>
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>Each team has one light vehicle to move around the AO, there are no other friendly forces in the area.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>CTRG patrols will be moving across the region, supported by mechanised and motorised vehicles.
	<br/>
	<br/>Neither the AA Cache and Artillery positions are not expected to be heavily defended.
	<br/>
	<br/>Enemy Blackfoot gunships are expected to enter Malden airspace within the next 40 minutes, ensure you have secured the AA Cache before their arrival. 
	<br/>
