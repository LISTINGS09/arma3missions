...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to secure the AAF Fuel Dump located just outside the town of Molos. The objective is to eliminate all enemy forces at the location and destroy the Diesel Tank. This is a high-priority operation that will disrupt the enemy's fuel supply, crippling their mobility in the region.
	<br/>
	<br/><font color='#FF7F00'>Eliminate All Enemy Contacts</font>
	<br/>Sweep the area and neutralize all AAF forces. Be cautious of any potential reinforcements.
	<br/>
	<br/><font color='#FF7F00'>Destroy the Diesel Tank</font>
    <br/>Plant explosives on the Diesel Tank to ensure its destruction.
	<br/>
