...
if (side group player != CIVILIAN) then {
	...
	<br/>The FIA insurgents have been using a covert camp east of Paros to store sensitive intelligence data. Recent reconnaissance has confirmed the presence of two servers containing high-value intelligence that could jeopardize ongoing AAF operations on Altis. The camp is heavily guarded, and the insurgents are expected to defend their assets with force.
	<br/>
	<br/>Your task is to lead an AAF strike team to locate and destroy the FIA intelligence data stored on two servers within the camp. Erase all data from the servers and ensure that the FIA does not retain any valuable information. Success in this mission will deal a significant blow to FIA operations.
	<br/>
	<br/>%4
	<br/>
	<br/>%1 <!--- Casualties Cap --->
