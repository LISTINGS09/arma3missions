...
if (side group player != CIVILIAN) then {
	...
	<br/>We have received intel that a CBRN (Chemical, Biological, Radiological, and Nuclear) container has been hidden by CSAT forces in the area. 
	<br/>
	<br/>Your mission is to locate and secure the container before it can be used against our forces or innocent civilians.
	<br/>
	<br/>The container is believed to be well-hidden, so we cannot provide you with an exact location. However, our intelligence sources have indicated that it may be located in one of two areas and the container itself is concealed in a small cardboard box.
	<br/>
	<br/>The container is extremely dangerous and must be handled with extreme caution. It may contain a variety of hazardous substances, including biological agents, toxic chemicals, or radioactive materials.
	<br/>
	<br/>We cannot stress enough the importance of wearing full protective gear and following proper handling procedures. Your team will consist of specially trained CBRN response personnel, along with additional support from our conventional forces.
	<br/>
	<br/>We do not know how much time we have before CSAT forces attempt to move or use the container. Your success in this mission could mean the difference between life and death for many innocent people.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
