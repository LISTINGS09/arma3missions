...
if (side group player != CIVILIAN) then {
	...
	<br/>Assault the town of Grabin and eliminate a NATO Armoured Platoon.
	<br/>
	<br/>Once inside the town, destroy the <marker name='marker_1'>Communications Tower</marker>, capture the <marker name='marker_2'>Barracks</marker> and eliminate two SAM sites known to be within the town.
	<br/>
	<br/>%1 <!-- Casualties Cap -->
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>Up to five squads, each with one APC for support.
	<br/>
