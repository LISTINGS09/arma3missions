...
if (side group player != CIVILIAN) then {
	...
	<br/>FIA has been pushing far into Malden over the recent weeks. It is time to push them back. 
	<br/>
	<br/>Your task is simple; neutralise the FIA Outpost.
	<br/>
	<br/>%1
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>Alpha and Bravo have one armoured APC each, the remaining squads have one unarmed transport.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>FIA has captured a number of IFVs which are believed to be deployed near the Outpost.
	<br/>
	<br/>A mortar position is also active within the Outpost, expect it to support enemy infantry across the AO.
	<br/>
	<br/>No additional QRF is expected.
	<br/>
