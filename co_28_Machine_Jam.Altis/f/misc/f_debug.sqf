...
if (count ((allMissionObjects "ModuleTaskSetState_F") select { _x getVariable "State"  isEqualTo "Assigned" }) > 0) then { ["f_debug.sqf","Task Status is 'Assigned'! Not set to 'Succeed' or 'Failure' is this correct?"] call f_fnc_logIssue };
