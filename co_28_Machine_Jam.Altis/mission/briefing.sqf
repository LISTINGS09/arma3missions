...
if (side group player != CIVILIAN) then {
	...
	<br/>We are operating in the region of Kore on the island of Altis. The primary objective is to capture an Insurgent Weapons Factory located outside of Kore. The area is known to be heavily fortified, and it is currently under the control of Insurgent forces. The terrain consists of hills with scattered vegetation and limited civilian presence.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
