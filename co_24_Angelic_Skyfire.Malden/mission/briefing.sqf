...
if (side group player != CIVILIAN) then {
	...
	<br/>Our mission is to recover a weapons cache currently held by Russian forces in a Northern Outpost. 
	<br/>	
	<br/>This cache is critical to our cause and holds valuable resources that we can use to further our operations in the region.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
