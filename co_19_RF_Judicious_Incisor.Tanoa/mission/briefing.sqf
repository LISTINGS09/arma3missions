...
if (side group player != CIVILIAN) then {
	...
	<br/>The political instability in the region has led to increased tensions between the government and various rebel factions, including the FIA. Intelligence reports indicate that a significant sum of money, believed to be intended for financing rebel activities, has been lost somewhere in the dense jungle terrain.
	<br/>
	<br/>The FIA is also aware of the money's existence and is actively searching for it. If they get their hands on it, it could significantly bolster their capabilities and escalate the conflict.
	<br/>
	<br/>Your mission is to locate and secure the crate of money before the FIA can find it. Time is of the essence, as failure to retrieve the funds could have severe consequences for the stability of the region.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Deploy your forces to the designated area of operations, utilizing stealth and caution to avoid detection by FIA patrols.
	<br/>
	<br/><font color='#FF7F00'>Search and Reconnaissance</font>
	<br/>Once in the jungle, conduct thorough search and reconnaissance operations to locate any signs or intelligence regarding the whereabouts of the money crate. Utilize both ground and aerial assets for maximum coverage.
	<br/>
	<br/><font color='#FF7F00'>Secure the Money</font>
	<br/>Once the crate is located, secure it immediately and establish a perimeter to prevent any FIA attempts to reclaim it. Exercise extreme caution, as the FIA may attempt to ambush your forces during the extraction.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>Extract the money from the crate from the jungle and transport it to a secure location for further analysis and processing.
	<br/>
	<br/>
