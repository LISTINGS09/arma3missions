...
_baseGlasses = ["","G_Balaclava_blk","G_Bandanna_shades","G_Sport_Blackred","G_Bandanna_aviator","G_Bandanna_CandySkull","G_Aviator"];
...
if (_isMan) then {
	...
	_unit addItem "H_Bandanna_blu";	// Free hat!
};
