...
if (side group player != CIVILIAN) then {
	...
	<br/>A transport helicopter carrying cargo boxes crashed somewhere over Amfissa.
	<br/>
	<br/>Four of these boxes are known to have landed somewhere in the area and one of these boxes is known to contain weapons - Locate the box containing the weapons, take the contents and then extract from the area.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
