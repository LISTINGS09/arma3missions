...
_grpIND = [
	...
	,["GrpIND_MMG1","MMG1","b_support","MG1",_orange]
	,["GrpIND_MMG2","MMG2","b_support","MG2",_orange]
	,["GrpIND_MAT1","MAT1","b_motor_inf","AT1",_purple]
	,["GrpIND_MAT2","MAT2","b_motor_inf","AT2",_purple]
	,["GrpIND_MTR1","MTR","b_mortar","MTR",_white]
];