...
if (side group player != CIVILIAN) then {
	...
	<br/>Your FIA forces are tasked with neutralizing a Syndikat-occupied Fuel Station located outside of Nicolet. The mission involves destroying the fuel pumps and eliminating all hostile infantry present in the area.
	<br/>
	<br/>The Syndikat forces have taken control of the Fuel Station located strategically outside Nicolet, posing a significant threat to the local populace and FIA operations in the region. Intelligence reports indicate that the Syndikat insurgents have fortified their position, utilizing the Fuel Station as a logistical hub for their illicit activities.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Approach the area cautiously to avoid detection. Scout the vicinity for enemy patrols and defensive positions.
	<br/>
	<br/><font color='#FF7F00'>Neutralization of Fuel Pumps</font>
	<br/>Once in position, proceed to sabotage the fuel pumps to deny the enemy their logistical advantage.
	<br/>
	<br/><font color='#FF7F00'>Elimination of Hostile Infantry</font>
	<br/>Engage and eliminate any Syndikat infantry encountered within the vicinity of the Fuel Station. Exercise caution to minimize civilian casualties and collateral damage.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>Once the objectives are complete, exfiltrate the area swiftly to avoid enemy reinforcements.
	<br/>
	<br/>		
