...
if (side group player != CIVILIAN) then {
	...
	<br/>Your FIA forces have received credible intelligence that a high-ranking CSAT (Canton-Protocol Strategic Alliance Treaty) officer is present near Agios Petros, Altis. This officer is a key figure responsible for coordinating the oppressive occupation of our homeland. Eliminating him will significantly disrupt CSAT operations on the island.
	<br/>
	<br/>The officer will be accompanied by a well-armed escort, so caution is of the utmost importance. This operation must be carried out swiftly and with precision to avoid unnecessary casualties.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Infiltrate the area near Agios Petros discreetly, taking advantage of the cover provided by the terrain.
	<br/>
	<br/><font color='#FF7F00'>Locate</font>
	<br/>Locate the CSAT officer. Reconnaissance suggests that he will be in a heavily guarded compound.
	<br/>
	<br/><font color='#FF7F00'>Eliminate</font>
    <br/>Eliminate the CSAT officer. Priority target. Ensure that your sniper has a clear shot.
	<br/>
	<br/><font color='#FF7F00'>Verify</font>
    <br/>Once the officer is eliminated, move in, secure the area and verify the target. 
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>Disengage and exfiltrate the area. If possible, collect any valuable intel from the officer's body or the compound.
	<br/>%1 <!--- Casualties Cap --->
