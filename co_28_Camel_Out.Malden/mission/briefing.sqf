...
if (side group player != CIVILIAN) then {
	...
	<br/>Intelligence sources have confirmed that NATO Commander, codename 'Harkin' is hiding within a fortified compound near La Riviere. Harkin is a key figure in the NATO command structure, and his capture could provide us with valuable information to further our cause.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>The following units are known to be operational in the AO, additional QRF can be expected from the East.
	<br/>%2%3
	<br/>High Threats:
	<br/>%4
	<br/>
