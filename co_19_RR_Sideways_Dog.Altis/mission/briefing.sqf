...
if (side group player != CIVILIAN) then {
	...
	<br/>Our intelligence indicates that NATO has set up a significant anti-aircraft defense network near the town of Athira on the island of Altis. This network poses a substantial threat to our air assets in the region. Your mission is to disable two MIM-145 Defender AA systems that are key components of this network.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
    <br/>Your team will deploy to a location designated by the Commander approximately 1 kilometer from the objective. Once on the ground, proceed on foot to the target area.
	<br/>
	<br/><font color='#FF7F00'>Primary Objective</font>
    <br/>Locate and disable the two MIM-145 Defender AA systems. These systems are likely to be well-guarded, so proceed with caution. You may need to neutralize any NATO forces guarding these assets.
	<br/>
	<br/><font color='#FF7F00'>Secondary Objective</font>
    <br/>Avoid civilian casualties and minimize collateral damage. Athira is a civilian-populated area and we cannot afford to harm innocent civilians.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
    <br/>After completing your mission objectives, proceed to the extraction point as chosen by the Commander.
	<br/>
