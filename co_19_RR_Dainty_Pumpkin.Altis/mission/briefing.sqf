...
if (side group player != CIVILIAN) then {
	...
	<br/>CSAT forces have identified two IDAP (International Development and Aid Project) trucks in the possession of the AAF. These vehicles are vital for humanitarian operations on the island. Your mission is to secure these trucks, locate their whereabouts, and ensure the area is secured for later recovery by IDAP personnel. The AAF are considered hostile in this context.
	<br/>
	<br/><font color='#FF7F00'>Locate IDAP Water Trucks</font>
    <br/>Your primary objective is to locate and secure the two missing IDAP Water trucks, adding a tracking device to each of them. Intelligence suggests they are held in the vicinity of the Agela Mountain area.
	<br/>
	<br/><font color='#FF7F00'>Secure the Area</font>
    <br/>Eliminate any AAF forces in the area. Ensure it is safe for IDAP personnel to recover the vehicles.
	<br/>
