...
if (side group player != CIVILIAN) then {
	...
	<br/>Our intelligence indicates the presence of a bandit cache near the town of Vatukoulo. The cache is believed to contain weapons, ammunition, and other supplies that are being used by local bandit groups to destabilize the region. Your task is to locate and secure this cache to prevent further harm to civilians and maintain stability in the area.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Your squad will infiltrate the area starting at a location chosen by the Commander. Use stealth and caution to avoid alerting the enemy.
	<br/>
	<br/><font color='#FF7F00'>Reconnaissance</font>
	<br/>Once in the vicinity of the suspected cache location, conduct thorough reconnaissance to gather intelligence on enemy positions, patrols, and potential defensive measures.
	<br/>
	<br/><font color='#FF7F00'>Engagement</font>
	<br/>Employ a combination of stealth and decisive action to neutralize any enemy resistance encountered. Utilize suppressive fire and coordinated manoeuvres to maintain the element of surprise.
	<br/>
	<br/><font color='#FF7F00'>Securing the Cache</font>
	<br/>Upon locating the bandit cache, establish a perimeter to prevent enemy reinforcements from interfering. Secure the cache and gather any valuable intelligence for further analysis.
	<br/>
	<br/><font color='#FF7F00'>Completion</font>
	<br/>Once the cache is secured, be prepared for potential enemy counterattacks and the Commander is to call mission complete when deemed safe.
	<br/>
	<br/>
