...
if (side group player != CIVILIAN) then {
	...
	<br/>Our mission is to clear out NATO strongholds within the city of Pyrgos. We have received intelligence that NATO forces have established several key defensive positions throughout the city, which are hindering our progress in the region.
	<br/>
	<br/>Your objectives are as follows:
	<br/>
	<br/>1. Neutralize all NATO forces within the three designated buildings.
	<br/>2. Secure the town and establish control over the strategic points.
	<br/>3. Minimize collateral damage and civilian casualties.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	...
	<br/>%2%3
	<br/>
	<br/>Expect NATO reinforcements from outside of the AO to attempt to re-occupy the town.
	<br/>
