...
if (side group player != CIVILIAN) then {
	...
	<br/>AAF forces have captured a 'medical truck' containing 'aid supplies'. Any reference to chemical weapons being stored within the truck are incorrect speculation from the AAF. 
	<br/>
	<br/>Re-capture the truck and bring it safely back.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>One platoon of up to five squads; Alpha, Bravo, Charlie, Delta and Echo begin <font color='#0080FF'><marker name='respawn_east'>here</marker></font color>.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>A number of AAF APCs are known to be in defensive positions around the AO, you may need to manoeuvre into a suitable firing position to engage them.
