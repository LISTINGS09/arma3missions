...
if (side group player != CIVILIAN) then {
	...
	<br/>The objective of this mission is for your forces to capture a CSAT Medical helicopter.
	<br/>
	<br/>CSAT has been using the Medical helicopter to transport high-value targets in the area. Your forces have been tasked to capture the helicopter to gain valuable intel and to disrupt CSAT operations in the area.
	<br/>
	<br/>The Medical helicopter is located at a CSAT Outpost, heavily guarded by Viper forces.
	<br/>
	<br/>Once the helicopter is secure, move to the helicopter and unlock it. The ground vehicles and friendly aircraft will provide cover and support during the extraction.
	<br/>
	<br/>Your forces must extract the Medical helicopter to a safe location. You should be prepared to face heavy resistance from enemy forces during the operation.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
