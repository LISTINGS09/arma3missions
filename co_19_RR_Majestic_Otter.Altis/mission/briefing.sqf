...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission, as part of the Altis Armed Forces, is to rescue a downed pilot who ejected from his aircraft after being hit by enemy fire. The pilot has landed near a FIA Outpost located outside of Abdera. The FIA forces are likely to be on high alert, so execute caution and precision in your operation.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Approach the area with caution, utilizing stealth and reconnaissance to gather intel on enemy positions and movements. The FIA Outpost can be identified by a flag.
	<br/>
	<br/><font color='#FF7F00'>Rescue Operation</font>
	<br/>Once you have located the downed pilot, neutralize any immediate threats and secure the area to extract the pilot safely.
	<br/>
	<br/><font color='#FF7F00'>Exfiltration</font>
	<br/>After successfully rescuing the pilot, exfiltrate the area swiftly to avoid any potential counterattacks from the FIA forces.
	<br/>
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>The FIA outpost is likely to be guarded by a substantial force of rebel fighters. Expect light to moderate infantry resistance, as well as potential vehicular support such as technicals or light armoured vehicles. The FIA forces are well-armed and highly motivated, posing a significant threat to our operation.
	<br/>
