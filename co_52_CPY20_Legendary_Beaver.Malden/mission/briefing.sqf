...
if (side group player != CIVILIAN) then {
	...
	<br/>FIA have been storing a number of munitions in two bunkers hidden somewhere in the hills. 
	<br/>
	<br/>Locate two intelligence documents in the area to identify the locations of the bunkers somewhere nearby, then detonate explosives at the entrances to block them.
	<br/>
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>The platoon begins at a <font color='#0080FF'><marker name='respawn_east'>Small Island</marker></font color> off the coast.
	<br/>
	<br/>Each squad has 2x RHIBs to make it to shore.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>Rebel forces are numerous in this sector, expect to encounter patrols and static emplacements. 
	<br/>
	<br/>A number of IFVs, captured from AAF forces by FIA are also known to be operational in the area, look out for them near Houdan.
	<br/>
