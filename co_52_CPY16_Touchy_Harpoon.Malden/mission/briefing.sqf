...
if (side group player != CIVILIAN) then {
	...
	<br/>Leave Malden airspace by capturing two NATO Air Transports.
	<br/>
	<br/>Both NATO V-44 Transports are located at a nearby Airport - You will need to eliminate both Pilots in order to gain access to the vehicles.
	<br/>
	<br/>Ensure the island is clear of enemy AA before attempting to leave the island, you will fail the mission if either transport is destroyed.
	<br/>
	<br/>%1
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>NATO forces have occupied the Airport and surrounding area, expect patrols and light support vehicles.
	<br/>
	<br/>Additional NATO QRF can be expected from the mainland, intent on preventing your forces from leaving the island. 
	<br/>
