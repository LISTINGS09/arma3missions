...
_flashHider = "";
_silencer1 = ["muzzle_snds_58_blk_F","muzzle_snds_58_hex_F"]; // Rifleman
...
_rifle = ["arifle_ARX_blk_F","arifle_ARX_hex_F","arifle_CTAR_hex_F"];
_riflemag = "30Rnd_65x39_caseless_green";
_riflemag_tr = "30Rnd_65x39_caseless_green_mag_Tracer";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = ["arifle_ARX_blk_F","arifle_ARX_hex_F","arifle_CTAR_hex_F"];
...
_glrifle = ["arifle_CTAR_GL_blk_F","arifle_CTAR_GL_hex_F"];
...
_bagmedium = "B_ViperLightHarness_blk_F";	// carries 200, weighs 30
...
// Automatic Rifleman
_AR = ["arifle_CTARS_blk_F","arifle_CTARS_hex_F"];
