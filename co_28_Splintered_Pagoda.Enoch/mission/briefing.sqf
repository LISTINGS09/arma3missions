...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to secure a factory located near Sitnik that is currently occupied by insurgent forces. The factory is critical to the war effort, and its capture will deal a significant blow to the enemy.
	<br/>
	<br/>The insurgents have planted a series of (two) bombs throughout the factory to prevent our forces from taking control. Your first priority is to locate and diffuse these bombs. The insurgents are likely to have booby-trapped the area around the bombs, so approach with caution.
	<br/>
	<br/>Once the bombs have been taken care of, your objective is to clear out the insurgents from the factory and secure the area. The enemy is likely to be well-armed and highly motivated, so be prepared for a tough fight.
	<br/>
	<br/>Your team has been equipped with the latest in CSAT weaponry and technology. Use your gear to your advantage and work together to achieve victory. Keep in mind that the enemy will be watching for any weaknesses in our approach, so stay alert and stay focused.
	<br/>
	<br/>Good luck, soldiers. Your success in this mission will be critical to the overall war effort. Remember, failure is not an option. The fate of our nation rests on your shoulders.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
