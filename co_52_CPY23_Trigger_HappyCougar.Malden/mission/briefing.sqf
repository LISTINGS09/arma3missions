...
if (side group player != CIVILIAN) then {
	...
	<br/>CSAT forces have recently landed and taken control of Le Port Harbour. 
	<br/>
	<br/>Enter the town and re-take the area, ensure civilian casualties are kept below 3.
	<br/>
	<br/>%1
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>Mechanised and motorised CSAT forces will be present near the Harbour with smaller infantry patrols across the AO.
	<br/>
	<br/>Following heavy mortar strikes by allied forces, most CSAT forces have fortified a number of houses in the area and patrols across the AO should be limited.
	<br/>
	<br/>No other additional QRF forces are expected.
	<br/>
