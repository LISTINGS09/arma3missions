...
if (side group player != CIVILIAN) then {
	...
	<br/>Your objective is to capture a wounded Syndikat leader who is believed to be hiding in the forest to the west of the Blue Pearl Port. The Syndikat leader is a high-value target and capturing him alive will significantly weaken Syndikat's influence in the region.
	<br/>
	<br/>
	<br/><font color='#FF7F00'>Search and Secure</font>
	<br/>Once inside the forest, conduct a thorough search to locate the wounded Syndikat leader. Be cautious of enemy patrols and traps they might have set up.
	<br/>
	<br/><font color='#FF7F00'>Capture the Target</font>
	<br/>When the Syndikat leader is located, proceed with extreme caution. Your primary objective is to capture him alive.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>Once the target is secured, proceed to an extraction point as designated by the Commander. Be prepared for potential enemy counterattacks.
	<br/>
	<br/>
