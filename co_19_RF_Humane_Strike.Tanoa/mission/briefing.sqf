...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to secure and capture the Gendarme Training Facility located in Saint-Julien. The facility is currently under the control of Gendarme forces and is being used to train their recruits. Syndikat leadership has identified this facility as a strategic asset that must be seized to weaken Gendarme influence in the region.
	<br/>
	<br/>Saint-Julien is a critical location for both Syndikat and Gendarme forces due to its strategic position and access to vital resources. The Gendarme Training Facility is heavily fortified and defended by a well-trained garrison. Intelligence reports suggest that the facility houses advanced weaponry and equipment, making it a high-value target.
	<br/>	
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>The Gendarme forces stationed at the training facility are highly trained and well-equipped. Expect to encounter infantry patrols, armed vehicles and fortified positions. The enemy is likely to have established defensive emplacements, including machine gun nests. Additionally, be prepared for potential reinforcements from Georgetown nearby.
	<br/>
