...
if (side group player != CIVILIAN) then {
	...
	<br/>Identify and mark the location of three hidden caches within Russian territory near Athira.
	<br/>
	<br/>Ensure the caches and their contents are not destroyed so FIA can loot them later.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
