...
if (side group player != CIVILIAN) then {
	...
	<br/>Our mission is to secure a fuel station currently held by NATO forces near Chalkeia. This fuel station is a critical strategic asset that can significantly impact our operations in the region, and its capture will weaken NATO's supply lines.
	<br/>
	<br/>Your objectives are as follows:
	<br/>1. Neutralize all NATO forces at the fuel station.
	<br/>2. Secure the area and establish control over the fuel station by destroying the two MBTs defending the area.
	<br/>
	<br/>Success in capturing the fuel station will give us a significant advantage over NATO forces and strengthen our supply lines.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
