...
if (side group player != CIVILIAN) then {
	...
	<br/>Last month, Rebel forces raided a nearby motor pool and captured three 'Gorgon' APCs. 
	<br/>
	<br/>They have been spotted moving north of Le Port and your unit has been tasked with their destruction.
	<br/>
	<br/>%1
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>Expect a high number of enemy patrols and motorised supports in the area. The Rebels lost a lot of men trying to capture the APCs, they're not going to want to see them gone without a fight.
	<br/>
	<br/>No air or artillery supports have been spotted in the area, however a number of static bunkers along the MSR appear to have been occupied by the Rebels.
	<br/>
