...
if (side group player != CIVILIAN) then {
	...
	<br/>The NVA (North Vietnamese Army) has launched a surprise attack and is in the process of capturing an important outpost within the region. The Outpost has been breached. 
	<br/>	
	<br/>Your mission is to help the defenders secure the outpost and eliminate any remaining NVA resistance in the area.
	<br/>
	<br/>Once the HQ is secured, recapture the rest of the Outpost - Defenders should hold the HQ until friendly forces can regain control of the outpost and establish a secure perimeter.
	<br/>
	<br/>Defend the HQ at all costs!
	<br/>
	<br/>%1 <!--- Casualties Cap --->
