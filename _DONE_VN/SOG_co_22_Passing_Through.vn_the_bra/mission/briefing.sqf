...
if (side group player != CIVILIAN) then {
	...
	<br/>The local area been plagued by ongoing civil unrest and insurgency for several years. The United States Marine Corps (USMC) has been deployed as part of a multinational force to restore stability and provide support to the local government. The Xayden Pass, a strategically important mountainous region, has become a stronghold for rebel forces. It is essential to clear the pass to secure vital lines of communication and deny the insurgents a key operational area.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
