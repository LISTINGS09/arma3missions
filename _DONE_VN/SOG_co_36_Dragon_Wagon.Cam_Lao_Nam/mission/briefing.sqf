...
if (side group player != CIVILIAN) then {
	...
	<br/>Attack an NVA Outpost and complete the following objectives;
	<br/>1. Clear the main HQ Building.
	<br/>2. Destroy key installations within the area; a Radar Site and Radio Tower.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
