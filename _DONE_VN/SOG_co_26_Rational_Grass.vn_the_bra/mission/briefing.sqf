...
if (side group player != CIVILIAN) then {
	...
	<br/>Your objective is to eliminate a North Vietnamese Army (NVA) camp located deep within enemy territory. The camp is responsible for refuelling and rearming NVA helicopters, which pose a significant threat to our forces in the region. Your mission is to neutralize the camp, destroy any helicopters present, and disrupt enemy operations in the area.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
