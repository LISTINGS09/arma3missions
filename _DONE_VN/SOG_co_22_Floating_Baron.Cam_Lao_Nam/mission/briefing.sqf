...
if (side group player != CIVILIAN) then {
	...
	<br/>Ha Long Navy Base is a strategic stronghold for the NVA, providing them with a staging area for maritime operations in the region. The presence of the two NVA boats poses a significant threat to our naval assets and the overall stability of the region.
	<br/>
	<br/>Your team will conduct a covert early morning assault on Ha Long Navy Base under the cover of darkness. The element of surprise is crucial for the success of this operation. You are to infiltrate the base, locate and destroy the NVA boats, and extract. Stealth is optional.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
