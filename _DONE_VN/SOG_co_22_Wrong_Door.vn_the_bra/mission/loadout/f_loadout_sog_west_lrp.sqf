...
_baseUniform = ["vn_b_uniform_macv_01_06","vn_b_uniform_macv_02_06","vn_b_uniform_macv_03_06","vn_b_uniform_macv_04_06","vn_b_uniform_macv_05_06","vn_b_uniform_macv_06_06"];
_baseHelmet = ["vn_b_boonie_01_06","vn_b_boonie_02_06","vn_b_boonie_03_06","vn_b_boonie_04_06","vn_b_boonie_05_06"];
_baseGlasses = "";
...
switch (_typeOfUnit) do
{
	...
	{
		["g"] call _backpack;
		_unit addHeadGear "vn_b_beret_01_05";
...
// LOADOUT: CARABINEER
   ...
   default
   {
		...
		if (true) exitWith {diag_log text format ["[F3] DEBUG (f_loadout_sog_west_lrp.sqf): Unit = %1. Gear template %2 does not exist!",_unit,_typeOfUnit]};
   };
