...
if (side group player != CIVILIAN) then {
	...
	<br/>We have received reliable intelligence indicating the presence of a high-ranking North Vietnamese Army (NVA) leader at a Prisoner of War (POW) camp located deep within enemy territory. Your Long Range Reconnaissance Patrol (LRRP) team has been selected to carry out a mission to eliminate this NVA leader. The success of this mission is crucial to disrupt enemy operations and boost the morale of our troops.
	<br/>
	<br/>Mission Objectives:
	<br/>Locate and infiltrate the NVA POW camp.
	<br/>Locate and execute the NVA leader.
	<br/>Extract safely without being detected.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	...
	<br/>%2%3
	<br/>
	<br/>The camp has a number of static AA defences.
	<br/>
