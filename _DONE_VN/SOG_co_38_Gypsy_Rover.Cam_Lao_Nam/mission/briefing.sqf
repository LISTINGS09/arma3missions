...
if (side group player != CIVILIAN) then {
	...
	<br/>NVA forces have attempted to conceal a large shipment of munitions at Sihanoukville. 
	<br/>
	<br/>Secure the warehouses without destroying the munitions so our team can search the area for intelligence.
	<br/>
	<br/>Enemy activity around the AO will be light, so the time to strike is now.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	<br/>
