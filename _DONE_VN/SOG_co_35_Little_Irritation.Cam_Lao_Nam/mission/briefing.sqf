...
if (side group player != CIVILIAN) then {
	...
	<br/>A US convoy was attacked and lost somewhere along the MSR, it is believed the VC have reinforced this area.
	<br/>
	<br/>Patrol along the MSR and eliminate any resistance you encounter.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	<br/>
