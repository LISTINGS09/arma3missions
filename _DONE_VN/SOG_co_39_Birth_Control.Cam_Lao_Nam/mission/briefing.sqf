...
if (side group player != CIVILIAN) then {
	...
	<br/>VC forces have captured a POW and are holding them at one of three known locations. 
	<br/>
	<br/>Locate the POW and return them back to HQ.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>Small patrols can be expected across the AO, enemy intensity will increase the longer you remain within the AO.
	<br/>
