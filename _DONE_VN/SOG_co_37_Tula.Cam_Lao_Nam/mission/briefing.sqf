...
if (side group player != INDEPENDENT) then {
	...
	<br/>An ARVN unit with tank support were ambushed in a large VC attack while travelling near the village of Vong Xo. 
	<br/>
	<br/>Locate the ARVN unit, repair the tank and extract any remaining survivors (ZULU) from the area.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	...
	_exe = player createDiaryRecord ["Diary", ["Mission",format["
	<br/><font size='18' color='#80FF00'>OBJECTIVES</font>
	<br/>You were ambushed in a large VC attack while travelling near the village of Vong Xo. 
	<br/>
	<br/>Having evaded the VC and regrouped, make your way back to the ambush site for rescue.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>The following units are known to be operational in the AO:
