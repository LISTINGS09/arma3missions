...
if (side group player != CIVILIAN) then {
	...
	<br/>Launch a surprise attack on a US outpost in our operational area. Breach the outpost and carry out a coordinated assault, resulting in the destruction of a vital radio tower and several helicopter support assets. 
	<br/>
	<br/>%1 <!--- Casualties Cap --->
