...
// US ARMY
_side = WEST;
ZMM_WESTMan = ["vn_b_men_usmc_68_08","vn_b_men_usmc_68_15","vn_b_men_usmc_68_16","vn_b_men_usmc_68_14","vn_b_men_usmc_68_07","vn_b_men_usmc_68_12","vn_b_men_usmc_68_02","vn_b_men_usmc_68_06"];
_Truck = ["vn_b_wheeled_m54_02_sog"];
_Light = ["vn_b_wheeled_m151_mg_02","vn_b_wheeled_m54_mg_03","vn_b_wheeled_m151_mg_04"];
...
_Heavy = ["vn_b_armor_m67_01_02","vn_b_armor_m41_01_02","vn_b_armor_m48_01_02"];
_Air = ["vn_b_air_uh1c_07_02",""];
_CAS = ["vn_b_air_oh6a_02"]];
...
for [{_wave = 1}, {_wave < _waveMax}, {_wave = _wave + 1}] do {
	...
	switch (_wave) do {
		...
		case 4: {
			[_location, _spawnRoad, _side, selectRandom (_Light + _Truck)] call zmm_fnc_spawnUnit;
			[_location, _spawnRoad, _side, selectRandom (_Air)] call zmm_fnc_spawnUnit;
			[_location, _spawnLand, _side, 4] call zmm_fnc_spawnUnit;
			[_location, _spawnLand, _side, 4] call zmm_fnc_spawnUnit;
			[_location, _spawnLand, _side, 4] call zmm_fnc_spawnUnit;
		};
