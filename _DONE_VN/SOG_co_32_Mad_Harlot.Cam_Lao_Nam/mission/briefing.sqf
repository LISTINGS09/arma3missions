...
if (side group player != CIVILIAN) then {
	...
	<br/>A US MIKE Force unit has been spotted nearby Thud Ridge and poses a direct threat to the AA defences stationed there.
	<br/>
	<br/>Infiltrate the area and ensure the unit is eliminated at all costs.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
