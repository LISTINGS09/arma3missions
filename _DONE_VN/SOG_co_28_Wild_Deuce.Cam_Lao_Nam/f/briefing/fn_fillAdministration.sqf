...
_diaryText = _diaryText + format["<br/>Framework Version: <font color='#00FFFF'>v%1</font><br/>%2%3%4%5%6%7<br/>",
	...
	if (!isNil "ZFH_version") then { format["Fill House: <font color='#00FFFF'>v%1</font><br/>", missionNamespace getVariable ["ZFH_version","0.00"]] } else { "" },
	if (!isNil "ZQR_version") then { format["QRF: <font color='#00FFFF'>v%1</font><br/>", missionNamespace getVariable ["ZQR_version","0.00"]] } else { "" },
