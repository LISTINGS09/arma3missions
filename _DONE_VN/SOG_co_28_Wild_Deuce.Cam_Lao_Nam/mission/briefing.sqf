...
if (side group player != CIVILIAN) then {
	...
	<br/>Land at one of the selected LZs with the aim of retrieving intelligence codes necessary to disable an enemy Anti-Aircraft (AA) defence system from a <marker name='marker_17'>VC Camp</marker>. 
	<br/>	
	<br/>Once the codes are obtained, the team must verify their authenticity by finding and accessing a missile launcher known to be awaiting deployment in <marker name='marker_18'>Attapeu</marker>. 
	<br/>
	<br/>When verified, you will be required to destroy the vehicle and your team should extract safely from the area at <marker name='marker_7'>EX Kettle</marker>.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
