...
if (side group player != CIVILIAN) then {
	...
	<br/>The United States Marine Corps has received intelligence regarding a Prisoner of War (POW) held by the North Vietnamese Army (NVA) at a heavily guarded prisoner camp. The POW, an American pilot, has critical information regarding enemy positions and operations. Your mission is to infiltrate the camp, locate and extract the POW, and return him safely to friendly lines.
	<br/>
	<br/>Objectives:
	<br/>Infiltrate the NVA prisoner camp.
	<br/>Locate and extract the American POW.
	<br/>Secure a suitable extraction point for the POW.
	<br/>Return the POW safely to friendly lines.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
