...
if (side group player != CIVILIAN) then {
	...
	<br/>Our intelligence has confirmed the presence of three North Vietnamese Army (NVA) caches in the region. These caches are believed to contain valuable supplies that are crucial to the enemy's operations. Our objective is to locate and neutralize these caches by mining them with booby-trapped ammunition boxes. This operation is critical in disrupting the enemy's logistics and weakening their fighting capability.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
