...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to capture a high-value target, a FIA officer known to be operating in the vicinity of Topolia. The FIA insurgency continues to pose a significant threat to stability in the region. Recent intelligence reports indicate heightened activity of FIA cells near the Topolia region. The captured officer is expected to possess valuable information regarding FIA leadership, supply lines, and potential future operations.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Move covertly to the vicinity of Topolia, avoiding detection by enemy patrols and surveillance.
	<br/>
	<br/><font color='#FF7F00'>Identification</font>
	<br/>Utilize reconnaissance assets to locate the FIA officer and gather intelligence on their hideout and defences.
	<br/>
	<br/><font color='#FF7F00'>Approach</font>
	<br/>Plan your approach carefully, considering terrain, cover, and potential enemy positions. Use stealth to your advantage to maintain the element of surprise.
	<br/>
	<br/><font color='#FF7F00'>Engagement</font>
	<br/>Execute your plan with precision, neutralizing hostile forces while minimizing collateral damage. Prioritize capturing the FIA officer alive.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>Once the target is secured, extract to the designated area by the Commander. Ensure a safe passage to the extraction point.
	<br/>
	<br/>
