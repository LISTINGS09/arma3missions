...
if (side group player != CIVILIAN) then {
	...
	<br/>Our rebel forces have been actively resisting the presence of the FIA (Freedom and Independence Army) in the region of Ammolofi Bay. We have received credible intelligence indicating that there is a strategically important FIA outpost located to the west of Ammolofi Bay. This outpost is being used to control the area and to store vital supplies and ammunition. Our objective is to locate this outpost and capture the flag located there to demonstrate our control and weaken FIA's presence.
	<br/>
	<br/><font color='#FF7F00'>Locate the Outpost</font>
    <br/>Once you reach the vicinity of the suspected outpost, use binoculars or recon equipment to identify the exact location. Confirm the presence of the FIA flag.
	<br/>
	<br/><font color='#FF7F00'>Capture the Flag</font>
    <br/>When the outpost is located, proceed with extreme caution. Engage and eliminate any enemy resistance as quietly as possible. Locate the flag and raise a NATO flag in its place. This symbolic gesture will signify our control over the area.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
    <br/>After capturing the flag, regroup and prepare for any possible counterattack. If the enemy reinforcements arrive, be ready to defend the outpost. The Commander is to end the mission when the area is deemed secure.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>The FIA has a strong presence in the area. Expect well-armed and well-trained soldiers. They are likely to have small arms, machine guns, and potentially light armored vehicles. Intelligence also suggests that they have set up defensive fortifications around the outpost.
	<br/>
