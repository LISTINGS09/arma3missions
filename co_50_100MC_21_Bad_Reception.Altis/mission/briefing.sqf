...
if (side group player != CIVILIAN) then {
	...
	<br/>Advance inland and eliminate the CSAT radio towers <font color='#0080FF'><marker name='T1'>#1</marker></font color> and <font color='#0080FF'><marker name='T2'>#2</marker></font color>.
	<br/>
	<br/>When complete, extract South to complete the mission.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>The CSAT territory to the East is heavily mined and best avoided.
