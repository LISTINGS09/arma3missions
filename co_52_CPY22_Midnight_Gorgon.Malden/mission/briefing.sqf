...
if (side group player != CIVILIAN) then {
	...
	<br/>Neutralise a CSAT Command HQ near the town of Saint Louis.
	<br/>
	<br/>%1
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>Motorised platoon consisting of HMT and AT Offroad Vehicles with unarmed trucks for transport.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>At least two IFVs are known to be operational in the area, locating and eliminating these should be a top priority.
	<br/>
	<br/>In addition to infantry patrols and other light vehicles, an elite recon squad is also known to be deployed near the HQ.
	<br/>
