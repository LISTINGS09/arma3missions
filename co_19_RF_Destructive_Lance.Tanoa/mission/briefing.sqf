...
if (side group player != CIVILIAN) then {
	...
	<br/>Our sources have confirmed that a shipment of cash, vital for our Syndikat operations, has been intercepted and is currently under the control of Gendarme forces at a nearby site. This shipment is essential for funding our operations and maintaining the support of the local population. We must act swiftly and decisively to recover it.
	<br/>
	<br/><font color='#FF7F00'>Primary Objective</font>
	<br/>Infiltrate the Gendarme-controlled site and retrieve the shipment of cash.
	<br/>	
	<br/><font color='#FF7F00'>Secondary Objective</font>
    <br/>Minimize casualties among Syndikat forces and avoid civilian casualties to maintain our local support.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>The Gendarme forces are well-equipped and have established a defensive perimeter around the site. Expect patrols, static defenses, and possibly light armored vehicles. Intel suggests that they have fortified key positions and may have a quick reaction force on standby. Be prepared for a tough fight.
	<br/>
