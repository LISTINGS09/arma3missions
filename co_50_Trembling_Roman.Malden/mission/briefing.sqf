...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission objective is to recover stolen IDAP Aid Supplies and transport them safely back to the NATO base. The stolen supplies are located at a facility North of Le Port.
	<br/>
	<br/>The CSAT forces are known to have occupied the IDAP facility and are likely to resist any attempt to recover the stolen supplies.
	<br/>
	<br/>The plan is to conduct a two-phase operation. In the first phase, our ground units will advance to the location of the stolen supplies and secure the area. 
	<br/>	
	<br/>Once the area is secured, the pallets should be loaded and your transport helicopters will airlift the two pallets of Supplies back to the NATO base.
	<br/>
	<br/>During the loading operation, all units should remain alert and prepared to respond to any threats.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	...
	<br/>%2%3
	<br/>
	<br/>Additional CSAT QRF forces can be expected from outside the area.
	<br/>
