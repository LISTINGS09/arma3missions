...
if (side group player != CIVILIAN) then {
	...
	<br/>Intelligence has confirmed that a FIA insurgent outpost located south of Kalochori is housing critical research data. This data is believed to contain highly sensitive information regarding experimental weapon systems and defense strategies that could be a severe threat to the security of Altis. FIA forces are using the outpost as a research hub, with heavy fortifications and routine patrols in the area. The AAF High Command has tasked your unit with a crucial mission to infiltrate the FIA outpost, retrieve the data, and extract without engaging in prolonged combat.
	<br/>
	<br/>Your objective is to infiltrate the FIA outpost. Secure the research data and extract safely. Avoid unnecessary engagements with the FIA forces; stealth is paramount to the success of this operation. If compromised, expect rapid enemy reinforcement from nearby FIA strongholds. Complete the mission with minimal casualties and avoid destruction of the research equipment.
	<br/>
	<br/>%4
	<br/>
	<br/>%1 <!--- Casualties Cap --->
