...
AMBI_DistMax = 800;	// Max distance to find buildings.
AMBI_DistMin = 600; // Min distance to spawn.
AMBI_UnitsMax = 60;	// Max units active at once.
AMBI_UnitsChance = 80; // Overall chance to spawn
AMBI_SafeAreas = ["safezone_1"]; // List of Safe Areas - Imported from ZMM
