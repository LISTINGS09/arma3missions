...
if (side group player != CIVILIAN) then {
	...
	<br/>Intelligence reports have confirmed that the Canton-Protocol Strategic Alliance Treaty (CSAT) has established a fortified outpost in Oreokastro, a key region of Altis. This outpost poses a significant threat to our strategic interests in the area and must be neutralized.
	<br/>
	<br/>Capture the CSAT Outpost in Oreokastro.
	<br/>Eliminate all hostile forces within the outpost.
	<br/>Minimize civilian casualties and collateral damage.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
