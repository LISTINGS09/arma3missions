...
if (side group player != CIVILIAN) then {
	...
	<br/>Advance inland and secure the three key CSAT controlled areas:
	<br/>
	<br/><font color='#72E500'>1.</font color> <font color='#0080FF'><marker name='W_1'>Ammo Dump</marker></font color>
	<br/><font color='#72E500'>2.</font color> <font color='#0080FF'><marker name='W'>Lookout Tower</marker></font color>
	<br/><font color='#72E500'>3.</font color> <font color='#0080FF'><marker name='W_2_1'>Vehicle Depot</marker></font color>
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>One platoon of up to five squads; Alpha, Bravo, Charlie, Delta and Echo. 
	<br/>
	<br/>You begin <font color='#0080FF'><marker name='respawn_west'>here</marker></font color>.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>There are likely a number of fortified positions covering the coast, HMG and mortar teams are known to be operating in the area no accurate intelligence is available on these locations.
	<br/>
