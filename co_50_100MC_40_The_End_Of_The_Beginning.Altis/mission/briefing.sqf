...
if (side group player != CIVILIAN) then {
	...
	<br/>A Transport Helicopter has crashed in Northern Altis. CSAT forces are in the process of securing and loading the cargo. 
	<br/>
	<br/>Locate the crash site and capture the cargo truck before enemy forces can secure it.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
