...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission, as part of the Altis Armed Forces, is to locate and secure a case of chemical compounds believed to be smuggled by CSAT forces near the village of Syrta.
	<br/>
	<br/>Intelligence reports indicate that CSAT operatives have been involved in the illegal trafficking of chemical agents at an outpost, posing a significant threat to regional stability.
	<br/>
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>You will be deployed to a designated near the AO (Area of Operations) as chosen by the Commander. Maintain stealth and avoid detection during the initial insertion.
	<br/>
	<br/><font color='#FF7F00'>Reconnaissance</font>
	<br/>Upon landing, conduct a thorough reconnaissance of the area surrounding Syrta. Utilize drones, binoculars, and other reconnaissance equipment to gather intel on enemy positions and potential locations of the chemical compounds.
	<br/>
	<br/><font color='#FF7F00'>Engagement</font>
	<br/>Once you have identified the likely location of the CSAT Outpost, proceed to engage any CSAT forces guarding the area. Exercise caution and use appropriate force to neutralize the enemy threat.
	<br/>
	<br/><font color='#FF7F00'>Secure the Objective</font>
	<br/>Move swiftly to find and secure the case of chemical compounds. Search inside cardboard boxes for the item and be prepared for additional enemy reinforcements.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>After securing the objective, extract the chemical compound to an extraction point designated by the Commander. Ensure that the area is clear of any remaining enemy threats before calling in the extraction team.
	<br/>
	<br/>
