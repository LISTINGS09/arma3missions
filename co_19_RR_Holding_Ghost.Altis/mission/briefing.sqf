...
if (side group player != CIVILIAN) then {
	...
	<br/>Our insurgent group has received critical intelligence regarding a CSAT outpost located in the region. This outpost houses valuable supplies and serves as a strategic point for CSAT operations in the area. Our mission is to capture this outpost and neutralize the Marid IFV guarding it, thereby weakening CSAT's presence and bolstering our own.
	<br/>
	<br/><font color='#FF7F00'>CSAT Outpost</font>
	<br/>The outpost consists of a main building and several sandbag emplacements, heavily guarded by CSAT troops. It's also rumoured to contain a cache of supplies and intel.
	<br/>
    <br/><font color='#FF7F00'>Marid IFV</font>
	<br/>The Marid IFV guards the outpost and is a significant threat. It's heavily armoured and armed with a 40mm GMG, which can devastate our forces if not dealt with swiftly.
	<br/>
	<br/><font color='#FF7F00'>Terrain</font>
	<br/>The outpost is situated in a hilly area with good visibility for both our forces and the enemy. This terrain provides opportunities for strategic positioning.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
