...
if (side group player != CIVILIAN) then {
	...
	<br/>Gendarme forces have identified two crucial Data Servers held by Syndikat operatives in the region of Ovau. These servers contain sensitive information vital to our strategic interests. It is imperative that our forces swiftly and decisively secure these servers before Syndikat can extract or destroy the data.
	<br/>
	<br/>
	<br/><font color='#FF7F00'>Secure Data Server Alpha</font>
	<br/>Locate and secure the first Data Server located in the vicinity of a Command Post in Ovau. Neutralize any Syndikat resistance encountered and establish a defensive perimeter around the server.
	<br/>
	<br/><font color='#FF7F00'>Secure Data Server Bravo</font>
	<br/>Move to the second Data Server located in the vicinity of the Tanoa Airport warehouse. Engage and eliminate Syndikat forces guarding the server. Secure the area and establish a defensive perimeter.
	<br/>
	<br/><font color='#FF7F00'>Extract Data Servers</font>
	<br/>Once both Data Drives are secure, exfil the area to retrieve the servers and transport them to a secure location for analysis. Ensure that the drives remain intact and undamaged during extraction.
	<br/>
	<br/><font color='#FF7F00'>Neutralize Syndikat Command Structure</font>
	<br/>Intelligence suggests that Syndikat leadership may be coordinating operations from a nearby command center. Locate and neutralize high-value targets to disrupt enemy command and control capabilities.
	<br/>
	<br/>
