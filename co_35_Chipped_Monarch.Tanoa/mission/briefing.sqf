...
if (side group player != CIVILIAN) then {
	...
	<br/>Our objective is to neutralize a CSAT attack helicopter stationed in the vicinity of Losi. The CSAT forces have established a formidable defence perimeter, fortified by a communications tower, which allows them to coordinate their operations effectively.
	<br/>
	<br/>To ensure the success of this mission, we must first disable the communications tower to disrupt their command and control capabilities, enabling our forces to approach the target area undetected. Once the communications tower is disabled, our forces will advance towards Losi and eliminate the CSAT attack helicopter, securing air superiority in the region.
	<br/>
	<br/>Disable the CSAT communications tower to disrupt enemy communications.
    <br/>Destroy the CSAT attack helicopter stationed in Losi.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
