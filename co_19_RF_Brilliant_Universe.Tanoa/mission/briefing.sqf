...
if (side group player != CIVILIAN) then {
	...
	<br/>Your NATO forces must clear the village north of Vatukoulo from FIA (Freedom and Independence Army) forces. The village is believed to be a stronghold for the FIA, and clearing it is essential to establish control over the area.
	<br/>
    <br/>The village north of Vatukoulo has been identified as a key location controlled by FIA forces. It is suspected that they are using the village as a base of operations for conducting attacks against NATO and civilian targets in the region.
	<br/>
    <br/>Your mission is to conduct a coordinated assault to eliminate all FIA presence in the village and secure it for NATO control.
	<br/>
	<br/>Expect heavy resistance from FIA fighters who are deeply entrenched within the village. They may have fortified positions and sniper nests set up to impede your advance.
	<br/>
	<br/>
