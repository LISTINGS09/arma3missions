...
if (side group player != CIVILIAN) then {
	...
	<br/>Our intel has identified the location of the four strongholds. Your mission is to clear out four insurgent strongholds within Karlin. 
	<br/>
	<br/>These strongholds are heavily fortified and well-armed with artillery support from nearby locations such as a <marker name='marker_5'>Military Base</marker> and a <marker name='marker_6'>Power Plant</marker> which have recently been occupied by enemy forces, so proceed with caution and precision.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	...
	<br/>%2%3
	<br/>
	<br/>Insurgents are using the MRL to provide artillery support within the area, it is believed to be located within a <marker name='marker_5'>Military Base</marker> to the west.
	<br/>
