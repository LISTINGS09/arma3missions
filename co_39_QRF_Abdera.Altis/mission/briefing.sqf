...
if (side group player != CIVILIAN) then {
	...
	<br/>Joint Operations Center (JOC) reports there is a good opportunity to secure and eliminate the enemies located at <font color='#0080FF'><marker name='obj1'>Abdera</marker></font color>.
	<br/>
	<br/>Clear and secure <font color='#0080FF'><marker name='obj1'>Abdera</marker></font color>.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
