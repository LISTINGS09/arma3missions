...
if (side group player != CIVILIAN) then {
	...
	<br/>Capture the <marker name='TARGMKR_4'>Forward Outpost</marker>.
	<br/>
	<br/>Destroy three NATO IFVs at the <marker name='TARGMKR_3'>Forward Outpost</marker>, <marker name='TARGMKR_1'>Military Base</marker> and <marker name='TARGMKR_2'>Radio Station</marker>.
	<br/>
	<br/>%1
	<br/>
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>Your platoon starts <marker name='respawn_east'>South of the Objective</marker>, all squads have light unarmed transports for travel.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>Enemy presence is expected to be high across the region, with a number of infantry and motorised patrols along the roads and rural areas.
	<br/>
	<br/>Three mechanised IFV (Marshall) squads are present at each location consisting of 8-14 infantry guarding the location. The IFVs are all assumed to be operational. You are to eliminate all of these.
	<br/>
	<br/>Expect a larger number of patrols around the <marker name='TARGMKR_3'>Forward Outpost</marker>, the outpost is only recently established and is not expected to be heavily defended.
	<br/>
