...
if (side group player != CIVILIAN) then {
	...
	<br/>The situation on the island of Altis has escalated significantly over the past few months. NATO forces have established a medical research facility in the northern region of Altis, and recent intelligence indicates that a highly toxic substance, codenamed 'Project Pandora', is being developed and stored there. This toxic substance poses a significant threat to the local population and must be recovered.
	<br/>
	<br/>Your mission, as a member of the AAF CBRN (Chemical, Biological, Radiological, and Nuclear) Team, is to infiltrate the NATO medical facility, locate and secure 'Project Pandora', and extract it safely. This mission is time-sensitive, and you should proceed with the utmost caution. Do not underestimate the security measures NATO has in place to protect this substance.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Your team will be inserted at the Commanders chosen position outside of the AO, approximately 1 kilometer from the target facility. Ensure noise discipline during the approach.
	<br/>
	<br/><font color='#FF7F00'>Secure 'Project Pandora'</font>
	<br/>The facility is heavily guarded. Your team should expect both armed NATO soldiers and private security personnel. Your primary objective is to secure 'Project Pandora'. Make use of stealth and suppressive fire when necessary, but avoid unnecessary engagement.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>Once the item is secured, extract to a designated location around 1 kilometer south of the facility. Ensure 'Project Pandora' is secured in a specialized CBRN containment unit for transportation.
	<br/>	
