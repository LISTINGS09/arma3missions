...
if (side group player != CIVILIAN) then {
	...
	<br/>We have received critical intelligence that a CSAT unit has taken control of a radar site in the Southern part of the Livonian countryside. This site is of strategic importance and must be retaken as soon as possible. Your mission is to secure the captured radar site and eliminate all CSAT forces present.
	<br/>
	<br/>The captured radar site is located on a hilltop and is heavily fortified. You will need to plan your approach carefully and coordinate your efforts to successfully secure the area. It is recommended that you conduct a reconnaissance mission to gather intel on the enemy's positions and defences before launching your attack.
	<br/>
	<br/>Your primary objective is to secure the radar installation and take control of the site. You must eliminate all hostile forces present and disable any defences that may pose a threat to our troops.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
