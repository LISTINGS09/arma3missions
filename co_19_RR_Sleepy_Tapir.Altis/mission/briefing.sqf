...
if (side group player != CIVILIAN) then {
	...
	<br/>Our intelligence reports indicate a significant CSAT presence in a camp located near the town of Faros. This camp serves as a strategic outpost for CSAT forces in the region. The camp is heavily fortified and houses valuable military assets, including vehicles, weapons, and supplies. It poses a significant threat to our operations in the area and must be neutralized.
	<br/>
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Your team will infiltrate the area under the cover of darkness. Use stealth and caution to avoid detection by enemy patrols and surveillance.
	<br/>
	<br/><font color='#FF7F00'>Assault</font>
	<br/>Once in position, initiate a coordinated assault on the CSAT camp. Utilize your squad's firepower and tactical abilities to overwhelm the enemy defenses.
	<br/>
	<br/><font color='#FF7F00'>Secure the Area</font>
	<br/>Clear the camp of all hostile forces and secure key objectives, including command centers, weapon caches, and communication facilities.
	<br/>
	<br/><font color='#FF7F00'>Gather Intelligence</font>
	<br/>Search the camp for any valuable intelligence, such as documents, computers, or prisoners, that may provide insight into CSAT's plans and operations in the region.
	<br/>
	<br/><font color='#FF7F00'>Establish Control</font>
	<br/>Once the area is secure, establish control over the camp and prepare for any potential counterattacks.
	<br/>	
	<br/>	
