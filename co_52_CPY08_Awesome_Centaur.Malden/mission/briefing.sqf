...
if (side group player != CIVILIAN) then {
	...
	<br/>Destroy two CSAT AAA Positions in the southern hills.
	<br/>
	<br/>%1
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>CSAT forces have occupied most buildings South of Lavalle and set up at least one checkpoint somewhere along the MSR.
	<br/>
	<br/>The town of Arudy lies in ruins and is not expected to have significant enemy presence, but expect a high number of enemy patrols around the AAA positions.
	<br/>
	<br/>Motorised and mechanised vehicles can be expected to be travelling along the MSR.
	<br/>
