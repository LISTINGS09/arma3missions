...
if (side group player != CIVILIAN) then {
	...
	<br/>Capture three CSAT-held locations by eliminating all enemy forces within each areas.
	<br/>
	<br/>%1
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>Enemy strength is expected to be a company-sized force which includes heavily armoured vehicles.
	<br/>
	<br/>Forces are dispersed across the area, with light patrols active across the AO. 
	<br/>
	<br/>A number of fortified positions have been identified. These may be occupied by infantry and have vehicle or static supports.
	<br/>
	<br/>No QRF forces are expected.
	<br/>
