...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to eliminate the AAF Artillery Outpost located near Oreokastro. The outpost serves as a vital asset for the AAF, enabling them to launch devastating artillery strikes against our positions.
	<br/>
	<br/>By neutralizing this outpost, we will severely hinder their ability to conduct offensive operations in the region.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Utilize stealth and reconnaissance to approach the target area undetected. Scout enemy positions and identify key targets for elimination.
	<br/>
	<br/><font color='#FF7F00'>Neutralize Enemy Defenses</font>
    <br/>Engage and eliminate enemy patrols and defensive positions surrounding the artillery outpost. Use guerrilla tactics to disrupt enemy coordination.
	<br/>
	<br/><font color='#FF7F00'>Destroy Artillery Outpost</font>
    <br/>Once the perimeter is secured, proceed to the main objective. Employ explosives or other suitable means to destroy the MLRS and render the outpost inoperable.
	<br/>
	<br/><font color='#FF7F00'>Exfiltration</font>
    <br/>After completing the primary objective, withdraw from the area swiftly and evade any pursuing enemy forces. Ensure all friendly units are safely extracted from the combat zone.
	<br/>
