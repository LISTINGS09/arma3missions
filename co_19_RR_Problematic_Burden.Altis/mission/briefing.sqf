...
if (side group player != CIVILIAN) then {
	...
	<br/>Locate and secure the AAF shipment at the warehouse near Lakka.
	<br/>
	<br/>The AAF shipment in question is believed to contain critical supplies vital to their ongoing operations in the region. Our intelligence suggests that the shipment is stored in a marked box within a warehouse near Lakka. The AAF has bolstered security in the area, making it imperative for us to act swiftly and decisively.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Move swiftly and covertly towards the warehouse area. Utilize the cover of darkness to your advantage, minimizing the risk of detection.
	<br/>
	<br/><font color='#FF7F00'>Reconnaissance</font>
	<br/>Prioritize reconnaissance efforts to gather actionable intelligence on enemy positions and fortifications surrounding the warehouse.
	<br/>
	<br/><font color='#FF7F00'>Securing the Objective</font>
	<br/>Once you have confirmed the location of the AAF shipment, move to search for the box within the warehouse, there are around 6 boxes that may contain the items.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>Once the objective is secured, prepare for extraction. Rendezvous with Raptor-1 at the designated extraction point for aerial evacuation.
	<br/>
	<br/><font color='#FF7F00'>Counter-Resistance</font>
	<br/>Neutralize any remaining enemy forces in the area to ensure a safe extraction and prevent potential retaliation.
	<br/>
