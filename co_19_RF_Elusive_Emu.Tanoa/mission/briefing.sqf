...
if (side group player != CIVILIAN) then {
	...
	<br/>The ongoing conflict with Syndikat in Nandai has escalated. Intelligence reports indicate that Syndikat forces have stolen a Cargo Container mounted on a Truck containing vital supplies and equipment. This cargo is of utmost importance to our operations in the region.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Insertion will be conducted via truck at location designated approximately 1 kilometer from the suspected Syndikat stronghold.
	<br/>
	<br/><font color='#FF7F00'>Reconnaissance and Planning</font>
	<br/>Conduct reconnaissance to gather intel on Syndikat movements and stronghold defences. Identify potential entry points and escape routes, plan infiltration and extraction routes accordingly.
	<br/>
	<br/><font color='#FF7F00'>Engagement and Recovery</font>
	<br/> Execute the plan to secure the stolen Truck and neutralize Syndikat resistance. Eliminate any remaining hostiles and ensure the area is clear for extraction.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>Extract the Cargo Container to designated extraction point for recovery.
	<br/>
	<br/>		
