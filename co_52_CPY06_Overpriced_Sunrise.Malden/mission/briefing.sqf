...
if (side group player != CIVILIAN) then {
	...
	<br/>Scout the City of <font color='#0080FF'><marker name='marker_49'>La Trinite</marker></font color> to confirm the FIA retreat.
	<br/>
	<br/>Secure the Town of <font color='#0080FF'><marker name='marker_50'>Dourdan</marker></font color>.
	<br/>
	<br/>%1
	<br/>
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>All squads each have one unarmed truck for transport and resupply.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>Following heavy artillery attacks from both sides, both FIA and Western forces abandoned the city of <font color='#0080FF'><marker name='marker_49'>La Trinite</marker></font color>.
	<br/>
	<br/>The enemy may have reinforced the city with a mechanised or light infantry team overnight, but contact is expected to be very light inside what remains of the city. Additional reinforcements are expected to leave from Dourdan within the hour.
	<br/>
	<br/>The town of <font color='#0080FF'><marker name='marker_50'>Dourdan</marker></font color> still has a significant infantry presence supported by at least one IFV and static supports, the main FIA Outpost operates from Sector #1 identified by a large <font color='#0080FF'><marker name='marker_41'>Cargo Tower</marker></font color>.
	<br/>
	<br/>A <font color='#0080FF'><marker name='marker_44'>Mortar Position</marker></font color> remains operational nearby. The majority of FIA forces defending Dourdan or heading to reinforce La Trinite, only light patrols are expected in the area.
	<br/>
