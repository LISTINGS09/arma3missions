...
if (side group player != CIVILIAN) then {
	...
	<br/>Our intelligence reports indicate that a power plant located near the town of Tarnow has been taken over by insurgents. The insurgents have planted explosive devices around the facility and are threatening to detonate them if their demands are not met. In addition, there are two fuel tankers located nearby that are being used by the insurgents to refuel their vehicles. It is essential that we secure the power plant and neutralize the threat posed by the insurgents.
	<br/>
	<br/>Your mission is to secure the power plant and destroy the two fuel tankers near the town of Tarnow.
	<br/>
	<br/>The main objective, the facility is heavily guarded, so you will need to approach it with care.
	<br/>
	<br/>Once the facility is secure, locate the two fuel tankers located nearby and plant explosive charges on the tankers and move back to a safe distance.
	<br/>
	<br/>The mission will be considered complete when all objectives are completed.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
