...
if (side group player != CIVILIAN) then {
	...
	<br/>NATO Command has received critical intelligence indicating the presence of a CSAT camp on the island of Altis. This camp is believed to be involved in the repair and maintenance of military assets, including two Tempest repair trucks. The Tempest repair trucks are crucial to CSAT's operations in the region. Our mission is to locate this camp and eliminate the Tempest repair trucks to cripple their logistical capabilities.
	<br/>
	...
	<br/>
    <br/><font color='#FF7F00'>Elimination of Tempest Trucks</font>
	<br/>Once the team reaches the CSAT camp, the explosives specialist will plant charges on both Tempest repair trucks. Ensure the charges are set and safely withdrawn to a safe distance.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>After the charges are set, the squad will retreat to a safe distance, and the explosives specialist will remotely detonate the charges. Once the Tempest trucks are destroyed, fall back to extraction.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
