...
if (side group player != CIVILIAN) then {
	...
	<br/>We have received credible intelligence that a high-level meeting between Russian forces and FIA is scheduled to take place near the town of Molos. 
	<br/>	
	<br/>This meeting poses a significant threat to regional stability and our national interests.
	<br/>
	<br/>You have been tasked with disrupting this meeting and neutralizing any potential threats, while also looking for evidence to confirm Russian forces are present on Altis.
	<br/>
