...
{
	private _mkrName = format ["mkr_road_%1", _forEachIndex];
	_mrkr = createMarkerLocal [_mkrName, _x];
	_mkrName setMarkerPosLocal _x;
	_mkrName setMarkerTypeLocal "mil_dot";
	_mkrName setMarkerColorLocal "ColorYellow";
	_mkrName setMarkerTextLocal format["R%1",_forEachIndex];
} forEach _spawnRoad;

{
	private _mkrName = format ["mkr_land_%1", _forEachIndex];
	_mrkr = createMarkerLocal [_mkrName, _x];
	_mkrName setMarkerPosLocal _x;
	_mkrName setMarkerTypeLocal "mil_dot";
	_mkrName setMarkerColorLocal "ColorOrange";
	_mkrName setMarkerTextLocal format["L%1",_forEachIndex];
} forEach _spawnLand;
