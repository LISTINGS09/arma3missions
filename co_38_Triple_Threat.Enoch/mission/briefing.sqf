...
if (side group player != CIVILIAN) then {
	...
	<br/>We have received intel that three LDF tanks have been spotted in the vicinity of an outpost located to the North of our current position. Your mission is to hunt down and destroy these tanks while capturing the outpost.
	<br/>
	<br/>Your first objective is to move in and secure a farm used to station light reinforcements before moving onto capture the main LDF outpost in the area. Once the Outpost has been secured, hunt down and eliminate the Tanks.
	<br/>	
	<br/>The LDF tanks are heavily armoured and armed with powerful weapons, so exercise caution and use all available resources to eliminate them. Be prepared for heavy resistance from enemy infantry as well.
	<br/>
	<br/> 
	<br/>%1 <!--- Casualties Cap --->
