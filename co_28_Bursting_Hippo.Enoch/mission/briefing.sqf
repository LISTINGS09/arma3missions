...
if (side group player != CIVILIAN) then {
	...
	<br/>A local Insurgent Cell is attempting trade supplies with Russian forces.
	<br/>
	<br/>Locate and destroy four supply crates located somewhere within the area and also eliminate all enemy at the meeting site.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
