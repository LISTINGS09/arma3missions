...
_rifle = ["arifle_MX_Black_F","arifle_MXM_Black_F","arifle_SPAR_01_blk_F","arifle_SPAR_03_blk_F","srifle_DMR_03_F"];
...
_baseUniform = if (leader _unit == _unit) then { ["U_Competitor"] } else { ["U_Rangemaster","U_I_G_resistanceLeader_F","U_C_IDAP_Man_casual_F","U_I_C_Soldier_Bandit_2_F","U_I_C_Soldier_Bandit_3_F"] };
...
if (_isMan) then {
	...
	_unit addItem "H_Cap_red";// Free Hat!
};
