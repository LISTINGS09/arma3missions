...
if (side group player != CIVILIAN) then {
	...
	<br/>Your main objective is to identify the locations of three Fuel Tankers currently being used by insurgent forces - Do not destroy them!
	<br/>
	<br/>There are three main Insurgent sites to investigate;
	<br/><marker name='marker_8'>Derailed Train</marker> - Insurgents recently derailed a train transporting vital supplies to our forces. Secure the area and eliminate all hostile forces looting the area, a large quantity of fuel was being transported so it is likely the first truck can be found here.
	<br/>
	<br/><marker name='marker_10'>Insurgent Barracks</marker> - The barracks was used as a staging point by the Insurgents for the attack on the train, they have been moving supplies to here and will likely have a supply truck on site.
	<br/>
	<br/><marker name='marker_16'>Fuel Station</marker> - An abandoned station has recently been occupied by enemy forces. We expect the enemy to have set up defences around the area, so we need to be prepared for heavy resistance. The enemy is known to have been using it to refuel a number of vehicles so it is likely a truck will be located there.
	<br/>
	<br/>Work to clear the remaining insurgent forces from the area as you move between each site. We cannot allow them to regroup and launch another attack on our forces.
	<br/>
	<br/>Your mission will be complete once each truck has been identified.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
