...
_Team = [[["I_SFIA_thug_lxWS","I_SFIA_enforcer_lxWS","I_SFIA_scout_lxWS","I_SFIA_hireling_lxWS","I_SFIA_scout_lxWS"]]];
_Squad = [[["I_SFIA_thug_lxWS","I_SFIA_enforcer_lxWS","I_SFIA_scout_lxWS","I_SFIA_hireling_lxWS","I_SFIA_thug_lxWS","I_SFIA_scout_lxWS","I_SFIA_hireling_lxWS","I_SFIA_medic2_lxWS"]]];
_Truck = ["I_C_Van_02_transport_F"];
_Light = ["I_C_Offroad_02_AT_F","I_C_Offroad_02_LMG_F"];
_Medium = ["I_Tura_Truck_02_aa_lxWS",["I_APC_Wheeled_03_cannon_F","[_grpVeh,['Guerilla_02',1],['showCamonetHull',0.5]] call BIS_fnc_initVehicle;"]];
_Heavy = [["I_APC_Wheeled_03_cannon_F","[_grpVeh,['Guerilla_02',1],['showCamonetHull',0.5,'showSLATHull',1]] call BIS_fnc_initVehicle;"]];
...
zmm_fnc_spawnUnit = {
	...
	diag_log format["SpawnUnit - Passed %1: %2 [%3] Try:%4", _targetPos, _unitClass, _side, _tries];
...
for [{_wave = 1}, {_wave < _waveMax}, {_wave = _wave + 1}] do {
	...
	switch (_wave) do {
		case 1: {
			[_location, ["veh_1","veh_2","veh_3","veh_4","veh_5","veh_6","veh_7","veh_8","veh_9","veh_10"], _side, selectRandom (_Light + _Truck)] call zmm_fnc_spawnUnit;
			[_location, ["veh_1","veh_2","veh_3","veh_4","veh_5","veh_6","veh_7","veh_8","veh_9","veh_10"], _side, selectRandom (_Light + _Truck)] call zmm_fnc_spawnUnit;
			[_location, ["veh_1","veh_2","veh_3","veh_4","veh_5","veh_6","veh_7","veh_8","veh_9","veh_10"], _side, selectRandom (_Light + _Truck)] call zmm_fnc_spawnUnit;
			[_location, ["inf_1","inf_2","inf_3","inf_4","inf_5","inf_6","inf_7"], _side, selectRandom (_Team + _Squad)] call zmm_fnc_spawnUnit;
			[_location, ["inf_1","inf_2","inf_3","inf_4","inf_5","inf_6","inf_7"], _side, selectRandom (_Team + _Squad)] call zmm_fnc_spawnUnit;
			[_location, ["inf_1","inf_2","inf_3","inf_4","inf_5","inf_6","inf_7"], _side, selectRandom (_Team + _Squad)] call zmm_fnc_spawnUnit;
			[_location, ["inf_1","inf_2","inf_3","inf_4","inf_5","inf_6","inf_7"], _side, selectRandom (_Team + _Squad)] call zmm_fnc_spawnUnit;
		};
		case 2: {
			[_location, ["veh_1","veh_2","veh_3","veh_4","veh_5","veh_6","veh_7","veh_8","veh_9","veh_10"], _side, selectRandom (_Light + _Truck)] call zmm_fnc_spawnUnit;
			[_location, ["veh_1","veh_2","veh_3","veh_4","veh_5","veh_6","veh_7","veh_8","veh_9","veh_10"], _side, selectRandom (_Light + _Truck)] call zmm_fnc_spawnUnit;
			[_location, ["veh_1","veh_2","veh_3","veh_4","veh_5","veh_6","veh_7","veh_8","veh_9","veh_10"], _side, selectRandom (_Light + _Medium)] call zmm_fnc_spawnUnit;
			[_location, ["inf_1","inf_2","inf_3","inf_4","inf_5","inf_6","inf_7"], _side, selectRandom (_Team + _Squad)] call zmm_fnc_spawnUnit;
			[_location, ["inf_1","inf_2","inf_3","inf_4","inf_5","inf_6","inf_7"], _side, selectRandom (_Team + _Squad)] call zmm_fnc_spawnUnit;
			[_location, ["inf_1","inf_2","inf_3","inf_4","inf_5","inf_6","inf_7"], _side, selectRandom (_Team + _Squad)] call zmm_fnc_spawnUnit;
			[_location, ["inf_1","inf_2","inf_3","inf_4","inf_5","inf_6","inf_7"], _side, selectRandom (_Team + _Squad)] call zmm_fnc_spawnUnit;
		...
		case 4: {
			[_location, ["veh_1","veh_2","veh_3","veh_4","veh_5","veh_6","veh_7","veh_8","veh_9","veh_10"], _side, selectRandom (_Light + _Truck)] call zmm_fnc_spawnUnit;
			[_location, ["veh_1","veh_2","veh_3","veh_4","veh_5","veh_6","veh_7","veh_8","veh_9","veh_10"], _side, selectRandom (_Light + _Truck)] call zmm_fnc_spawnUnit;
			[_location, ["veh_1","veh_2","veh_3","veh_4","veh_5","veh_6","veh_7","veh_8","veh_9","veh_10"], _side, selectRandom (_Heavy + _Medium)] call zmm_fnc_spawnUnit;
			[_location, ["inf_1","inf_2","inf_3","inf_4","inf_5","inf_6","inf_7"], _side, selectRandom (_Team + _Squad)] call zmm_fnc_spawnUnit;
			[_location, ["inf_1","inf_2","inf_3","inf_4","inf_5","inf_6","inf_7"], _side, selectRandom (_Team + _Squad)] call zmm_fnc_spawnUnit;
			[_location, ["inf_1","inf_2","inf_3","inf_4","inf_5","inf_6","inf_7"], _side, selectRandom (_Team + _Squad)] call zmm_fnc_spawnUnit;
			[_location, ["inf_1","inf_2","inf_3","inf_4","inf_5","inf_6","inf_7"], _side, selectRandom (_Team + _Squad)] call zmm_fnc_spawnUnit;
