...
_grpBLU = [
	...
	,["GrpBLU_IFV1","Thunder 1","b_mech_inf","T1",_red]
	,["GrpBLU_IFV2","Thunder 2","b_mech_inf","T2",_blue]
	,["GrpBLU_IFV3","Thunder 3","b_mech_inf","T3",_green]
	,["GrpBLU_ENG1","Engineers","b_maint","E",_orange]
];