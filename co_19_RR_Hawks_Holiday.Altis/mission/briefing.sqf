...
if (side group player != CIVILIAN) then {
	...
	<br/>Tensions between our PMC group and the NATO-backed CTRG (Cooperative Task Force) have escalated in recent weeks. CTRG operatives have been conducting operations in our region, which we view as a direct threat to our cause. We have received intelligence that a CTRG team is currently stationed at a NATO outpost south of Lakka. Our goal is to eliminate this threat and capture their UH-80 helicopter, which could greatly enhance our capabilities.
	<br/>
	<br/><font color='#FF7F00'>Infiltrate</font>
    <br/>Infiltrate the area silently. We don't want to alert the CTRG to our presence until we strike.
	<br/>
	<br/><font color='#FF7F00'>Locate</font>
    <br/>Locate the CTRG Team at the NATO outpost. They will likely have guards posted around the perimeter, so proceed with caution.
	<br/>
	<br/><font color='#FF7F00'>Neutralize</font>
    <br/>Neutralize the CTRG operatives. Be sure to eliminate all threats, as leaving survivors could jeopardize the mission.
	<br/>
	<br/><font color='#FF7F00'>Capture</font>
    <br/>Capture the UH-80 helicopter. This is a valuable asset that we can use for future operations.
	<br/>
	<br/><font color='#FF7F00'>Extract</font>
    <br/>Once the helicopter is secured, extract from the area. Expect enemy reinforcements, so be prepared for additional engagements.
	<br/>
