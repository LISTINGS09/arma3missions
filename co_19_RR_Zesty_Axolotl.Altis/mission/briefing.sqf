...
if (side group player != CIVILIAN) then {
	...
	<br/>Our intelligence reports indicate that two NATO-affiliated civilians have been taken as hostages by the Free Independent Army (FIA) near the village of Alikampos, Altis. The hostages are believed to be held within a compound under heavy FIA guard. The FIA, an insurgent faction known for its anti-NATO sentiments, poses a significant threat to regional stability.
	<br/>
	<br/><font color='#FF7F00'>Rescue the Hostages</font>
	<br/>Your primary objective is to locate and safely extract the two hostages from the FIA compound.
	<br/>
	<br/><font color='#FF7F00'>Neutralize FIA Resistance</font>
	<br/>Engage and eliminate any FIA forces encountered in the vicinity of the compound.
	<br/>
	<br/><font color='#FF7F00'>Secure the Area</font>
	<br/>Once the hostages are secured, establish a perimeter around the compound to prevent any FIA reinforcements from interfering with the extraction.
	<br/>
	<br/>
