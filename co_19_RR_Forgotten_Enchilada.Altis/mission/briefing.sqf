...
if (side group player != CIVILIAN) then {
	...
	<br/>Our NATO forces are tasked with contaminating three crates of foodstuffs that are currently under the protection of the Freedom and Independence Army (FIA) in the area east of Paros. This covert operation is part of our broader strategy to weaken the FIA's logistical support and disrupt their activities in the region.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Insertion will to a location of the Commanders choosing. Maintain noise discipline during insertion. Move on foot to the target area to avoid detection.
	<br/>
	<br/><font color='#FF7F00'>Contamination</font>
	<br/>Once the target site is located, identify the three crates. Use the provided chemical agents to contaminate the foodstuffs. Ensure no visual or physical evidence remains. Be vigilant for any enemy presence, and eliminate threats quietly.
	<br/>
	<br/><font color='#FF7F00'>Intel Gathering</font>
	<br/>If the opportunity arises, search for any documents or materials that may help us gather critical intelligence on the FIA.
	<br/>
	<br/><font color='#FF7F00'>Exfiltration</font>
	<br/>Withdraw from the area using the same route used for infiltration.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>The FIA is known for their guerrilla tactics and should not be underestimated. They are likely to have a contingent of well-armed fighters guarding the food crates. Intelligence reports suggest they may have light armored vehicles and sniper teams in the area. Be prepared for possible reinforcements from nearby FIA-controlled territories.
	<br/>
