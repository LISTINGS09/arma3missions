...
if (side group player != CIVILIAN) then {
	...
	<br/>CSAT forces have established a weapons cache somewhere within the town of Kalithea. This cache contains critical supplies and munitions that are being used to support CSAT operations in the region. Intelligence reports indicate that the cache is heavily guarded and hidden within civilian infrastructure, making it difficult to locate and destroy. FIA resistance forces, you and your team, must neutralize this cache to cripple CSAT's supply lines and prevent further operations in the area.
	<br/>
	<br/>Your FIA squad is tasked with infiltrating the town of Kalithea, locating, and destroying the CSAT weapons cache. Due to the civilian presence, precision and discretion are paramount. You will need to identify the exact location of the cache, eliminate any CSAT forces guarding it, and destroy it without causing unnecessary collateral damage. Expect heavy resistance.
	<br/>
