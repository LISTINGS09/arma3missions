...
if (side group player != CIVILIAN) then {
	...
	<br/>Capture and secure four FIA locations near Melanera Bay;
	<br/>1. <marker name='marker_16'>North Checkpoint</marker>
	<br/>2. <marker name='marker_17'>South Checkpoint</marker>
	<br/>3. <marker name='marker_18'>West Outpost</marker>
	<br/>4. <marker name='marker_19'>Temporary HQ</marker>
	<br/>
	<br/>%1 <!--- Casualties Cap --->
