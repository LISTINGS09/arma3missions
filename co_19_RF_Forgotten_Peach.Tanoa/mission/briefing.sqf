...
if (side group player != CIVILIAN) then {
	...
	<br/>CTRG forces have identified a critical situation requiring immediate attention. Two cases containing highly sensitive material have been stolen by FIA rebels and are believed to be hidden within a village to the south of Galili. These cases contain vital intelligence and must be recovered before they fall into the wrong hands. The FIA rebels are known for their guerrilla tactics and may attempt to use the stolen material against friendly forces if not apprehended swiftly.
	<br/>
	<br/>Your mission is to deploy a team of highly trained operatives to infiltrate the village, locate the stolen cases and extract them safely back to base. Exercise extreme caution as the area is likely to be heavily defended by FIA rebels. Utilize stealth and reconnaissance to gather intel on enemy positions and plan your approach accordingly.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Move quietly and swiftly through the village, utilizing cover and concealment to avoid detection.
	<br/>
	<br/><font color='#FF7F00'>Search and Recovery</font>
	<br/>Conduct a thorough search of the area to locate the stolen cases. Be prepared for ambushes set by the FIA rebels.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>Once the cases have been secured, rendezvous at an extraction location as chosen by the Commander.
	<br/>
	<br/>
