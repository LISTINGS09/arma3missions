...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to capture three towns held by Insurgent forces: Kulno, Widok, and Dolnik. The towns are heavily fortified and defended, so use all of your available resources to accomplish this objective.
	<br/>
	<br/>The Insurgents are well-armed and well-trained, so expect heavy resistance. Move quickly and efficiently to avoid unnecessary casualties.
	<br/>
	<br/>The first objective is to capture Kulno. This town is located on a hill, giving the Insurgents a strategic advantage. Consider using your armoured vehicles to take control of the high ground before moving in on foot.
	<br/>
	<br/>Your second objective is capturing Widok. This town is located in a forest, providing cover for the Insurgents. Use your ground troops to move through the forest and clear out any enemy positions.
	<br/>
	<br/>The third and final objective will be to capture Dolnik. This town is located in a valley, making it difficult to approach. We will need to use our vehicle support to soften up any defences before moving in on the ground.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
