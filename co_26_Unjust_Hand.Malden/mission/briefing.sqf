...
if (side group player != CIVILIAN) then {
	...
	<br/>We have received intelligence that the town of La Pessange is currently providing aid to enemy combatants, and their civilian population is known to be sympathetic to their cause. In order to weaken the enemy's supply chain and demoralize the local population, we have been ordered to poison the town's water supply.
	<br/>
	<br/>The plan is as follows:
	<br/>Your team of elite operatives will be inserted near the town. Their mission is to locate the town's water facilities and allow the Engineers to plant the poison.
	<br/>
    <br/>Once the poison has been delivered, the team will exfiltrate the town and return to base.
	<br/>
	<br/>For good measure, you are also to destroy the Newspaper Kiosk within the town.
	<br/>
	<br/>This operation is of the utmost importance, and failure is not an option. We must weaken the enemy's ability to fight by any means necessary, and the population of La Pessange is unfortunately caught in the middle.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
