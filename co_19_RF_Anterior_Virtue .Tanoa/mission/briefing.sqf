...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to eliminate a local Syndikat leader who is meeting with FIA militants to exchange vital information. Your primary goal is to eliminate the leader and obtain the files from their dead body.
	<br/>
	<br/>The Syndikat leader, known by the codename 'Viper', has been identified as a key figure in the illegal activities destabilizing the region. Viper has been actively collaborating with the FIA militants, providing them with weapons, ammunition, and intelligence in exchange for various favours and services.
	<br/>
	<br/>Recent intelligence reports indicate that Viper is planning a high-level meeting with FIA militants to exchange critical information regarding the Syndikat's operations and their future plans. This meeting presents a unique opportunity to neutralize Viper and gather valuable intelligence on Syndikat activities.
	<br/>
	<br/><font color='#FF7F00'>Location</font>
	<br/>The meeting is scheduled to take place at house located in the outskirts of Lijnhaven Airport.
	<br/>
	<br/><font color='#FF7F00'>Syndikat Security</font>
	<br/>Expect heavy security surrounding Viper during the meeting. Syndikat operatives are likely to be armed and highly trained. Exercise caution and be prepared for a potential firefight.
   	<br/>
	<br/><font color='#FF7F00'>FIA Militants</font>
	<br/>While the FIA militants may not pose an immediate threat to your team, they are likely to be armed and hostile towards any perceived threats. Avoid engaging them unless absolutely necessary to accomplish the mission objectives.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>Once Viper has been neutralized and the files secured from their body, proceed to the extraction point for immediate evacuation. Be prepared for potential reinforcements and secure the area before extraction.
	<br/>
	<br/>
