...
if (side group player != CIVILIAN) then {
	...
	<br/>CSAT forces are advancing through the region of Altis and must secure critical supply lines to maintain momentum. NATO forces have established a roadblock outside the village of Dorida, which is blocking our supply route. The roadblock consists of tank traps, anti-vehicle defenses, and infantry elements. Intel suggests the presence of light armor or mechanized infantry. NATO forces have recently reinforced the area, making a direct approach dangerous.
	<br/>
	<br/>Your objective is to clear the NATO roadblock outside Dorida. This will involve neutralizing enemy defenses, eliminating all NATO forces in the vicinity, and removing the tank traps that block our supply convoy's passage. Failure to secure the road will severely hinder our operational capabilities.
	<br/>
	<br/>%4
	<br/>
	<br/>%1 <!--- Casualties Cap --->
