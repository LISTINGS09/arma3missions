...
if (side group player != CIVILIAN) then {
	...
	<br/>Clear out an enemy Mortar Site, Checkpoint and Command Compound.
	<br/>
	<br/>%1
	<br/>
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>Up to five squads with unarmed transports to move around the AO.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>A Mortar site is known to be operational within the AO, eliminating this should be a priority to prevent further casualties. The following units are also known to be operational in the AO:
	<br/>%2%3
	<br/>
