...
if (side group player != CIVILIAN) then {
	...
	<br/>Your objective is to recover tank parts from NATO warehouses and bring them back to our base. The tank parts are critical to repair our armoured vehicles and we cannot afford to have them fall into the wrong hands.
	<br/>
	<br/>Your team will need to locate the tank parts to bring them back to our bases as quickly and safely as possible.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
