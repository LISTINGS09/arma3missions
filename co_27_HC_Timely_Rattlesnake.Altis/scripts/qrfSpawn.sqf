...
_Air = ["B_T_VTOL_01_infantry_F","B_Heli_Transport_01_F",["B_Heli_Transport_03_F","[_grpVeh,['Black',1]] call BIS_fnc_initVehicle;"]];
...
zmm_fnc_spawnPara = {
	...
	private _groupMax = 3; // Maximum para groups
