...
if (side group player != CIVILIAN) then {
	...
	<br/>A high-value NATO scientist has been flown into the AO by helicopter and has recently landed to the north of Rodopoli. Intelligence reports suggest that this scientist is carrying crucial research data that could significantly improve NATO's technological capabilities. The scientist is believed to be under heavy NATO protection in a secluded area near the landing zone. It is critical that this individual does not escape or complete their research collaboration with NATO forces.
	<br/>
	<br/>Your CSAT strike team is tasked with eliminating the NATO scientist before they can be extracted or moved further into NATO-controlled territory. You must neutralize the scientist and, if possible, recover any research data they might be carrying. This will require infiltrating the area, engaging any hostile NATO forces, and ensuring the scientist is terminated.
	<br/>
	<br/>%4
	<br/>
	<br/>%1 <!--- Casualties Cap --->
