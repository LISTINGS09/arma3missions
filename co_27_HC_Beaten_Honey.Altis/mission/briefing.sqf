...
if (side group player != CIVILIAN) then {
	...
	<br/>The Armed Forces of Altis have established a strategic communications tower to the northeast of Sofia. This installation is a critical hub for their intelligence and command operations in the region. Intelligence reports indicate that the tower is being used to coordinate military operations and relay high-priority communications across Altis. Its destruction is imperative to disrupting AAF's operational capabilities in this sector.
	<br/>
	<br/>CSAT forces are tasked with destroying the AAF Communications Tower. A strike team will infiltrate the area, eliminate any resistance, and place explosives to demolish the installation. The tower is heavily guarded, and enemy patrols have been reported in the vicinity. Expect hostile contact.
	<br/>
