...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to capture Dr. Aleksandr Volkov, a prominent scientist working with the Altis Armed Forces. Intel suggests he is currently located near Abdera, conducting research vital to the AAF's operations.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
    <br/>Proceed to the chosen insertion point. Maintain stealth and avoid engaging enemy forces unless absolutely necessary.
	<br/>
	<br/><font color='#FF7F00'>Gathering Intelligence</font>
    <br/>Once in the vicinity of the location, conduct reconnaissance to gather information on Dr. Volkov's whereabouts and the surrounding enemy forces. Utilize drones and reconnaissance equipment to maintain a safe distance.
	<br/>
	<br/><font color='#FF7F00'>Approach and Capture</font>
    <br/>Plan your approach carefully, taking advantage of cover and terrain to avoid detection. Move swiftly but silently to Dr. Volkov's location and apprehend him without raising alarm.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
    <br/>Once Dr. Volkov is secured, extract him from the area using the provided transport. Be prepared for potential enemy resistance during the extraction phase.
	<br/>
