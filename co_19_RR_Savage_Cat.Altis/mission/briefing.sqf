...
if (side group player != CIVILIAN) then {
	...
	<br/>We have received reliable intel that the Freedom and Independence Army (FIA) is utilizing a training facility located near Stavros to conduct operations against our interests. This training facility is a crucial hub for the FIA, serving as a staging area for their guerrilla fighters.
	<br/>
	<br/>Your mission is to capture the FIA training facility near Stavros and neutralize any FIA forces present. This will severely disrupt the FIA's operations in the area, allowing us to regain control.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
    <br/>The Commander will choose an insertion point, which will be approximately 1 kilometre from the target area.
	<br/>
	<br/><font color='#FF7F00'>Approach</font>
    <br/>Move toward the FIA training facility, avoiding unnecessary engagements. We want to catch them off guard.
	<br/>
	<br/><font color='#FF7F00'>Secure the Facility</font>
    <br/>Once you reach the facility, secure the perimeter first. Your main objectives are to capture the facility intact and gather any intel you may find.
	<br/>
	<br/><font color='#FF7F00'>Neutralize Threats</font>
    <br/>Engage and eliminate any FIA fighters present. Ensure to check all buildings, cargo posts, and bunkers within the facility for hostiles.
	<br/>
	<br/><font color='#FF7F00'>Gather Intel</font>
    <br/>While securing the facility, gather any documents, laptops, or other sources of intelligence that may shed light on FIA activities, leadership, or supply routes. These may be essential for future operations.
	<br/>
	<br/><font color='#FF7F00'>Extract</font>
    <br/>Once the area is secured, the Commander is to choose a suitable exfil location.
	<br/>
