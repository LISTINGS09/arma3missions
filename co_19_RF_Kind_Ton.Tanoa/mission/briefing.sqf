...
if (side group player != CIVILIAN) then {
	...
	<br/>Gendarme forces have been tasked with conducting a raid on two Syndikat caches located near a forest clearing. The Syndikat, known for their illicit activities, pose a significant threat to the stability of the region. Intelligence indicates that these caches contain a substantial amount of weaponry, ammunition, and supplies, which are being used to fuel Syndikat's operations in the area.
	<br/>
	<br/>
	<br/><font color='#FF7F00'>Reconnaissance</font>
	<br/>Upon insertion, conduct a brief reconnaissance of the area to confirm the location of the Syndikat caches and assess any potential threats or obstacles.
	<br/>
	<br/><font color='#FF7F00'>Approach</font>
	<br/>Move swiftly and quietly towards the forest clearing, utilizing the cover of the terrain to avoid detection. Exercise caution and maintain situational awareness at all times.
	<br/>
	<br/><font color='#FF7F00'>Engagement</font>
	<br/>Once the caches are located, initiate the assault simultaneously on both locations to maximize the element of surprise. Utilize coordinated fire and suppressive tactics to neutralize any Syndikat resistance swiftly.
	<br/>
	<br/><font color='#FF7F00'>Destruction</font>
	<br/>Utilize explosives or other suitable means to destroy the caches and render the contents unusable. Ensure all personnel maintain a safe distance during the demolition process.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>After completing the mission objectives, extract from the area. Maintain security during the extraction to prevent any potential ambush by Syndikat forces.
	<br/>
	<br/>
