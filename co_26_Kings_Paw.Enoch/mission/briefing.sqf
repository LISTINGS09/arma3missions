...
if (side group player != CIVILIAN) then {
	...
	<br/>Independent forces have captured two of our MBTs and are using them against us. Our mission is to neutralize the captured MBTs and secure two occupied locations while doing so.
	<br/>
	<br/>The first step is to assess the threat level posed by the captured MBTs and the Independent forces. We need to gather intelligence about their location to devise a suitable strategy, securing the bridge should be the first point of call.
	<br/>
	<br/>Your primary objective is to neutralize the captured MBTs and any associated crews nearby. We can use a combination of anti-tank infantry or close air support to destroy the tanks.
	<br/>
	<br/>Once the MBTs are neutralized, we need to secure any remaining locations before your mission is considered complete.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
