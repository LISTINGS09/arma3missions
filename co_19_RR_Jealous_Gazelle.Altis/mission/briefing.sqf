...
if (side group player != CIVILIAN) then {
	...
	<br/>Intelligence reports confirm the presence of a stolen CSAT Ammo Truck near a fortified NATO depot located in Lakka. This depot is critical for NATO's operations in the area and is heavily guarded. Our mission is to recover the stolen Ammo Truck and minimize any damage to the depot to avoid drawing unnecessary attention.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
    <br/>Infiltrate Lakka without raising suspicion. Maintain stealth until reaching the depot.
	<br/>
	<br/><font color='#FF7F00'>Locate the Truck</font>
    <br/>Once inside the depot, locate the stolen Truck's exact position it will be located in one of the warehouses.
	<br/>
	<br/><font color='#FF7F00'>Recover the Truck</font>
    <br/>Secure the stolen Ammo Truck and prepare it for extraction.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
    <br/>When the Ammo Truck is secured, rendezvous with the extraction team at a predetermined location by the Commander for a quick and safe evacuation.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>NATO has a significant presence in the area, with well-armed troops and armoured vehicles guarding the depot. Expect well-trained infantry and armoured support.
	<br/>
