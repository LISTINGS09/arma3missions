...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission as NATO forces is to capture two IDAP areas currently under Syndikat control. The primary targets are an IDAP school located in Ba and an IDAP warehouse situated south of Ba. Additionally, you are tasked with destroying a nearby Communication Tower to disrupt enemy communication and coordination.
	<br/>
	<br/><font color='#FF7F00'>Capture IDAP School</font>
	<br/>Secure the perimeter of the IDAP school.
	<br/>Conduct a systematic clearing operation to neutralize enemy resistance.
	<br/>Establish a stronghold within the school premises to prevent enemy reinforcements.
	<br/>
	<br/><font color='#FF7F00'>Capture IDAP Warehouse</font>
	<br/>Move south to the designated IDAP warehouse.
	<br/>Engage enemy forces and secure the warehouse area.
	<br/>Neutralize any enemy presence within the warehouse and set up defensive positions.
	<br/>
	<br/><font color='#FF7F00'>Destroy Communication Tower</font>
	<br/>Locate and destroy the nearby Communication Tower to disrupt enemy communications.
	<br/>Utilize explosives or other means to render the tower inoperable.
	<br/>Maintain security while the demolition team carries out the task.
	<br/>
	<br/>
