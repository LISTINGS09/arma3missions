...
if (side group player != CIVILIAN) then {
	...
	<br/>In recent weeks, tensions between NATO and CSAT have escalated on the island of Altis. Reports indicate that CSAT forces have planted an explosive device at an IDAP (International Development and Aid Project) warehouse, located in a densely populated civilian area. The detonation of this device would result in significant civilian casualties and humanitarian disaster.
	<br/>
	<br/>NATO has been authorized by the Altis government to neutralize this threat and prevent any further escalation. Your mission is to locate and disarm the explosive device planted by CSAT forces within the IDAP warehouse before they can detonate it (and they will after 30 minutes!).
	<br/>
	<br/><font color='#FF7F00'>Locate the IDAP Warehouse</font>
	<br/>Your first task is to locate the IDAP warehouse. It is situated near Limnichori and is marked on your map.
	<br/>
	<br/><font color='#FF7F00'>Secure the Area</font>
	<br/>Before approaching the warehouse, secure the immediate vicinity to ensure the safety of both your team and the civilians in the area. CSAT forces will have stationed guards around the warehouse.
	<br/>
	<br/><font color='#FF7F00'>Neutralize Any Resistance</font>
	<br/>CSAT will have left behind guards. Eliminate any threats swiftly and proceed with caution.
	<br/>
	<br/><font color='#FF7F00'>Locate and Disarm the Explosive</font>
	<br/>Once the area is secure, locate the explosive device near the warehouse. The device is believed to be located near a group IDAP crates, so use your team's expertise to find it.
	<br/>
	<br/><font color='#FF7F00'>Disarm the Explosive</font>
	<br/>Our explosive ordnance disposal (EOD) experts will be on-site to disarm the device. Provide them with cover and security during the disarmament process.
	<br/>
	<br/><font color='#FF7F00'>Exfiltration</font>
	<br/>After successful disarmament, exfiltrate the area immediately. Expect more CSAT reinforcements to arrive once they realize their plan has failed.
	<br/>
