...
if (side group player != CIVILIAN) then {
	...
	<br/>CSAT forces have been tracking a local FIA Leader for a number of weeks. Finally, HQ has confirmed their current location.
	<br/>
	<br/>You have been instructed to move out immediately and eliminate the FIA Leader at all costs.
	<br/>
	<br/>Eliminate the <font color='#0080FF'><marker name='marker_191'>FIA Leader</marker></font color> at the marked location.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	...
	<br/>Small infantry patrols and a number of static HMG/Mortar supports are known to be operational in the AO.
	<br/>
	<br/>FIA have also 'borrowed' some heavy armor from NATO. This is a significant step up from their standard off-road and is likely to either be an IFV or AAA asset - Watch out for them in the AO.
	<br/>
