...
if (side group player != CIVILIAN) then {
	...
	<br/>Commander, you have been tasked with stopping a CSAT smuggling operation that is posing a significant threat to regional stability and security. Intelligence reports indicate that the smugglers are transporting weapons and other illicit goods within barrels and may be working in collusion with other hostile actors in the area.
	<br/>
	<br/>Your mission is to neutralize the smuggling operation and locate two items of evidence, using all necessary means to ensure the safety of the civilian population and maintain regional stability.
	<br/>
	<br/>Your primary objectives are as follows:
	<br/>1. Secure the primary smuggling site.
	<br/>2. Interdict the flow of illicit goods by locating two items - You'll need some specialised tools to open the containers, which can be found nearby.
	<br/>3. Ensure the safety of the civilian population and prevent any collateral damage.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
