...
if (side group player != CIVILIAN) then {
	...
	<br/>Intelligence has confirmed the location of a Police Commander who is considered a high-value target. The Commander is heavily guarded by NATO patrols, but our forces have been tasked with capturing the Commander alive.
	<br/>
	<br/>Our mission is to capture the Police Commander and bring him into custody for questioning.
	<br/>
	<br/>Approach the target location with caution, establish a perimeter around the building and secure entry and exit points to prevent their escape.
	<br/>
	<br/>Once the target is located, interact with the person to disable them and take them into custody alive.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
