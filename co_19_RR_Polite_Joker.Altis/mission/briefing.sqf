...
if (side group player != CIVILIAN) then {
	...
	<br/>Our intelligence indicates that NATO has established a hidden outpost near Frini, containing a Multiple Launch Rocket System (MLRS). This MLRS poses a significant threat to our operations in the region. It is imperative that we destroy it before it can be used against CSAT forces.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Your team will infiltrate the area and take advantage of the forest cover to approach the area. Commander is to choose a starting location outside of the AO.
	<br/>
	<br/><font color='#FF7F00'>Intelligence Gathering</font>
    <br/>Once on the ground, gather any available intelligence on the outpost's layout and enemy positions. Prioritize reconnaissance to minimize surprises.
	<br/>
	<br/><font color='#FF7F00'>Assault</font>
    <br/>Move in on the outpost, eliminating any hostiles encountered. Do not raise alarms until you have reached the MLRS location. Avoid unnecessary casualties. Once you reach the MLRS, plant explosive charges to destroy it. Ensure you have adequate demolition equipment.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
    <br/>After the MLRS is destroyed, exfiltrate the area as quickly and stealthily as possible.
	<br/>
