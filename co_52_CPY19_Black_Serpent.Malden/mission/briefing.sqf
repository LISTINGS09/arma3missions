...
if (side group player != CIVILIAN) then {
	...
	<br/>NATO forces have recently landed on Malden and captured a number of towns to the South.
	<br/>
	<br/>A spec-ops team were sent in to establish contacts with local resistance forces, but were ambushed and captured.
	<br/>
	<br/>Your platoon is to break through the NATO lines, identify the location of the captured prisoners and rescue them before NATO can fully mobilise all forces.
	<br/>
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>Each squad has one IFV attached to move and fight across the AO. All squads begin to the <marker name='respawn_east'>North</marker>.
	<br/>
	<br/>Civilians are present in the area and must not be engaged under any circumstances. 
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>It is unknown when NATO landed on the island, however expect numerous mechanised and infantry patrols across the region.
	<br/>
	<br/>The town of <marker name='marker_45'>La Riviere</marker> and <marker name='marker_44'>Chapoi</marker> only have a minimum garrison of defenders, while <marker name='marker_42'>Cancon</marker> has a much larger enemy occupation - NATO has fortified a number of structures within the town and armoured vehicles have been spotted regularly passing through the town.
	<br/>
	<br/>NATO have also established a small field base at <marker name='DOWNMKR_1'>Saint Martin</marker>, which holds a laptop containing the location of our prisoners.
	<br/>
	<br/>Intel indicates an armed helicopter touched down somewhere in the area - Approach with caution.
	<br/>
	<br/><font size='18' color='#80FF00'>CREDITS</font>
	<br/>Created by <font color='#72E500'>2600K</font color>
	<br/>
	...
	(missionName splitString " ") param [3,"**REDACTED**"]
	]]];
};
