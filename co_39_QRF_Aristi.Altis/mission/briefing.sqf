...
if (side group player != CIVILIAN) then {
	...
	<br/>Joint Operations Center (JOC) reports there is a good opportunity to secure and eliminate the enemies located at <font color='#0080FF'><marker name='obj2'>Aristi</marker></font color>.<br/>
	<br/>
	<br/>Destroy the <font color='#0080FF'><marker name='obj1'>ZSU-39</marker></font color> armor located at Aristi.
	<br/>Clear and secure <font color='#0080FF'><marker name='obj2'>Aristi</marker></font color> from enemy forces.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
