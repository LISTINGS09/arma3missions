...
if (side group player != CIVILIAN) then {
	...
	<br/>The LDF has been trying to establish an Outpost over the past few weeks.
	<br/>
	<br/>Move into the area and eliminate all traces of the Outpost.
	<br/>
	<br/>%1 <!-- Casualties Cap -->
	...
	<br/>%2%3
	<br/>
	<br/>The LDF has deployed a number of AP minefields, so watch your step!
	<br/>
