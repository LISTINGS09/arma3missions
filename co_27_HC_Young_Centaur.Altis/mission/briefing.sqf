...
if (side group player != CIVILIAN) then {
	...
	<br/>A high-ranking asset under Russian command has been captured by FIA insurgents near the town of Sofia. The man is critical to ongoing intelligence operations in the region. Our reconnaissance indicates that the asset has been wounded and is being held in a compound just outside of Sofia. The area is heavily guarded by FIA insurgents who have fortified positions along the road.
	<br/>
	<br/>
	<br/>Your objective is to recover the captured asset. Due to his injuries, the asset will require extraction via carrying. The FIA insurgents are aware of the asset's value and will likely respond aggressively once they detect any rescue attempt. Time is of the essence—extract the asset and return him to safety to ensure medical attention is administered as soon as possible.
	<br/>
	<br/>%4
	<br/>
	<br/>%1 <!--- Casualties Cap --->
