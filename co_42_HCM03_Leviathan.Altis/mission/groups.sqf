...
_grpIND = [
	["GrpAAF_CO","CO","b_hq","CO",_yellow],
	["GrpAAF_ASL","Alpha","b_inf","A",_red],
	["GrpAAF_BSL","Bravo","b_inf","B",_blue],
	["GrpAAF_CSL","Charlie","b_inf","C",_green],
	["GrpAAF_DSL","Delta","b_inf","D",_orange]
