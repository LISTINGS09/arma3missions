...
UPSMON_Debug = 0;
//if !isMultiplayer then {UPSMON_Debug = 1;}; // Too much spam and untify messages!
...
UPSMON_searchVehicledist = 400; // 700, 900 
...
UPSMON_USE_SMOKE = 70; // org 13: decreased while AI is popping smoke a bit too often
...
UPSMON = compile preProcessFileLineNumbers "Scripts\UPS\UPSMON.sqf";
UPSMON_CreateGroup = compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\UPSMON_CreateGroup.sqf";

//Core
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\COMMON\Core\init.sqf";
call compile preprocessFileLineNumbers "Scripts\UPS\UPSMON\Get_pos\UPSMON_pos_init.sqf";
//Params
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\COMMON\Group\init.sqf";
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\COMMON\target\init.sqf";
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\COMMON\unit\init.sqf";
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\COMMON\Params\init.sqf";
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\COMMON\buildings\init.sqf";
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\COMMON\vehicles\init.sqf";
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\COMMON\cover\init.sqf";
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\COMMON\terrain\init.sqf";
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\COMMON\MP\init.sqf";
//Modules
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\MODULES\init.sqf";
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\MODULES\FORTifY\init.sqf";
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\MODULES\AMBUSH\init.sqf";
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\MODULES\ARTILLERY\init.sqf";
//Orders
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\MODULES\ORDERS\UPSMON_PATROL\init.sqf";
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\MODULES\ORDERS\UPSMON_REINFORCEMENT\init.sqf";
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\MODULES\ORDERS\UPSMON_Transport\init.sqf";
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\MODULES\ORDERS\UPSMON_PATROLSRCH\init.sqf";
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\MODULES\ORDERS\UPSMON_FLANK\init.sqf";
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\MODULES\ORDERS\UPSMON_ASSAULT\init.sqf";
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\MODULES\ORDERS\UPSMON_DEFEND\init.sqf";
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\MODULES\ORDERS\UPSMON_RELAX\init.sqf";
call compile preProcessFileLineNumbers "Scripts\UPS\UPSMON\MODULES\ORDERS\UPSMON_SUPPLY\init.sqf";

[] execvm "Scripts\UPS\UPSMON\COMMON\CORE\fnc\UPSMON_TRACK.sqf";
[] execvm "Scripts\UPS\UPSMON\UPSMON_MAINLOOP.sqf";
[] execvm "Scripts\UPS\UPSMON\UPSMON_MAINLOOPCiv.sqf";
