...
if (side group player != CIVILIAN) then {
	...
	<br/>Locate and destroy three caches hidden somewhere around an occupied research facility.
	<br/>
	<br/>%1
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>Around one company of insurgent forces are located in the region. 
	<br/>
	<br/>They are lightly armed, however do have technical and mortar supports stationed within the facility.
	<br/>
