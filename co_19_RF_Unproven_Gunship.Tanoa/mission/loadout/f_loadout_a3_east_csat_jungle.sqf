...
// Default setup
_attachments = [_silencer1,_attach1,_scope1]; // The default attachment set for most units, overwritten in the individual unitType
...
_attach_mg = [_silencer1,_attach1,_scope1,_bipod1];
...
// Medium AT
_MAT = ["launch_O_Vorona_green_F","launch_O_Titan_short_ghex_F","launch_O_Titan_ghex_F"];
