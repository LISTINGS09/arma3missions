...
if (side group player != CIVILIAN) then {
	...
	<br/>Intelligence reports indicate a strategic opportunity to further our influence in the Chapoi region. The NATO presence in the area has been a thorn in our side for too long. We have identified three key targets that, once secured, will significantly weaken their foothold and grant us a stronger position in this area.
	<br/>
	<br/>Power Transformers
	<br/>This facility is crucial to the operation of the NATO forces in the region. It supplies electricity to their communication systems, surveillance equipment, and possibly their defensive emplacements. Securing this site will disrupt their capabilities and create confusion in their ranks.
	<br/>
	<br/>Mortar Pit
	<br/>The mortar pit located near the Power Transformer Site poses a significant threat to any offensive actions we undertake. It is essential that we neutralize this threat to ensure the safety of our forces during the operation. Capturing the mortar pit will also provide us with a valuable indirect fire capability that we can use against other NATO positions.
	<br/>
	<br/>Medical Facility
	<br/>The medical facility in the area plays a crucial role in sustaining NATO personnel. By taking control of this facility, we can deny them medical aid, erode their morale, and potentially force them to divert resources from other fronts to tend to their wounded.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
