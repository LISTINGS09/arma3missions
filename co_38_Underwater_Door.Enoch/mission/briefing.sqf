...
if (side group player != CIVILIAN) then {
	...
	<br/>We have received intelligence that a CSAT Device Truck has been spotted within an outpost located to the north of Nadbor. Your mission is to clear the outpost and capture the device truck before it can be extracted by CSAT forces.
	<br/>
	<br/>The outpost is heavily guarded and we can expect resistance from both infantry and armored vehicles. Your objective is to eliminate all hostile forces and secure the area to prevent any counter-attacks.
	<br/>
	<br/>Once the area is secure, locate and retrieve the device truck.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
