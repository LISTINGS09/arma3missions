...
if (side group player != CIVILIAN) then {
	...
	<br/>FIA forces have been tasked with the critical mission of destroying an enemy cache that has fallen into Syndikat hands. Syndikat forces have stolen a significant number of munitions, which pose a grave threat to our operations and the stability of the region. It is imperative that these munitions are neutralized to prevent them from being used against us or innocent civilians. Furthermore, by destroying the cache, we will send a clear message to Syndikat and other hostile factions that their actions will not go unpunished.
	<br/>
	<br/>Your primary objective is to locate and destroy the enemy cache. This will require a coordinated effort to breach Syndikat defenses, neutralize enemy resistance and secure the area for demolition. Once the cache has been located, utilize your infantry to clear buildings and secure the perimeter. Be prepared for a fierce firefight and adapt your tactics as needed to overcome Syndikat resistance within the jungle.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>Syndikat forces are known to be well-equipped and highly motivated. They have fortified the cache location and are prepared to defend it at all costs. Expect heavy resistance, including infantry and armored vehicles.
	<br/>
