...
if (side group player != CIVILIAN) then {
	...
	<br/>Your force has been tasked with recovering a fuel truck captured by Russian forces near the town of Orino. The fuel truck is crucial for sustaining our operations in the area, and its loss poses a significant threat to our logistical capabilities. Your mission is to locate, secure, and extract the fuel truck while neutralizing any hostile forces encountered.
	<br/>
	<br/>
	<br/><font color='#FF7F00'>Insertion</font>
	<br/>Your team will be inserted at a location outside of the AO chosen by the Commander. From there, proceed on foot into the AO.
	<br/>
	<br/><font color='#FF7F00'>Reconnaissance</font>
	<br/>Conduct reconnaissance of the area to gather intelligence on enemy positions, patrols, and any potential obstacles to the mission. Utilize drones and reconnaissance teams to gather real-time information.
	<br/>
	<br/><font color='#FF7F00'>Advance to Contact</font>
	<br/>Move cautiously towards the last known location of the fuel truck, utilizing available cover and terrain to avoid detection. Maintain situational awareness and be prepared for enemy contact at any time.
	<br/>
	<br/><font color='#FF7F00'>Neutralize Hostiles</font>
	<br/>Engage and neutralize any Russian forces encountered in the area. Use a combination of small arms fire, heavy weapons, and supporting fire from your UAV eliminate threats.
	<br/>
	<br/><font color='#FF7F00'>Secure the Truck</font>
	<br/>Once the area is cleared of hostiles, locate and secure the fuel truck. Ensure that it is intact and operational for extraction.
	<br/>
	<br/><font color='#FF7F00'>Exfiltration</font>
	<br/>Once the fuel truck is secured, clear the area of any remaining hostiles and prepare to extract the Truck to a location designated by the Commander.
	<br/>
	<br/>
