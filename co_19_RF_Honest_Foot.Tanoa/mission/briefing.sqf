...
if (side group player != CIVILIAN) then {
	...
	<br/>Your CSAT forces must capture a CTRG road checkpoint by seizing control of the flagpole located South of Petit Nicolet and securing the HQ within the village of Petit Nicolet. A NATO Armored Personnel Carrier (APC) is stationed at the HQ and poses a significant threat.
	<br/>
	<br/>The area around Petit Nicolet is strategically vital for our operations. The CTRG checkpoint serves as a critical barrier for NATO forces. By capturing it, we gain control over a key route, enhancing our logistical capabilities and securing our position in the region.
	<br/>
	<br/><font color='#FF7F00'>1.</font> Eliminate resistance at the checkpoint and secure the flagpole there.
	<br/><font color='#FF7F00'>2.</font> Secure the HQ within the village of Petit Nicolet.
	<br/><font color='#FF7F00'>3.</font> Neutralize the NATO APC stationed at the HQ to prevent it from impeding our advance.
	<br/>
