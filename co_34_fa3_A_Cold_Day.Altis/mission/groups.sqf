...
_GrpOPF = [
	...
	,["GrpCSAT_A1","Alpha One","o_inf","A1",_opfor]
	,["GrpCSAT_A2","Alpha Two","o_inf","A2",_opfor]
	,["GrpCSAT_BSL","Bravo SL","o_inf","BSL",_opfor]
	,["GrpCSAT_B1","Bravo One","o_inf","B1",_opfor]
	,["GrpCSAT_B2","Bravo Two","o_inf","B2",_opfor]
	,["GrpCSAT_MMG1","MMG","o_support","MMG",_opfor]
	,["GrpCSAT_IFV1","IFV","o_mech_inf","IFV",_opfor]
];