...
if (side group player != CIVILIAN) then {
	...
	<br/>Your task is to rescue a captured officer from Syndikat rebels who have overrun a listening station in the area. The officer is believed to be held hostage within the station. Syndikat forces are known to have heavy armour in the vicinity, so caution is advised.
	<br/>
	<br/>Syndikat rebels have taken control of the listening station, capturing one of our officers who was manning it. The officer's exact location within the station is unknown, but it is imperative to extract them safely.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Approach the area cautiously, avoiding detection by Syndikat patrols. Use the cover of terrain and foliage to your advantage.
	<br/>
	<br/><font color='#FF7F00'>Search and Rescue</font>
	<br/>Once you reach the listening station, secure the perimeter and conduct a thorough search to locate the captured officer. Be prepared for enemy contact at any moment.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>Once the officer is located, extract them from the area safely. Coordinate with the UAV for air support and eliminate any remaining enemy threats.
	<br/>
	<br/><font color='#FF7F00'>Exfiltration</font>
	<br/>Withdraw from the area swiftly, ensuring the safety of all personnel. Avoid prolonged engagements with Syndikat forces and prioritize the successful extraction of the officer.
	<br/>
	<br/>
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>You will have the support of NATO UAV for close air support. Utilize this asset judiciously to neutralize enemy armor and provide cover for ground forces.
	<br/>
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>Syndikat rebels are well-armed and equipped, with heavy armor present in the area. Expect fierce resistance as you approach the listening station. Syndikat may have fortified their position, so be prepared for entrenched enemies.
	<br/>	
