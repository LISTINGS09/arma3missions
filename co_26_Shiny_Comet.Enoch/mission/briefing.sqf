...
if (side group player != CIVILIAN) then {
	...
	<br/>A meteor has crashed somewhere near Brena.
	<br/>
	<br/>Investigate the area for intelligence, including the location of the impact site and take control of it from the LDF.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
