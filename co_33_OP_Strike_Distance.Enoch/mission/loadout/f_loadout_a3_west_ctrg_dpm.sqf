...
// Default setup
_attachments = [_attach1,_scope2,_bipod1, _silencer1, _silencer2]; // The default attachment set for most units, overwritten in the individual unitType

// Predefined Class Attachment Setup
_attach_co = [_attach1,_scope2,_bipod1, _silencer1, _silencer2];
_attach_dc = [_attach1,_scope2,_bipod1, _silencer1, _silencer2]; // Also SL!
_attach_fl = [_attach1,_scope2,_bipod1, _silencer1, _silencer2];
_attach_mg = [_attach1,_scope2,_bipod1, _silencer1, _silencer2];
...
// Automatic Rifleman
_AR = ["LMG_03_F","arifle_MX_SW_Black_F","arifle_MX_SW_khk_F"];
