...
// CSAT PACIFIC (APEX)
  case 4:
  {
    ...
    _Unit_Pool_V = ["O_T_MRAP_02_ghex_F","O_T_MRAP_02_gmg_ghex_F","O_T_MRAP_02_hmg_ghex_F","O_T_LSV_02_armed_F","O_T_LSV_02_AT_F","O_T_LSV_02_unarmed_F","O_T_Truck_03_transport_ghex_F","O_T_Truck_03_covered_ghex_F"];
...
// RUSSIAN (APEX)
  case 15:
  {
    _Unit_Pool_S = ["O_R_soldier_M_F","O_R_Soldier_LAT_F","O_R_Soldier_TL_F","O_R_medic_F","O_R_Soldier_AR_F","O_R_soldier_exp_F","O_R_Soldier_GL_F","O_R_Patrol_Soldier_A_F","O_R_Patrol_Soldier_Engineer_F"];
    _Unit_Pool_V = ["O_T_MRAP_02_ghex_F","O_T_MRAP_02_gmg_ghex_F","O_T_MRAP_02_hmg_ghex_F","O_T_LSV_02_armed_F","O_T_LSV_02_unarmed_F","O_T_Truck_03_transport_ghex_F","O_T_Truck_03_covered_ghex_F"];
    _Unit_Pool_T = ["O_T_MBT_02_cannon_ghex_F","O_T_MBT_02_arty_ghex_F","O_T_APC_Tracked_02_cannon_ghex_F","O_T_APC_Wheeled_02_rcws_ghex_F","O_T_APC_Tracked_02_AA_ghex_F"];
	_Unit_Pool_A = ["O_T_VTOL_02_infantry_F","O_Heli_Attack_02_black_F","O_Heli_Light_02_v2_F"];
  };
