...
if (side group player != CIVILIAN) then {
	...
	<br/>This mission is aimed at securing a CSAT camp situated near the Xirolimni Dam. The camp, serving as a strategic stronghold for CSAT forces, poses a significant threat to regional stability and FIA interests. Your mission is to neutralize enemy resistance, secure the camp, and establish FIA control over the area.
	<br/>
	<br/><font color='#FF7F00'>Neutralize Enemy Forces</font>
	<br/>Engage and eliminate all CSAT forces occupying the camp and its surrounding areas.
	<br/>
	<br/><font color='#FF7F00'>Secure Xirolimni Dam</font>
	<br/>Ensure the safety and integrity of the Xirolimni Dam to prevent any potential sabotage attempts.
	<br/>
	<br/>
