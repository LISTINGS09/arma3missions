...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to capture an Outpost and destroy an airdrop before it can be secured by the AAF outside of Negades. The airdrop contains critical supplies that could significantly bolster AAF's capabilities in the region. It's imperative that you act swiftly and decisively to prevent this from happening.
	<br/>
	<br/><font color='#FF7F00'>1.</font> Locate the Outpost using your recon capabilities, it will be identified by AAF flags.
	<br/><font color='#FF7F00'>2.</font> Neutralize any AAF forces guarding the Outpost and await the airdrop.
	<br/><font color='#FF7F00'>3.</font> Destroy the dropped supplies by any means necessary to prevent them from falling into enemy hands.	
	<br/><font color='#FF7F00'>4.</font> Extract safely from the area once the mission is accomplished.
	<br/>
