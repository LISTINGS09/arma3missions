...
if (side group player != CIVILIAN) then {
	...
	<br/>AAF forces are assisting FIA in gaining control in this area. 
	<br/>
	<br/>Attack the FIA fuel depot and search for intel confirming AAF support somewhere within the depot.
	<br/>
	<br/>Once confirmed, the fuel depot will need destroyed and you will need to return to base.
	<br/>
	<br/>The V-44 has an action that will allow units to paradrop from the plane. Vector may also provide support via an armed V-44 found at the rearming point.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
