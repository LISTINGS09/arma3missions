...
if (side group player != CIVILIAN) then {
	...
	<br/>Fellow Freedom and Independence Army (FIA) soldiers, we have received critical intelligence that the Insurgent forces in the Agios Petros region possess a valuable document outlining their future plans, supply routes and potential contacts with foreign actors. Obtaining this intelligence is crucial for our continued fight against the oppressive Altis Armed Forces.
	<br/>
	<br/>The Insurgents are currently headquartered in the vicinity of Agios Petros, which is a remotely populated rural area. Expect enemy contact in the town itself and its surrounding areas. We must move swiftly and discreetly to secure the intelligence and extract without drawing unnecessary attention to our presence.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Infiltrate the Agios Petros area covertly. It's crucial that we maintain the element of surprise.
	<br/>
	<br/><font color='#FF7F00'>Intelligence Retrieval</font>
	<br/>Locate the Insurgent headquarters, which is suspected to be in the vicinity of Agios Petros. Search for the intelligence documents and secure them.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>Once you have the document, extract from the area as quickly as possible. Avoid prolonged engagements with enemy forces.
	<br/>
