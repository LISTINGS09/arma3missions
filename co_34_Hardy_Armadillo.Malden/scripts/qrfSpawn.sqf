...
_Air = [["O_T_VTOL_02_infantry_dynamicLoadout_F","_grpVeh setPylonLoadout [1,'PylonRack_19Rnd_Rocket_Skyfire']; _grpVeh setPylonLoadout [4,'PylonRack_19Rnd_Rocket_Skyfire'];"],["O_Heli_Transport_04_bench_F","[_grpVeh,['Black',1]] call BIS_fnc_initVehicle;"]];
...
for [{_wave = 1}, {_wave < _waveMax}, {_wave = _wave + 1}] do {
	...
	switch (_wave) do {
		...
		case 3: {
			...
			[_location, _spawnRoad, _side, selectRandom (_Medium)] call zmm_fnc_spawnUnit;
			[_location, _spawnLand, _side, selectRandom _Team] call zmm_fnc_spawnUnit;
		};
		case 4: {
			[_location, _spawnRoad, _side, selectRandom (_Light + _Truck)] call zmm_fnc_spawnUnit;
		...
		default {
			...
			[_location, _spawnRoad, _side, selectRandom (_Heavy)] call zmm_fnc_spawnUnit;
			[_location, _spawnLand, _side, selectRandom _Team] call zmm_fnc_spawnUnit;
			[_location, _spawnLand, _side, selectRandom _Team] call zmm_fnc_spawnUnit;
		};
	};
