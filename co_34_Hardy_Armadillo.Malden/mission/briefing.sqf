...
if (side group player != CIVILIAN) then {
	...
	<br/>The first site is located near Corton, while the second site is located at Blanches. Both sites are currently occupied by Russian forces, who have established strong defences and are expected to put up a fierce resistance.
	<br/>
	<br/>Your objectives for this mission are as follows:
	<br/>1. Neutralize all enemy forces at both sites.
	<br/>2. Secure the sites and prevent any further enemy incursions.
	<br/>3. Gather any intelligence that can be useful for future operations.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	...
	<br/>%2%3
	<br/>
	<br/>Additional QRF forces can be expected from outside the area, expect a heavy Russian counterattack.
	<br/>
