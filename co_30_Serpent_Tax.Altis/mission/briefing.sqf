...
if (side group player != CIVILIAN) then {
	...
	<br/>We have identified a strategic communications tower located near the town of Abdera. This tower serves as a critical hub for enemy communications in the region. Your objective is to destroy this tower, severing their command and control capabilities. Additionally, you are to capture the town of Abdera, establishing a CSAT foothold in the area.
	<br/>
    <br/>Destroy the communications tower: The primary objective is to neutralize the communications tower by planting explosive charges at key structural points. Once the charges are set, retreat to a safe distance for detonation.
    <br/>Capture the town of Abdera: Clear the town of enemy forces and establish control. This involves neutralizing any hostile units encountered and securing key locations such as the town center, government buildings, and strategic positions.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
