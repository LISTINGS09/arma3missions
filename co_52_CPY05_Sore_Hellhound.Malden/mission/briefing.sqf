...
if (side group player != CIVILIAN) then {
	...
	<br/>NATO forces have occupied three villages to the west, clear each location of enemy forces.
	<br/>
	<br/>%1
	<br/>
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>Up to five squads begin outside <font color='#0080FF'><marker name='respawn_east'>Dourdan</marker></font color>, you are to proceed into the AO on foot.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>Enemy infantry and motorised patrols will be active across the area. One IFV is known to be operational within one of the villages.
	<br/>
