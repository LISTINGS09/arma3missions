...
if (side group player != CIVILIAN) then {
	...
	<br/>Syndikat forces have captured an LDF Communications Truck. 
	<br/>
	<br/>Recover the truck likely located at one of the four enemy camps, then clear any of the remaining camps of enemy forces.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>Each of the camps are expected to be lightly guarded. The following units are known to be operational in the AO:
	<br/>%2%3
	<br/>
