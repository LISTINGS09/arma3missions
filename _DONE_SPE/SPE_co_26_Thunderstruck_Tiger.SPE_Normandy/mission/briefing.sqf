...
// <marker name='marker_10'>XXX</marker>
// Green #80FF00
// Orange #FF7F00
// Blue #00FFFF
...
if (side group player != CIVILIAN) then {
	...
	<br/>Your forces have been tasked with locating and destroying three US caches hidden in the area around <marker name='marker_10'>La Guederie</marker>. 
	<br/>
	<br/>The caches are believed to contain vital military munitions and equipment that could pose a significant threat to our operations if they fall into the wrong hands. The success of this mission is crucial to ensuring our advantage on the battlefield.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
