...
if (side group player != CIVILIAN) then {
	...
	<br/>Our intelligence has identified a strategically vital German ammunition dump located at Avocaterie. Capturing and securing this facility is crucial to weakening the enemy's logistical capabilities in this region.
	<br/>
    <br/>Primary Objective: Capture the German Ammo Dump at Avocaterie.
    <br/>Secondary Objective: Neutralize any resistance encountered.
	<br/>
    <br/>The German forces have fortified the area, expecting retaliation. Expect heavy resistance.
    <br/>Our intelligence suggests the presence of enemy infantry and armoured vehicles.
	<br/>
	<br/>Fast Travel available from Flag.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
