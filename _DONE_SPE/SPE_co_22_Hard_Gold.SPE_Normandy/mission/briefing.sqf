...
if (side group player != CIVILIAN) then {
	...
	<br/>US Forces have received credible intelligence indicating the presence of a German anti-tank gun in the town of <marker name='marker_7'>Cambernon</marker>. 
	<br/>
	<br/>This PaK 40 poses a significant threat to our advancing units and must be neutralized immediately. Your task force, has been assigned the mission to locate and eliminate the PaK40 gun, ensuring the safety of friendly forces in the region.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
