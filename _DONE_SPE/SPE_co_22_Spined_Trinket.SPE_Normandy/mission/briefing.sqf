...
if (side group player != CIVILIAN) then {
	...
	<br/>Our intelligence reports indicate that the Marigny Church is currently being used as a strategic stronghold by German forces. Additionally, two FlaK 36 Anti-Tank Artillery units are positioned in the vicinity, posing a significant threat to our armoured divisions. It is imperative that we swiftly and decisively neutralize these threats to ensure the success of our broader campaign.
	<br/>
	<br/><font color='#FF7F00'>Capture Marigny Church</font>
	<br/>Deploy your infantry to secure the church building. Be cautious of potential enemy reinforcements and utilize cover effectively.
	<br/>Once secured, establish a defensive perimeter to repel any counterattacks.
	<br/>
	<br/><font color='#FF7F00'>Neutralize Anti-Tank Artillery</font>
	<br/>Utilize your armoured assets to locate and destroy the two FlaK 36 assets.
	<br/>Coordination between infantry and armor is crucial. Infantry should screen for anti-tank threats while armoured units engage the artillery.
	<br/>
	<br/><font size='18' color='#80FF00'>Enemy Forces</font>
	<br/>The enemy forces occupying Marigny Church and the surrounding area are a well-equipped and entrenched faction. Expect infantry with small arms, as well as possible anti-tank and sniper elements. The FlaK 36 Anti-Tank Artillery units are positioned to strategically to cover key approaches, making a direct assault from this direction challenging.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
