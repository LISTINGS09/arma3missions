...
// <marker name='marker_3'>XXX</marker>
// Green #80FF00
// Orange #FF7F00
// Blue #00FFFF
...
if (side group player != CIVILIAN) then {
	...
	<br/>You are French Resistance forces and have been tasked with disrupting the German supply route near <marker name='marker_3'>Cametours</marker>. 
	<br/>
	<br/>Intelligence reports indicate that three critical locations along this supply route must be mined to impede their logistical operations. The success of this operation is paramount to weaken the enemy's capabilities in the region.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	<br/>
