...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to conduct a side attack on the village of La Geniere, currently held by German forces. Intelligence reports indicate that the Germans are preparing a strong defence to the south. To exploit this vulnerability, your American forces will execute a flanking manoeuvre from the west, catching the enemy off guard.
	<br/>
	<br/><font color='#FF7F00'>Flanking Manoeuvre</font>
	<br/>Once in position on the western side of La Geniere, coordinate your forces for a synchronized attack.
	<br/>Divide your forces to create confusion among the enemy ranks.
	<br/>Exploit any weaknesses in their defences and push towards the centre of the village.
	<br/>
	<br/><font color='#FF7F00'>Target Prioritization</font>
	<br/>Establish control over key intersections and access points to limit the enemy's mobility within the village.
	<br/>Focus on eliminating high-value targets, including enemy commanders and heavy weapons positions and vehicles.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
