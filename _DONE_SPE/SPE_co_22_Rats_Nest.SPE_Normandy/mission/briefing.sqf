...
if (side group player != CIVILIAN) then {
	...
	<br/>The village of La Geniere has become a stronghold for the French Resistance. Recent intelligence reports suggest that they have fortified the area and are using it as a base for their operations. The Resistance has been disrupting our supply lines and causing unrest in the region, which is strategically important.
	<br/>
	<br/>You have been tasked with capturing La Geniere and neutralizing the French Resistance presence in the area. It's crucial to restore stability and ensure the safety of the local population.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
