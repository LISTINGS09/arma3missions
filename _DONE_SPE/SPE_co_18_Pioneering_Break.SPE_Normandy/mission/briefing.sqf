...
if (side group player != CIVILIAN) then {
	...
	<br/>The enemy has established a strategic artillery battery at La Petite Moriniere, posing a significant threat to our operations in the region. Intelligence reports suggest that the battery is actively targeting civilian populations and our resistance strongholds. Your mission is to infiltrate La Petite Moriniere and eliminate the artillery threat to ensure the safety of our people.
	<br/>
	<br/><font color='#FF7F00'>Sabotage</font>
	<br/>Identify the optimal point of entry for your main assault force.
	<br/>Prioritize the destruction of the artillery piece. Use explosives or other means to render them inoperable.
	<br/>Beware of enemy reinforcements; time is of the essence.
	<br/>
	<br/><font color='#FF7F00'>Exfiltration</font>
	<br/>After completing the objective, withdraw from the area using a different route than your entry point.
	<br/>Expect enemy pursuit and be prepared for ambushes. Plan your escape route and have designated fallback points.
	<br/>
