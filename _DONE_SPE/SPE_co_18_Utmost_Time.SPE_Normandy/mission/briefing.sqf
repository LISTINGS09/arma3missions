...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to complete the assault on a halted German convoy in the dense forest of Bois De Soulles. This operation comes after a failed ambush by our main Resistance forces, which encountered unexpected and strong opposition, forcing them to retreat. Your primary task is to locate and destroy three identified ammo trucks within the convoy.
	<br/>
	<br/><font size='18' color='#80FF00'>Enemy Forces</font>
	<br/>The German convoy is well-armed with one tank and may have reinforced their positions with additional infantry after the failed ambush.
    <br/>Resistance forces in the area are likely to have set up defensive positions and traps. Expect a determined and well-coordinated enemy.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
