...
if (side group player != CIVILIAN) then {
	...
	<br/>Secure the Harbour and Rebel HQ to the North of Le Port.
	<br/>
	<br/>%1
	<br/>
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>Civilians will be present in the town, watch your fire!
	<br/>
	<br/>Each squad has one unarmed transport to move across the AO.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>Allied forces have managed to push back the Rebel forces out of the town of Le Port. The remaining area to the North will consist of light patrols and what remains of a mechanised section.
	<br/>
	<br/>Rebels have been known to barricade the roads leading out to the North of the town, expect them to be fortified.
	<br/>
	<br/>Around the HQ light helicopter support has been spotted, expect them to be airborne as you near the target - Light arms fire should bring them down easily enough. 
	<br/>
	<br/>Mortar support is also believed to be at the HQ so avoid lingering too long when in contact.
	<br/>
	<br/>
