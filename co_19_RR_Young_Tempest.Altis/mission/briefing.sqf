...
if (side group player != CIVILIAN) then {
	...
	<br/>Your primary objective is to locate and destroy an insurgent cache hidden near Syrta. The cache contains critical supplies and weaponry that the insurgents are utilizing to fuel their operations. Your task is to neutralize this threat and deny the enemy access to these resources.
	<br/>
	<br/><font color='#FF7F00'>Locate the Insurgent Cache</font>
	<br/>Use your reconnaissance assets to identify the precise location of the insurgent cache. This may involve gathering intelligence from conducting patrols, or utilizing unmanned aerial vehicles (UAVs) for reconnaissance.
	<br/>
	<br/><font color='#FF7F00'>Destroy the Cache</font>
	<br/>Once the cache has been located, neutralize it using explosives or other means. Ensure that the cache is completely destroyed to prevent the insurgents from salvaging any supplies.
	<br/>
	<br/><font color='#FF7F00'>Eliminate Resistance</font>
	<br/>Engage and neutralize any insurgent forces encountered in the vicinity of the cache. Maintain situational awareness and be prepared for enemy counterattacks.
	<br/>
