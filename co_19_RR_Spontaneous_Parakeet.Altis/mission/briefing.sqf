...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to conduct a sabotage operation targeting a CSAT (Canton Protocol Strategic Alliance Treaty) camp located near Galati. Your primary objective is to sabotage their supplies, particularly targeting their food storage facilities. The aim is to disrupt their logistics and weaken their operational capabilities in the region.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Approach the target area as stealthily as possible to avoid detection. Utilize the natural terrain features to conceal your movements.
	<br/>
	<br/><font color='#FF7F00'>Sabotage Supplies</font>
	<br/>Once near the camp perimeter, locate the food storage baskets. Interact with the baskets to set fire to any food supplies you encounter. Ensure thorough destruction to prevent salvage or recovery by the enemy.
	<br/>
	<br/><font color='#FF7F00'>Avoid Detection</font>
	<br/>Be vigilant for enemy patrols and security measures. Stay low and maintain stealth throughout the operation to minimize the risk of engagement.
	<br/>
	<br/><font color='#FF7F00'>Exfiltration</font>
	<br/>After completing the sabotage objectives, withdraw from the area. Utilize predetermined extraction routes as chosen by the Commander.
	<br/>
	<br/>
