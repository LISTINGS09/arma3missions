...
if (side group player != CIVILIAN) then {
	...
	<br/>1. Destroy a CSAT T-100 currently undergoing repairs at the CSAT Military Base.
	<br/>2. Eliminate the Bases Commander, currently located at the nearby Radio Station.
	<br/>
	<br/>%1
	<br/><font size='18' color='#80FF00'>SPECIAL TASKS</font>
	<br/>An unoccupied IFV has been spotted parked nearby the lighthouse, if the crew can be eliminated before they can remount the IFV it could be captured and used to assist in the attack.
	<br/>
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>Each squad has one unarmed and one HMG Technical for transport, if required.
	<br/>
	<br/>The IFV crew has one AT Technical.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>In addition to the parked IFV, a further two IFVs have been seen moving around the base.
	<br/>
	<br/>One light attack helicopter is known to be on standby from the airport to the East or already landed at the Military Base - Expect it to mobilise if you are spotted nearing the Military Base. 
	<br/>
	<br/>Infantry patrols can be expected across the entire AO. 
	<br/>
