...
if (side group player != CIVILIAN) then {
	...
	<br/>Your task force is to capture three critical Russian-held locations near Altis Airfield. The success of this operation is crucial to securing the strategic position and maintaining control over the region. The three primary targets are as follows:
	<br/>
	<br/><font color='#FF7F00'>Abandoned Resort</font>
	<br/>Located to the northwest of Altis Airfield, the abandoned resort has been converted into a fortified Russian position. It serves as a key observation point for enemy forces in the area. Your mission is to neutralize all hostiles, secure the resort, and establish a forward operating base.
	<br/>
	<br/><font color='#FF7F00'>Power Plant</font>
	<br/>Situated to the northeast of Altis Airfield, the power plant is currently under Russian control. It provides electricity to the nearby regions, making it a vital asset for the enemy. Your objective is to eliminate the enemy forces, take control of the power plant, and prevent any damage to the infrastructure.
	<br/>
	<br/><font color='#FF7F00'>Loading Dock</font>
	<br/>Positioned to the southeast of Altis Airfield, the loading dock serves as a primary Russian logistics hub. Capturing this location will significantly disrupt the enemy's supply lines and limit their ability to reinforce their positions. Your task is to clear out the enemy forces and secure the docks.
	<br/>
	<br/>A lightly armed military research side stands between you and these three objectives. You'll save us some trouble if you can secure it on your advance, but it remains optional.
	<br/>
