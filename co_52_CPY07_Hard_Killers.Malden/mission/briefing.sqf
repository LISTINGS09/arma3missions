...
if (side group player != CIVILIAN) then {
	...
	<br/>Assault the Nothern sector of Malden, occupied by CSAT forces.
	<br/>
	<br/>Capture the three bunkers surrounding Lolisse, before securing the village itself.
	<br/>
	<br/>%1
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>Expect to encounter light infantry patrols across the AO. At least two APCs have been spotted in the vicinity of Lolisse.
	<br/>
	<br/>All CSAT Bunkers are expected to have motorised or static supports close nearby, while the village itself will heavily occupied.
	<br/>
	<br/>CSAT QRF can be expected to arrive from the South if Lolisse appears to be under threat, expect motorised and mechanised infantry reinforcements.
	<br/>
