...
if (side group player != CIVILIAN) then {
	...
	<br/>Camp Maxwell is a strategic CSAT logistics node supporting operations across the region. Recent intel reports a CSAT fuel truck (high-value logistic vehicle) operating in the Camp Maxwell area to refuel frontline units.
	<br/>
	<br/>Capturing the truck intact will significantly impair CSAT mobility and provide NATO with a usable asset. Expect standard camp defenses and local patrols; exercise caution to capture the vehicle rather than destroy it.
	<br/>
	<br/><font color='#FF7F00'>1.</font> Seize Camp Maxwell.
	<br/><font color='#FF7F00'>2.</font> Locate and capture the CSAT fuel truck and secure it intact.
	<br/>
	<br/>%4
	<br/>
	<br/>%1 <!--- Casualties Cap --->
