...
if (side group player != CIVILIAN) then {
	...
	<br/>The recent surge in CSAT operations in the western region of Altis has put critical SFIA supply lines under threat. Intelligence reports indicate that CSAT forces have established a fuel depot in the valley to the west of Mike-26 to support their mechanized units. This depot consists of two fuel pods and a single fuel truck, which are essential to their operational capabilities in the area.
	<br/>
	<br/>Given the strategic importance of the fuel depot, it is imperative that any forces there are neutralized without causing significant damage to the assets. This operation will not only hinder CSAT’s operational reach but also provide SFIA with an opportunity to repurpose the captured resources.
	<br/>
	<br/>Your unit has been tasked with the mission to secure the depot and ensure the safe recovery of the fuel assets.
	<br/>%4
	<br/>%1 <!--- Casualties Cap --->
