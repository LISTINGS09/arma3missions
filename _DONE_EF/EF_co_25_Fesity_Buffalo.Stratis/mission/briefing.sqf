...
if (side group player != CIVILIAN) then {
	...
	<br/>Your SFIA forces have been tasked with neutralizing a strategically vital AAF compound located in the region. Intelligence reports confirm the presence of a large number enemy defenses, including two ZU-23-2 trucks providing anti-air and infantry suppression capabilities. Additionally, a nearby mortar site poses a significant threat to our operations. All enemy assets in the area must be neutralized to ensure operational success.
	<br/>
	<br/><font color='#FF7F00'>Secure the AAF Compound</font>
	<br/>Eliminate all hostile forces within the compound.
	<br/>Capture and secure the two Cargo HQ buildings to prevent enemy reoccupation.
	<br/>
	<br/><font color='#FF7F00'>Destroy the Mortar Site</font>
	<br/>Neutralize the mortar emplacement to eliminate indirect fire threats.
	<br/>Confirm destruction via visual inspection.
	<br/>
	<br/><font color='#FF7F00'>Eliminate ZU-23-2 Trucks</font>
	<br/>Locate and destroy both ZU-23-2 trucks in the area.
	<br/>Each truck is stationed near a fortified AAF position.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
