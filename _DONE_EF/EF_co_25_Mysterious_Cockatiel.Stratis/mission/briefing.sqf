...
if (side group player != CIVILIAN) then {
	...
	<br/>CSAT activity around the Stratis coastline has been increasing, and recent aerial recon confirms that Camp Tempest has been converted into a fully operational CSAT outpost. The site is being used as an early-warning node to track AAF naval and air movement across the western approaches. If left in their hands, further expansion along the coast is expected, making future AAF operations substantially more difficult.
	<br/>
	<br/>To complicate matters, CSAT has deployed a submarine just off the western shoreline. Its sensor suite and torpedo coverage effectively shut down any attempt at a seaborne approach from that side. Any movement over open water will be detected long before it reaches land, and naval support won’t be able to close distance until the camp is secured.
	<br/>
	<br/>Despite this, the outpost at Camp Tempest remains lightly garrisoned and relies heavily on the sub for early detection. This creates a narrow window for a ground assault that avoids CSAT’s long-range surveillance.
	<br/>
	<br/>Your forces shall advance on Camp Tempest, neutralize the CSAT presence, and re-establish control of the outpost. The submarine offshore is not your objective and should be avoided; the focus is the camp itself.
	<br/>
	<br/><font color='#FF7F00'>1.</font> Secure Camp Tempest from all CSAT forces.
	<br/><font color='#FF7F00'>2.</font> Neutralize enemy patrols operating around the camp perimeter.
	<br/><font color='#FF7F00'>3.</font> Avoid any approach from the western sea, as CSAT naval sensors are active.
	<br/><font color='#FF7F00'>4.</font> Raise the AAF flag over Camp Tempest once the outpost is fully secured.
	<br/>	
	<br/>%4
	<br/>
	<br/>%1 <!--- Casualties Cap --->
