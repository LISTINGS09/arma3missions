...
private _side = WEST;
ZMM_WESTMan = ["EF_B_Marine_R_Des","EF_B_Marine_LAT2_Des","EF_B_Marine_R_Des","EF_B_Marine_TL_Des","EF_B_Marine_R_Des","EF_B_Marine_AR_Des","EF_B_Marine_R_Des"]; // WEST - MTJF (ARID)
