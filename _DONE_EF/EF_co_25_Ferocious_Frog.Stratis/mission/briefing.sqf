...
if (side group player != CIVILIAN) then {
	...
	<br/>NATO forces have established a strategic artillery rearmament facility near Agia Marina, essential for maintaining long-range MLRS capabilities on the island. This compound has been pivotal in their ability to project force and sustain operations across Stratis. Intelligence reports indicate that the facility is heavily guarded, with a mix of infantry, mechanized units, and defensive fortifications. This compound must be secured to neutralize NATO's artillery advantage and disrupt their operational reach on the island.
	<br/>
	<br/>Your SFIA (Special Forces of the Independent Altis) will conduct a high-priority assault on the NATO compound near Agia Marina. Your objective is to breach the facility, eliminate all hostile forces, and secure the rearmament depot. Once secured, SFIA engineers will dismantle or repurpose key infrastructure to deny NATO further use of the site. This operation will cripple NATO’s artillery capabilities and shift the balance of power in the region.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
