...
_nvg = "TiGoggles_grn_RF"; //"NVGoggles_OPFOR";
...
// Woodland-Hex
_baseUniform = ["U_lxWS_SFIA_deserter"];
_baseHelmet = ["H_HelmetHeavy_Simple_Olive_RF"];
...
// Ghillie
_ghillieUniform = ["U_lxWS_SFIA_soldier_2_O"];
_ghillieHelmet = ["H_HelmetHeavy_Simple_Olive_RF"];
_ghillieRig = ["V_SmershVest_01_F"];
_ghillieGlasses = [];

// Spec Op
_sfuniform = ["U_lxWS_SFIA_soldier_2_O"];
_sfhelmet = ["H_Beret_ocamo"];
