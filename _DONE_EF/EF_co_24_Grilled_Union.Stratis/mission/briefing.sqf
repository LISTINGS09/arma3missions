...
if (side group player != CIVILIAN) then {
	...
	<br/>Your SFIA forces, bolstered by CSAT advisors and resources, have been tasked with a critical operation to destabilize NATO’s influence in the region. Your primary objectives are to destroy a NATO MLRS (Multiple Launch Rocket System) and secure Camp Rogain by eliminating the NATO reserve forces stationed there. Success will not only weaken NATO’s strategic capabilities but also solidify CSAT's trust and support for our rebellion.
	<br/>
	<br/>Zulu forces will conduct a diversionary assault on Stratis Airbase to the south, drawing NATO's attention and splitting their forces. Concurrently, air support will neutralize NATO communications towers to delay reinforcement requests.
	<br/>
	<br/><font color='#FF7F00'>Phase One - Neutralize the MLRS</font>
	<br/>The NATO MLRS poses a severe threat to our operations and must be destroyed. Intelligence suggests the system is lightly guarded but operational. Approach with caution, as any delay could allow NATO to reposition the weapon or call for reinforcements. Utilize explosive charges to ensure complete destruction, and move swiftly to avoid prolonged engagement with enemy forces in the area.
	<br/>
	<br/><font color='#FF7F00'>Phase Two - Capture Camp Rogain</font>
	<br/>Once the MLRS is neutralized, your unit will advance toward Camp Rogain. The camp serves as a critical forward operating base for NATO and houses reserve forces. Eliminating the troops stationed there and securing the facility will provide our forces with a strategic foothold on the island. Expect heavy resistance, and coordinate with CSAT advisors to leverage their advanced weaponry and tactical expertise. Control of Camp Rogain is non-negotiable.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
