...
if (side group player != CIVILIAN) then {
	...
	<br/>The recent surge in CSAT operations in the western region of Altis has put critical NATO supply lines under threat. Intelligence reports indicate that CSAT forces have established a fuel depot in the valley west of Mike-26 to support their mechanized units. This depot consists of two fuel pods and a single fuel truck, which are essential to their operational capabilities in the area.
	<br/>
	<br/>Given the strategic importance of the fuel depot, it is imperative that it is neutralized without causing significant damage to the assets. This operation will not only hinder CSAT’s operational reach but also provide NATO with an opportunity to repurpose the captured resources.
	<br/>
	<br/>Secure the depot and ensure the safe recovery of the fuel assets.
	<br/>
	<br/>Ensure no damage to the following:
	<br/><font color='#FF7F00'>1.</font> Two fuel pods located at the site.
	<br/><font color='#FF7F00'>2.</font> A fuel truck stationed within the depot.
	<br/>
	<br/>%4
	<br/>
	<br/>%1 <!--- Casualties Cap --->
