...
if (side group player != CIVILIAN) then {
	...
	<br/>Over the past week, FIA cells operating in southern Stratis have become increasingly bold, launching ambushes on AAF patrols and sabotaging key infrastructure. Signals intelligence and eyewitness reports place a significant FIA presence inside the village of Girna. The insurgents have been using civilian homes and abandoned buildings as safehouses, weapons stashes, and meeting points.
	<br/>
	<br/>Complicating the situation, CSAT forces have moved into the area under the guise of 'security assistance'. In reality, they have been providing the FIA with protection, early warning, and limited logistical support. Their presence inside and around Girna has allowed FIA fighters to regroup, move freely, and prepare further attacks against AAF positions along the central road network.
	<br/>
	<br/>The village must be secured before the FIA can launch another strike, and CSAT’s involvement risks escalating the conflict if the situation is not handled decisively.
	<br/>
	<br/><font color='#FF7F00'>1.</font> Secure and clear the village of Girna of all FIA and CSAT hostiles.
	<br/><font color='#FF7F00'>2.</font> Identify and neutralize FIA safehouses within the village.
	<br/><font color='#FF7F00'>3.</font> Minimize civilian casualties and structural damage wherever possible.
	<br/>
	<br/>%4
	<br/>
	<br/>%1 <!--- Casualties Cap --->
