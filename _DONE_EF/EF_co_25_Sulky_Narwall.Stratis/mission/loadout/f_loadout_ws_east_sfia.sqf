...
_scope2 = ["optic_MRCO","optic_Arco_blk_F","optic_Hamr","optic_ERCO_blk_F","optic_VRCO_RF"]; // Low
...
_rifle = ["arifle_SLR_V_lxWS","arifle_SLR_lxWS","arifle_Galat_lxWS"];
_riflemag = "30Rnd_762x51_slr_lxWS";
_riflemag_tr = "30Rnd_762x51_slr_tracer_green_lxWS";

// Standard Carabineer (Medic, Rifleman (AT), MAT Gunner, MTR Gunner, Carabineer)
_carbine = ["arifle_SLR_Para_lxWS","arifle_Galat_lxWS"];
_carbinemag = "30Rnd_762x51_slr_lxWS";
_carbinemag_tr = "30Rnd_762x51_slr_tracer_green_lxWS";
...
_glrifle = ["arifle_SLR_V_GL_lxWS","arifle_SLR_GL_lxWS"];
