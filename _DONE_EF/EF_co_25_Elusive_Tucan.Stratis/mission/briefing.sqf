...
if (side group player != CIVILIAN) then {
	...
	<br/>NATO forces have recently increased their operations in the Stratis region due to escalating tensions with the CSAT (Canton-Protocol Strategic Alliance Treaty). Intelligence reports indicate that two freelance journalists, Mark Evans and Adam Müller, were conducting an independent investigation into alleged war crimes committed by CSAT in the area. Unfortunately, their activities caught the attention of CSAT forces.
	<br/>
	<br/>The journalists were captured approximately 48 hours ago and are now being held at an abandoned house located south of Camp Rogain. The house, a dilapidated structure once used by local villagers, has been identified as a temporary detention site frequently utilized by CSAT for high-value captives. This development poses a significant risk to the safety of the journalists, as CSAT has been known to use hostages for propaganda or as bargaining tools in negotiations.
	<br/>
	<br/>NATO Command has designated this operation as a top priority. Failure to secure the journalists will not only result in a loss of credibility for NATO forces but could also jeopardize future journalistic activities in the region.
	<br/>
	<br/>%4
	<br/>%1 <!--- Casualties Cap --->
