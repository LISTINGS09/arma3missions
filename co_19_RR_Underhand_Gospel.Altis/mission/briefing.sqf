...
if (side group player != CIVILIAN) then {
	...
	<br/>Our FIA forces have received credible intel regarding the presence of an AAF (Altian Armed Forces) cache located to the east of Gatolia. This cache is believed to contain essential supplies that could significantly bolster our efforts in the ongoing resistance against the AAF occupation.
	<br/>
	<br/>Your mission, as the commander of this FIA unit, is to locate and secure the AAF cache. Be prepared to encounter resistance from AAF forces, as they are likely to protect this cache at all costs.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Your team will begin by infiltrating the designated by the Commander. Ensure a low profile to avoid attracting attention.
	<br/>
	<br/><font color='#FF7F00'>Intelligence Gathering</font>
	<br/>Upon reaching the vicinity, scout the area for any signs of AAF presence or defensive positions. Your primary objective is to locate the cache's exact position.
	<br/>
	<br/><font color='#FF7F00'>Engagement and Extraction</font>
	<br/>If you encounter AAF forces, engage only if absolutely necessary. Your priority is to secure the cache. If engagement becomes inevitable, use guerrilla tactics and ambushes to minimize casualties.
	<br/>
	<br/><font color='#FF7F00'>Cache Secure</font>
	<br/>Once you've located the cache, secure it and ensure that it is intact.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>After securing the cache, prepare for extraction. Ensure all members of your team are accounted for and uninjured. Retreat to a safe rendezvous point.
	<br/>	
