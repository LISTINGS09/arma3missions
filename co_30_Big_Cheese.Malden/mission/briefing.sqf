...
if (side group player != CIVILIAN) then {
	...
	<br/>There are a number of CSAT warehouses in the AO, and we believe the CBRN containers are spread across any of these warehouses. These containers may contain dangerous materials that pose a significant risk to the environment and human life and must be secured. 
	<br/>
	<br/>The warehouses are guarded by a substantial number of enemy troops, including infantry and armoured vehicles.
	<br/>
	<br/>Your main objective is to secure six CBRN containers. Once each warehouse is secured, locate and secure any CBRN containers within. Ensure that they are handled with extreme care and follow proper protocols for handling hazardous materials.
	<br/>
	<br/>Once the CBRN containers are secured, extract your forces from the mission area.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
