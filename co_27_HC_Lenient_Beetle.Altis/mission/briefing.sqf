...
if (side group player != CIVILIAN) then {
	...
	<br/>A recent intelligence report indicates that two crates containing high-value chemical materials are located within the city of Pyrgos. Due to the sensitive nature of these materials, the Altis Armed Forces have deployed a CBRN team to secure and extract these crates before they can fall into enemy hands. Hostile forces may be present in the area, and the city is still partially populated with civilians, requiring discretion.
	<br/>
	<br/>Your team is tasked with locating and securing two chemical crates within Pyrgos. The leaders of each squad are equipped with chemical detectors that will alert them when they are within 250 meters of one of the crates. 
	<br/>
