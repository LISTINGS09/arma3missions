...
if (side group player != CIVILIAN) then {
	...
	<br/>NATO forces have established a critical MLRS (Multiple Launch Rocket System) installation east of Comms Bravo. This vehicle poses a significant threat to CSAT operations in the region. Intelligence reports indicate that the MLRS is heavily guarded by NATO troops and defensive structures. The strategic importance of this asset to NATO cannot be overstated and its destruction is paramount to ensuring the success of our broader military objectives.
	<br/>
	<br/>Your task force is to infiltrate the area East of Comms Bravo, locate the NATO MLRS installation, and destroy it. The mission requires precision, coordination, and a swift execution to minimize the possibility of reinforcements or a counterattack by NATO forces.
	<br/>
	<br/><font color='#FF7F00'>Locate</font>
	<br/>Use reconnaissance assets, including UAVs and ground scouts, to pinpoint the exact location of the MLRS installation.
	<br/>
	<br/><font color='#FF7F00'>Engage</font>
	<br/>Once the target is confirmed, deploy a coordinated assault to neutralize any defensive structures and enemy personnel protecting the MLRS.
	<br/>
	<br/><font color='#FF7F00'>Destroy</font>
	<br/>Employ explosives or other means to ensure the complete destruction of the MLRS. Confirm the destruction of the asset before exfiltration.
	<br/>
	<br/><font color='#FF7F00'>Exfiltration</font>
	<br/>Withdraw from the area quickly and covertly to avoid enemy retaliation. Regroup at a designated safe zone.
	<br/>
	<br/>
