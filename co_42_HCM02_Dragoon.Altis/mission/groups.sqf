...
_grpOPF = [
	["GrpCSAT_CO","CO","b_hq","CO",_yellow],
	["GrpCSAT_ASL","Alpha","b_inf","A",_red],
	["GrpCSAT_BSL","Bravo","b_inf","B",_blue],
	["GrpCSAT_CSL","Charlie","b_inf","C",_green],
	["GrpCSAT_DSL","Delta","b_inf","D",_orange]
