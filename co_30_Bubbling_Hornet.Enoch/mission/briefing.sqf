...
if (side group player != CIVILIAN) then {
	...
	<br/>We have received a distress signal from two Russian pilots who have crashed within LDF territory. Your mission is to rescue them before they fall into the hands of our enemies.
	<br/>
	<br/>Intel suggests that the pilots survived the crash but are injured and within the vicinity of the crash site. The LDF has already dispatched a search party to capture them, and time is of the essence. 
	<br/>
	<br/>Your objective is to enter the area, locate the pilots, and extract them safely.
	<br/>
	<br/>Once you locate the pilots, you will need to extract them back to the starting point.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
