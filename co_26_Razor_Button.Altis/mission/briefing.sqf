...
if (side group player != CIVILIAN) then {
	...
	<br/>Locate and rescue a captured NATO pilot somewhere near the Ammolofi Bay.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>Up to two infantry teams begin at <marker name='respawn_west'>Altis Airfield</marker>.
	<br/>
	<br/>Vector units are on standby for transportation and CAS.
	<br/>
