...
if (side group player != CIVILIAN) then {
	...
	<br/>The situation on Altis is becoming increasingly volatile. NATO forces have seized and are prepping to destroy a critical Ammo Depot, which was previously under our control. We must act swiftly to disarm the explosives and reclaim the depot, particularly securing the Ammo Truck located inside. Failure is not an option; the repercussions of NATO holding such a strategic asset could be disastrous.
	<br/>
	<br/><font color='#FF7F00'>Disarm the Explosive</font>
    <br/>The primary objective is to locate and disarm the explosive that NATO has placed within the Ammo Depot.
	<br/>
	<br/><font color='#FF7F00'>Secure the Ammo Truck</font>
    <br/>Once the explosive is disarmed, secure the Ammo Truck parked inside the depot. This vehicle is of utmost importance to our operations on Altis and must be preserved at all costs.
	<br/>
	<br/><font color='#FF7F00'>Neutralize NATO Forces</font>
    <br/>Expect resistance from NATO forces. Neutralize any enemy combatants encountered in and around the depot. Keep in mind that they might have entrenched positions and could employ armour support. Deploy our assets effectively to counter these threats.
	<br/>
