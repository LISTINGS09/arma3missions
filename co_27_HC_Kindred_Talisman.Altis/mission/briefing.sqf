...
if (side group player != CIVILIAN) then {
	...
	<br/>Your Russian forces have identified an AAF outpost positioned just outside of Iraklia. This outpost has been a critical node for enemy communication and logistical operations in the region. Intelligence reports suggest a heavily armed garrison of infantry is stationed there, along with a vital communications tower that maintains contact with AAF command across the island. Neutralizing this outpost is crucial to disrupting enemy operations and securing our strategic objectives in the area.
	<br/>
	<br/>Your task is to infiltrate and neutralize the AAF outpost. Eliminate all hostile infantry personnel stationed within the perimeter. Furthermore, your team must destroy the communications tower located at the center of the outpost to sever enemy communications and hinder their ability to coordinate reinforcements. Be prepared for a potential counterattack as enemy forces may attempt to reclaim the position.
	<br/>
	<br/>Support/Vector Teams may choose any vehicle and/or role as designated by the Commander.
	<br/>
	<br/>Virtual Depot: <font color='#80FF00'>Enabled</font>
	<br/>%4
	<br/>
	<br/>%1 <!--- Casualties Cap --->
