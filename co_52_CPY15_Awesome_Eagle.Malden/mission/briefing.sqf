...
if (side group player != CIVILIAN) then {
	...
	<br/>Destroy an armed WY-55 Hellcat located at a nearby AAF Radio Station.
	<br/>
	<br/>An AA Support Team is also located in the area and must be eliminated.
	<br/>
	<br/>%1
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>Each squad has two LSVs, one armed.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>AAF forces are present across the area. Heavier vehicles are stationed around the Radio Station located towards the North.
	<br/>
	<br/>A number of static HMG positions have been established in the nearby towns and patrols can be expected in the surrounding forests.
	<br/>
	<br/>The Hellcat is currently landed at the Radio Station, should it become airborne you will need to acquire additional weapons to eliminate it.
	<br/>
