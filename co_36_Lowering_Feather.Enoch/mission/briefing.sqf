...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to locate and destroy three LDF APCs.
	<br/>
	<br/>The first step in this mission is to gather intelligence on the whereabouts of the APCs. This can be done through aerial reconnaissance or by using ground-based infantry. 
	<br/>
	<br/>Once the APCs have been located, the preferred method for destroying APCs is to use anti-tank weapons, such as guided missiles or rocket launchers. At least one of the APCs is known to be operational within the AO, the other two are believed to be stationed at an LDF depot.
	<br/>
	<br/>Once all three APCs have been destroyed, return to base.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
