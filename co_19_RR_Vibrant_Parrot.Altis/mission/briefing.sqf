...
if (side group player != CIVILIAN) then {
	...
	<br/>Your AAF forces have been tasked with capturing a FIA outpost located to the north of Ifestiona. The primary objective is to locate and secure the compound before capturing the flag within the outpost.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Move cautiously towards the central grid coordinates, utilizing terrain and cover to minimize exposure to potential enemy fire.
	<br/>
	<br/><font color='#FF7F00'>Search and Secure</font>
	<br/>Upon reaching the outpost vicinity, conduct a thorough search of the compound. Neutralize any resistance encountered and secure the area.
	<br/>
	<br/><font color='#FF7F00'>Capture the Flag</font>
	<br/>Once the area is secured, locate and capture the flag within the compound. This signifies successful occupation and control of the Outpost.
	<br/>
	<br/><font color='#FF7F00'>Consolidation</font>
	<br/>Establish defensive positions and prepare for possible counter-attacks. Ensure that the outpost remains under AAF control.
	<br/>
	<br/><font color='#FF7F00'>Exfiltration</font>
	<br/>Once the outpost is secured, be prepared for extraction or endex.
	<br/>
