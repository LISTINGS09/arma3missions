...
_grpIND = [
	...
	,["GrpIND_IFV1","Thunder1","b_mech_inf","T1",_orange]
	,["GrpIND_IFV2","Thunder2","b_mech_inf","T2",_orange]
	,["GrpIND_AH1","Eagle1","b_air","E1",_purple]
	,["GrpIND_AH2","Eagle2","b_air","E2",_purple]
];