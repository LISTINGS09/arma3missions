...
if (side group player != CIVILIAN) then {
	...
	<br/>Your mission is to locate and destroy three NATO caches located in the vicinity of Cancon. These caches are believed to contain weapons, ammunition, and other supplies that could be used against our forces, so it's imperative that we neutralize them as quickly as possible.
	<br/>
	<br/>Our intelligence indicates that the caches are located in three separate locations around Cancon, marked within the AO so we'll need to deploy our forces accordingly. You will be using a combination of ground and air assets to conduct this mission.
	<br/>
	<br/>Our ground forces will consist of two infantry squads and one armoured unit. These forces will be responsible for locating and securing the caches once they have been located. The armoured unit will provide cover and support for the infantry, who will be responsible for any demolitions required to destroy the caches.
	<br/>
	<br/>In addition to our ground forces, we'll also be deploying air assets to provide support and reconnaissance. We'll have two planes and one reconnaissance drone at our disposal. The planes will be responsible for providing cover and support for our ground forces, while the drone can provide real-time intelligence on enemy movements and the location of the caches.
	<br/>
	<br/>Once you have located the caches, use demolition charges to destroy the caches, making sure to take any necessary precautions to avoid collateral damage.
	<br/>
	<br/>Be prepared for any potential enemy resistance and take all necessary precautions to ensure the safety of our forces.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	...
	<br/>%2%3
	<br/>
	<br/>Additional NATO QRF forces can be expected from outside the area.
	<br/>
