...
if (side group player != CIVILIAN) then {
	...
	<br/>Locate a crashed NATO Blackfoot somewhere <marker name='marker_1'>in the area</marker> and destroy the equipment on-board.
	<br/>
	<br/>Destroy the CSAT AAA that remains active to the <marker name='marker_2'>South of the Island</marker>.
	<br/>
	<br/>%1
	<br/>
	<br/><font size='18' color='#80FF00'>FRIENDLY FORCES</font>
	<br/>Your unit begins at <marker name='respawn_west'>La Pessange</marker>, each squad has one truck to move across the AO if required.
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>CSAT forces are aware of your presence in the area and infantry and motorised patrols can be expected across the region. 
	<br/>
	<br/>One IFV is also active in the area along with the armoured AA asset.
	<br/>
	<br/>The town of <marker name='marker_61'>La Riviere</marker> can be expected to dispatch additional CSAT infantry or mechanised forces.
	<br/>
