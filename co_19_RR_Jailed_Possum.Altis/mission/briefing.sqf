...
if (side group player != CIVILIAN) then {
	...
	<br/>Gentlemen, we find ourselves in a challenging situation. Our intelligence reports indicate that CSAT forces have established a heavily fortified checkpoint on Altis Island. This checkpoint serves as a crucial logistical point for the enemy and poses a significant threat to our operations in the region. Our mission today is to capture this checkpoint by securing the flag located within the facility.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Start by loading up your platoon onto the transport helicopters at our main base. Fly to the designated LZ near the checkpoint. Ensure a low-level approach to avoid enemy radar detection.
	<br/>
	<br/><font color='#FF7F00'>Assault</font>
	<br/>After landing, move to your initial waypoint, marked on your map, and prepare for the assault. Use the terrain to your advantage for cover and approach the checkpoint cautiously.
	<br/>
	<br/><font color='#FF7F00'>Capture the Flag</font>
	<br/>The primary objective is to secure the flag located within the checkpoint. Be advised, the enemy will defend it vigorously. Once you capture the flag, hold the position and defend against any enemy counterattacks.
	<br/>
	<br/><font color='#FF7F00'>Eliminate Enemy</font>
	<br/>You may encounter resistance throughout the checkpoint. Clear the area systematically and eliminate any CSAT forces you encounter.
	<br/>
	<br/><font color='#FF7F00'>Exfiltration</font>
	<br/>Once the flag is secure, hold the position until the Commander is satisfied the area is secure.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>The enemy forces at the CSAT Checkpoint are well-equipped and well-fortified. Expect to encounter a mix of infantry units. We have also received reports of armoured vehicles, so be prepared for mechanized resistance. The CSAT forces are battle-hardened and will put up a fierce fight.
	<br/>
