...
if (side group player != CIVILIAN) then {
	...
	<br/>Syndikat forces have received intel about a high-value NATO Ammo Truck currently stationed in the village of Savaka. This truck contains critical supplies and ammunition that are essential for sustaining our operations against NATO forces in the region. Your mission is to capture and recover the NATO Ammo Truck, ensuring it is safely transported to our forward operating base.
	<br/>
	<br/>
	<br/><font color='#FF7F00'>Primary Objective</font>
	<br/>Infiltrate the village of Savaka and locate the NATO Ammo Truck.
	<br/>
    <br/><font color='#FF7F00'>Secondary Objective</font>
	<br/>Neutralize any NATO forces in the vicinity to prevent reinforcements from jeopardizing the operation.
	<br/>
	<br/>
	<br/><font size='18' color='#80FF00'>ENEMY FORCES</font>
	<br/>Savaka is a small, strategically positioned village with a moderate NATO presence. Recent reconnaissance indicates that NATO forces are conducting routine patrols and have established several checkpoints around the area. The terrain is a mix of urban and rural environments, providing both cover and obstacles that can be used to our advantage. Expect resistance to be light to moderate, but be prepared for quick reinforcement deployments from nearby NATO installations.
	<br/>	
