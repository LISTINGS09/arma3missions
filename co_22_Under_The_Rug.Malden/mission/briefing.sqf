...
if (side group player != CIVILIAN) then {
	...
	<br/>Syndikat forces operating in the region have stolen a vehicle, sparking tension and potential conflict in the area.
	<br/>
	<br/>Investigate the incident and de-escalate the tensions by recovering the vehicle and working towards a peaceful resolution... For your group at least.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
