...
if (side group player != CIVILIAN) then {
	...
	<br/>CSAT forces have established a temporary forward operating camp just outside the town of Ioannina, located in Northern Altis. Intelligence reports indicate that they are holding two highly sensitive briefcases containing a significant amount of funds intended for further CSAT operations in the region. The camp is fortified, with multiple patrols and defensive positions set up in and around the camp.
	<br/>
	<br/>NATO command has identified this as a critical opportunity to disrupt CSAT's operational capabilities in the area. A swift and decisive strike will cripple their supply chain and prevent further movements.
	<br/>
	<br/>Your unit is tasked with infiltrating the CSAT camp, neutralising hostile forces, and securing the two briefcases. Time is of the essence, as CSAT may attempt to move the briefcases to a more secure location if they detect our presence.
	<br/>
	...
	(format["Lethal Damage: %1", ["<font color='#CF142B'>Disabled</font>","<font color='#80FF00'>Enabled</font>"] select FAR_var_InstantDeath]) + "<br/>" +
