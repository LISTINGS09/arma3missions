...
if (side group player != CIVILIAN) then {
	...
	<br/>Situated in the Southern part of Livonia, Swarog is a strategically important area that has been taken over by Russian forces. It is your mission to secure the outpost and neutralize all hostile forces in the area.
	<br/>
	<br/>Our intelligence suggests that the Russian forces have been using the outpost to conduct chemical testing experiments. They have heavily fortified the area and have set up multiple defensive positions, including guard posts and watchtowers.
	<br/>
	<br/>Approach the area using the cover of the nearby hills, neutralise the enemy's defensive positions and secure the perimeter of the outpost.
	<br/>
	<br/>Once the perimeter is secure, move in to clear the buildings and eliminate any remaining hostiles.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
