...
if (side group player != CIVILIAN) then {
	...
	<br/>Frini is a strategically significant area within the conflict zone, situated near the border between NATO and CSAT-controlled territories. Intelligence reports indicate that the CSAT compound near Frini is being used as a staging ground for offensive operations against NATO forces. The presence of enemy armored vehicles poses a significant threat to our operations in the region.
	<br/>
	<br/>Your NATO forces have been tasked with neutralizing enemy vehicles at a CSAT compound located near Frini. The compound houses several high-value enemy assets, including armoured vehicles and weapon caches. Your mission is to infiltrate the compound, eliminate any hostile resistance and destroy or disable the enemy vehicles.
	<br/>
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Your team will approach the CSAT compound as determined by the Commander. Utilize stealth and reconnaissance to gather intel on enemy positions and defensive emplacements.
	<br/>
	<br/><font color='#FF7F00'>Engagement</font>
	<br/>Once inside the compound, engage hostile forces swiftly and decisively. Use a combination of small unit tactics, combined arms, and coordinated fire support to overwhelm the enemy.
	<br/>
	<br/><font color='#FF7F00'>Vehicle Neutralization</font>
	<br/>Identify and prioritize enemy vehicles for neutralization. Ensure to use appropriate munitions and tactics based on the type and armour protection of each vehicle.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>Once the mission objectives have been achieved, extract from the area promptly. Secure a safe route and maintain situational awareness to avoid enemy counterattacks during the withdrawal.
	<br/>
	<br/>
