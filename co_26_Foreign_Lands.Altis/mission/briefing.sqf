...
if (side group player != CIVILIAN) then {
	...
	<br/>We have received intelligence regarding a rival Insurgent group operating near Limni. They pose a significant threat to our interests in the region and must be neutralized. Our mission is to launch a focused attack on their positions and capture strategic objectives, which are as follows:
	<br/>
	<br/>Capture the Outpost: The Outpost is a crucial location for the enemy, providing them with a fortified position and a vantage point. Neutralize all enemy forces within the Outpost and secure it for our own use.
	<br/>
	<br/>Secure the Group of Houses: The group of houses in the vicinity is suspected to serve as a logistical hub and potentially a hideout for enemy leadership. Clear the area of any hostiles and ensure the houses are under our control.
	<br/>
	<br/>Control the Cargo Tower: The cargo tower overlooking Cape Kategidis offers excellent observation capabilities and potential communication advantages. Seize control of the tower and eliminate any resistance encountered.
	<br/>
	...
	(((vehicles select { side _x getFriend side group player < 0.6 && count crew _x > 0}) apply {  getText (configFile >> "CfgVehicles" >> typeOf _x >> "displayName") }) call BIS_fnc_consolidateArray) apply { format["%2x <font color='#00FFFF'>%1</font><br/>", _x#0, _x#1] } joinString "",
