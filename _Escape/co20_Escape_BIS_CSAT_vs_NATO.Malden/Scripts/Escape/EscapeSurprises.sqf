        ...
        if (!_isExecuted && time > _surpriseTimeSec) then {
            ...
            if (call _condition) then {
                ...
                if (_surpriseID == "DROPCHOPPER") then {
                    ...
                    _dropGroup = createGroup [A3E_VAR_Side_Opfor, true];
                    _dropUnits = [];
				...
				if (_surpriseID == "DROPCHOPPER_I") then {
                    ...
                    _dropGroup = createGroup [A3E_VAR_Side_Ind, true];
                    _dropUnits = [];
                ...
                if (_surpriseID == "RUSSIANSEARCHCHOPPER") then {
                    ...
                    _group = createGroup [A3E_VAR_Side_Opfor, true];
				...
				if (_surpriseID == "LEAFLETDRONE") then {
					...
					_arr = [(getMarkerPos "drn_russianSearchChopperStartPosMarker"), 0, "C_UAV_06_F", A3E_VAR_Side_Ind] call bis_fnc_spawnvehicle;
