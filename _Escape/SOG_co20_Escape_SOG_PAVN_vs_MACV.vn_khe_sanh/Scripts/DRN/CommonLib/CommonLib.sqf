...
drn_fnc_CL_GetRandomMarkerPos = {
	...
	private _area = markerSize _markerName;
	_area pushBack markerDir _markerName;
	_area pushBack ( markerShape _markerName isEqualTo "Rectangle" );
	private _spawnPos = [ _markerName, _area ] call BIS_fnc_randomPosTrigger;
    _spawnPos
};
