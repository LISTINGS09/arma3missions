...
if (side group player != CIVILIAN) then {
	...
	<br/>Locate two CSAT Ammo Dumps within the village of Abdera and defend the area while the Engineers set charges (interaction).
	<br/>
	<br/>Vector has a set of improvised IEDs, to disrupt CSAT reinforcements.
	<br/>
	<br/>Once both Dumps have been destroyed, leave the area.
	<br/>
	<br/>%1 <!--- Casualties Cap --->
	<br/>
