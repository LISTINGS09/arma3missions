...
if (side group player != CIVILIAN) then {
	...
	<br/>Your rebel forces must execute a coordinated operation to steal two research documents from the possession of Gendarme forces. Additionally, you are tasked with destroying two communications towers at Comms Bravo to disrupt enemy communications. Finally, your primary objective is to move north and retrieve the documents located at a Gendarme safe house situated to the west of Ovau.
	<br/>
	<br/><font color='#FF7F00'>Steal Research Documents</font>
	<br/>The primary objective is to acquire two research documents currently in the possession of Gendarme forces.
	<br/>These documents are of significant importance to our cause and must be retrieved without raising unnecessary alarms.
	<br/>
	<br/><font color='#FF7F00'>Destroy Communications Towers</font>
	<br/>In order to disrupt enemy communications and prevent reinforcements or alerts, you must destroy two communications towers located at Comms Bravo.
	<br/>The destruction of these towers will impede the enemy's ability to coordinate and call for reinforcements.
	<br/>
	<br/><font color='#FF7F00'>Retrieve Documents</font>
	<br/>After neutralizing the communications towers, your forces are to proceed north towards the Gendarme safe house.
	<br/>The documents are likely to be heavily guarded, so exercise caution and employ stealth tactics when necessary.
	<br/>Once secured, extract the documents and evacuate the area swiftly.
	<br/>
	<br/>
