...
if (side group player != CIVILIAN) then {
	...
	<br/>Our intelligence reports indicate that the Altis Armed Forces (AAF) have established two static Anti-Tank (AT) positions near the village of Synneforos. These AT positions pose a significant threat to our operations in the region and must be eliminated.
	<br/>
	<br/><font color='#FF7F00'>Reconnaissance</font>
	<br/>Once in the vicinity of Synneforos, gather information about the exact locations of the AAF static AT positions. This information will be crucial for planning your attack.
	<br/>
	<br/><font color='#FF7F00'>Elimination</font>
	<br/>When you have obtained the necessary intel, approach the AT positions carefully. Neutralize the AAF soldiers manning these positions. Use silenced weapons to maintain stealth. Ensure that all threats are eliminated.
	<br/>
	<br/><font color='#FF7F00'>Exfiltration</font>
	<br/>After successfully eliminating the threats, exfiltrate the area. Avoid engaging AAF reinforcements, if any are dispatched. Regroup at the extraction point designated by the Commander.
	<br/>
