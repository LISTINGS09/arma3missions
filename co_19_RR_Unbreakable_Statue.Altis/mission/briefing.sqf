...
if (side group player != CIVILIAN) then {
	...
	<br/>Intelligence has identified a critical target deep within enemy territory: a generator powering a key Russian camp. This generator serves as a lifeline for their operations in the region. Disabling it will significantly hinder their capabilities and disrupt their supply lines, giving us a strategic advantage. 
	<br/>
	<br/>You are part of a NATO Special Forces team tasked with infiltrating the Russian camp, locating the generator, and sabotaging it. This operation requires precision, stealth, and quick execution.
	<br/>
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Utilize stealth to infiltrate the perimeter of the Russian camp undetected. Avoid patrols and surveillance to maintain secrecy.
	<br/>
	<br/><font color='#FF7F00'>Locate the Generator</font>
	<br/>Once inside the camp, proceed to locate the generator.
	<br/>
	<br/><font color='#FF7F00'>Sabotage the Generator</font>
	<br/>Once located, interact with the object to disable the generator.
	<br/>
	<br/><font color='#FF7F00'>Exfiltration</font>
	<br/>After completing the sabotage, exfiltrate out of the area swiftly and quietly. Use alternative routes if necessary to avoid detection.
	<br/>
	<br/>
