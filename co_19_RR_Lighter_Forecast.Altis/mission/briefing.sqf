...
if (side group player != CIVILIAN) then {
	...
	<br/>Russian forces have received intelligence indicating that a crucial cache of classified military equipment has been captured by NATO and is currently hidden inside a medium-sized shipping container. This container is believed to be concealed within a warehouse or yard in the vicinity of Topolia, Altis. The nature of the equipment within the cache is highly sensitive, and it is imperative that it be recovered.
	<br/>
	<br/>The primary objective is to locate the medium-sized shipping container that holds the captured cache. This container is suspected to be located in a warehouse or yard near Topolia.
	<br/>
	<br/><font color='#FF7F00'>Infiltration</font>
	<br/>Russian forces will be inserted at a location chosen by the Commander, depending on the tactical situation. The team will approach Topolia quietly to maintain the element of surprise.
	<br/>
	<br/><font color='#FF7F00'>Reconnaissance</font>
	<br/>Prioritize reconnaissance to locate the warehouse or yard where the medium-sized shipping container is believed to be concealed. Use the UAV or ground patrol for this purpose.
	<br/>
	<br/><font color='#FF7F00'>Identification</font>
	<br/>Once the suspected location is identified, confirm that the container contents matches the description of the captured cache.
	<br/>
	<br/><font color='#FF7F00'>Extraction</font>
	<br/>Once the cache is located, secure the area immediate and then extract.
	<br/>
